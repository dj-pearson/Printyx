    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <div
                  className={`text-2xl font-bold ${getConversionColor(metrics.leadToQualifiedRate)}`}
                >
              ...
              <div className="text-center p-4 bg-green-50 rounded-lg">
                <div
                  className={`text-2xl font-bold ${getConversionColor(metrics.qualifiedToDemoRate)}`}
                >
              ...
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                <div
                  className={`text-2xl font-bold ${getConversionColor(metrics.demoToProposalRate)}`}
                >
              ...
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                <div
                  className={`text-2xl font-bold ${getConversionColor(metrics.proposalToClosedWonRate)}`}
                >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>AI-powered recommendations to hit your sales goals</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-3">
            {nudges.map((nudge, index) => (
              <div
                key={index}
                className={`p-4 rounded-lg border ${getPriorityColor(nudge.priority)}`}
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600 mt-1">Deal: {nudge.dealTitle}</div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Track your conversion performance over time</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
