    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Statistical process control for deal flow monitoring</CardDescription>
        </CardHeader>
        <CardContent>
                ...
                <div className="flex justify-between items-end h-full">
                  {controlCharts.map((point, index) => (
                    <div key={index} className="flex flex-col items-center">
                      ...
                      <div
                        className={`text-xs font-medium ${point.isOutOfControl ? 'text-red-600' : 'text-gray-800'}`}
                      >
                        {point.value}
                      </div>
                    </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-yellow-700 mt-1">
                      Pipeline metrics are showing out-of-control points. Review recent activities
