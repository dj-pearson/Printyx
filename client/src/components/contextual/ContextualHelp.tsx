...
> = {
  'advanced-billing': {
    ...
    industryContext:
      'Most copier dealers lose 15-20% revenue to billing errors and missed recurring charges.',
    quickTips: [
  ...
  'task-management': {
    ...
    quickTips: ['Prioritize by business impact', 'Use dependencies to clarify workflow order'],
  },
  'quotes-management': {
  ...
  'service-dispatch-optimization': {
    title: 'Service Dispatch Optimization',
    industryContext:
      'Optimized routing can save 30+ minutes per technician per day and improve customer satisfaction by 18%.',
    quickTips: [
  ...
  'product-catalog-optimization': {
    ...
    industryContext:
      'AI-powered pricing optimization can increase profit margins by 5-15% while maintaining competitiveness.',
    quickTips: [
  ...
  'deals-management-optimization': {
    ...
    industryContext:
      'Predictive deal scoring can improve win rates by 15-25% and reduce sales cycles by 12% on average.',
    quickTips: [
  ...
  'purchase-orders-optimization': {
    ...
    industryContext:
      'AI-powered procurement optimization can reduce costs by 8-12% while improving vendor performance and compliance.',
    quickTips: [
  ...
  'quote-builder-optimization': {
    ...
    industryContext:
      'Dynamic pricing optimization and AI-powered quote building can increase win rates by 15-25% and boost average deal value by 12%.',
    quickTips: [
  ...
  'task-management-optimization': {
    ...
    industryContext:
      'AI-powered task management and productivity optimization can increase team efficiency by 18% and reduce project completion times by 12%.',
    quickTips: [
  ...
  'quotes-management-optimization': {
    ...
    industryContext:
      'AI-powered quote management and success prediction can increase conversion rates by 19% and improve quote-to-close ratios by 15%.',
    quickTips: [
  ...
  'quote-proposal-generation-optimization': {
    ...
    industryContext:
      'AI-powered proposal generation can reduce creation time by 45% and increase success rates by 40%, with proposals featuring ROI calculations showing 67% higher acceptance rates.',
    quickTips: [
