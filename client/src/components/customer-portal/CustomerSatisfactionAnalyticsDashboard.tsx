...
import { 
  ...
  Target, Award, Calendar, BarChart3, Smile, Frown,
  ThumbsUp, AlertTriangle, CheckCircle, Clock, Filter
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <Badge className={`mt-2 text-xs ${npsCategory.color}`}>
              {npsCategory.label}
            </Badge>
          </CardContent>
        </Card>
                  ...
                  {analytics.surveyTypeBreakdown?.map((type, index) => (
                    <div key={index} className="flex items-center justify-between">
                      <div className="flex-1">
                        <p className="font-medium text-sm capitalize">{type.type.replace('_', ' ')}</p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                      <div className="text-center">
                        ...
                        <Badge className={`mt-2 ${npsCategory.color}`}>
                          {npsCategory.label}
                        </Badge>
                      </div>
                    </div>
