        ...
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center space-x-3">
              ...
              <Button
                variant="outline"
                onClick={() => (window.location.href = '/customer-portal/service-requests')}
              >
                View My Requests
              </Button>
            </div>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Request service for your equipment or report an issue</CardDescription>
      </CardHeader>
      <CardContent>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="after-hours">
                      After hours (additional fees may apply)
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
