            ...
            {items.map((item) => {
              const ItemContent = (
                <div className="flex items-start gap-3 p-2 rounded-md hover:bg-accent cursor-pointer transition-colors">
                  <div
                    className={cn('h-2 w-2 rounded-full mt-2', getPriorityColor(item.priority))}
                  />
...
export function ActivityFeed({ title, activities, maxItems = 5, loading }: ActivityFeedProps) {
