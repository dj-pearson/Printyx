...
const createNavigationSections = (userRole: any): NavigationSection[] => {
  ...
  if (permissions.sales || isPlatformRole || isCompanyAdmin) {
    sections.push({
      ...
      icon: Target,
      path: '/crm',
      matchPatterns: ['/crm*', '/leads*', '/contacts*', '/deals*', '/opportunities*', '/sales-pipeline*', '/quote*', '/proposal*', '/demo*', '/contracts*', '/commission*', '/customer-success*', '/sales-command*', '/sales-performance*', '/data-enrichment*', '/document-builder*', '/apollo-leads*'],
      children: [
        ...
        { title: 'Apollo.io Leads', path: '/apollo-leads', icon: Globe },
