...
import { BookOpen, HelpCircle, ArrowRight, CheckCircle, AlertTriangle, Clock } from 'lucide-react';
        ...
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <h4 className={`font-semibold ${colors.text}`}>{process.title}</h4>
              {estimatedTime && (
            ...
            <AlertDescription className={`${colors.text} mb-3`}>
              {process.description}. Follow the structured process to ensure all requirements are
              met.
            </AlertDescription>
