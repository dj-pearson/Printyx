...
const navigationStructure = {
  ...
  service: {
    ...
    modules: [
      ...
      {
        key: 'mobile-field-service',
        label: 'Mobile Field Service',
        path: '/mobile-field-service',
        icon: Smartphone,
      },
  ...
  reports: {
    ...
    modules: [
      ...
      {
        key: 'team-sales-reports',
        label: 'Team Sales Reports',
        path: '/team-reports',
        icon: BarChart3,
      },
      {
        key: 'all-sales-reports',
        label: 'All Sales Reports',
        path: '/sales-reports',
        icon: BarChart3,
      },
      {
        key: 'my-service-reports',
        label: 'My Service Reports',
        path: '/my-service-reports',
        icon: BarChart3,
      },
      {
        key: 'team-service-reports',
        label: 'Team Service Reports',
        path: '/team-service-reports',
        icon: BarChart3,
      },
      {
        key: 'all-service-reports',
...
export default function MobileNav({ className }: MobileNavProps) {
  ...
  const hasPermission = (department: string, moduleKey: string) => {
    const deptPermissions = userPermissions[department as keyof typeof userPermissions] as
      | string[]
      | undefined;
