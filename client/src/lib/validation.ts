...
export const documentUploadSchema = z.object({
  ...
  category: z.enum(['contracts', 'service-docs', 'financial', 'compliance', 'training'], {
...
export const workflowCreationSchema = z.object({
  ...
  category: z.enum(['customer', 'service', 'finance', 'equipment'], {
...
export const businessRecordSchema = z.object({
  ...
  leadSource: z
    ...
    .optional(),
  status: z
    .enum(['active', 'inactive', 'churned', 'competitor_switch', 'non_payment'])
    .default('active'),
