...
export default function AdminCommandCenter() {
  ...
  const getResourceIcon = (name: string) => {
    ...
    if (lowerName.includes("disk") || lowerName.includes("database")) return <HardDrive className="w-5 h-5" />;
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Execute administrative workflows and monitor system health</p>
          </div>
          <Button
            onClick={() => {
              refetchOverview();
        ...
        <Tabs defaultValue="quick-actions" className="space-y-6">
          ...
          <TabsContent value="pending-tasks" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review and action items requiring admin attention
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="monitoring" className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {systemResources && systemResources.map((resource: SystemMetric, idx: number) => (
                <Card key={idx}>
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
            ...
            <Card className={systemOverview?.systemHealth === "healthy" ? "border-green-200 bg-green-50" : "border-orange-200 bg-orange-50"}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">
                        {systemOverview?.systemUptime}% uptime • {systemOverview?.activeUsers} active users
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3 text-sm text-gray-600">
                    ...
                    <Button className="w-full mt-4" onClick={() => handleWorkflow("tenant-provisioning")}>
                      Start Workflow
                      <ArrowRight className="w-4 h-4 ml-2" />
                    </Button>
                  </div>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Import, update, or manage users in bulk
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-3 text-sm text-gray-600">
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                {selectedWorkflow ? `Starting workflow: ${selectedWorkflow}` : "Select a workflow to begin"}
              </DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-900">
                  <strong>Note:</strong> This workflow is under development. In production, this would guide you through a multi-step process with validation and confirmation at each stage.
                </p>
              </div>
