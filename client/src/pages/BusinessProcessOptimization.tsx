        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Streamline workflows, automate processes, and improve efficiency
            </p>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="mt-2">
                    <Progress
                      value={processData.processOverview.processEfficiency}
                      className="h-2"
                    />
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-2">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                      {processData.processOverview.automatedProcesses}/
                      {processData.processOverview.totalProcesses} processes
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Tabs defaultValue="workflows" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-1 sm:gap-0">
                ...
                <TabsTrigger value="compliance" className="text-xs sm:text-sm px-2 py-2">
                  Compliance
                </TabsTrigger>
              </TabsList>
                          ...
                          <div>
                            <div className="flex justify-between items-center mb-2">
                              ...
                              <span className="text-sm font-medium">
                                {formatPercentage(workflow.automationLevel)}
                              </span>
                            </div>
              ...
              <TabsContent value="analytics" className="space-y-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {processData.processAnalytics.bottlenecks.map(
                              ...
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  ...
                                  <div className="text-xs text-gray-500 mt-2">
                                    Avg delay: {bottleneck.avgDelay} days • {bottleneck.frequency}{' '}
                                    occurrences/month
                                  </div>
                                </div>
                                <Badge
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Efficiency scores and improvement opportunities
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="text-right">
                                <div className="text-sm font-bold">
                                  {formatPercentage(dept.currentEfficiency)}
                                </div>
                                <div className="text-xs text-gray-500">
                                  Target: {formatPercentage(dept.targetEfficiency)}
                                </div>
                              </div>
                            </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Track efficiency and automation progress over time
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="h-64 flex items-center justify-center bg-gray-50 rounded">
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-500">
                          Showing efficiency trends from{' '}
                          {processData.processAnalytics.trends[0]?.month} to{' '}
                          {
                            processData.processAnalytics.trends[
                              processData.processAnalytics.trends.length - 1
                            ]?.month
                          }
                        </p>
                      </div>
                        ...
                        <div className="space-y-4">
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                              ...
                              <span className="ml-2 font-medium">
                                {formatPercentage(opportunity.estimatedReduction)}
                              </span>
                            </div>
                            <div>
                              <span className="text-gray-500">Implementation:</span>
                              <span className="ml-2 font-medium">
                                {opportunity.implementationTime}w
                              </span>
                            </div>
                            <div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-yellow-600 mt-2">
                              <strong>Mitigation:</strong> Accelerate automation initiatives for
                              critical processes
                            </div>
                      ...
                      <div className="p-4 border border-yellow-200 bg-yellow-50 rounded-lg">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-yellow-600 mt-2">
                              <strong>Mitigation:</strong> Implement knowledge management system and
                              cross-training
                            </div>
                            <div className="text-xs text-yellow-600 mt-1">
