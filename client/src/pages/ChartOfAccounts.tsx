...
export default function ChartOfAccounts() {
  ...
  const filteredAccounts = accounts.filter((account: ChartOfAccount) => {
    ...
    const matchesType =
      typeFilter === 'all' || account.accountType.toLowerCase() === typeFilter.toLowerCase();
            ...
            <Card key={account.id} className="hover:shadow-md transition-shadow">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button size="sm" variant="outline" onClick={() => setViewingAccount(account)}>
        ...
        <Dialog open={!!viewingAccount} onOpenChange={() => setViewingAccount(null)}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>View complete account information and settings.</DialogDescription>
            </DialogHeader>
            {viewingAccount && (
                    ...
                    <div className="mt-2 space-y-1 text-sm">
                      ...
                      {viewingAccount.parentAccountId && (
                        <div>
                          ...
                          {getParentAccountName(viewingAccount.parentAccountId)}
                        </div>
                      )}
                    </div>
                  </div>
