...
export default function DocumentManagement() {
  ...
  const uploadMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest('/api/document-management/upload', {
        method: 'POST',
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Organize, automate, and manage all business documents
            </p>
          </div>
              ...
              {documentLibrary && (
                <>
                  <div className="text-2xl font-bold">
                    {documentLibrary.summary.totalDocuments.toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">
                    {documentLibrary.summary.categoriesCount} categories
                  </p>
                  <div className="text-xs text-gray-600 mt-1">
                    Storage: {documentLibrary.summary.storageUsed} /{' '}
                    {documentLibrary.summary.storageLimit}
                  </div>
                </>
              )}
            </CardContent>
              ...
              {documentLibrary && (
                <>
                  <div className="text-2xl font-bold text-orange-600">
                    {documentLibrary.summary.pendingApproval}
                  </div>
              ...
              {documentLibrary && (
                <>
                  <div className="text-2xl font-bold text-green-600">
                    {documentLibrary.summary.complianceScore}%
                  </div>
            ...
            <CardContent>
              {workflowData && (
                <>
                  ...
                  <p className="text-xs text-muted-foreground">Workflow automation success</p>
                  <div className="text-xs text-gray-600 mt-1">
          ...
          <TabsContent value="library" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Organize documents by type and compliance requirements
                </CardDescription>
              </CardHeader>
              <CardContent>
                {documentLibrary && (
            ...
            <Card>
              ...
              <CardContent>
                ...
                {searchResults && (
                  <div className="space-y-4">
                    <div className="text-sm text-gray-600">
                      Found {searchResults.totalResults} results in {searchResults.searchTime}{' '}
                      seconds
                    </div>
                    ...
                    {searchResults.results.map((result: any) => (
                      <div key={result.id} className="border rounded-lg p-4">
                        ...
                        <div className="text-xs text-gray-500">
                          OCR Confidence: {result.ocrConfidence}% | Size: {result.metadata.fileSize}{' '}
                          | Modified:{' '}
                          {format(new Date(result.metadata.lastModified), 'MMM dd, yyyy')}
                        </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-blue-600">
                        {workflowData.automationStats.totalRulesActive}
                      </div>
                      <div className="text-sm text-gray-600">Active Rules</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-green-600">
                        {workflowData.automationStats.rulesTriggeredToday}
                      </div>
                      <div className="text-sm text-gray-600">Triggered Today</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-600">
                        {workflowData.automationStats.timesSaved}h
                      </div>
                      <div className="text-sm text-gray-600">Time Saved/Month</div>
                    </div>
                    <div className="text-center">
                      <div className="text-2xl font-bold text-orange-600">
                        {workflowData.automationStats.documentsProcessed.toLocaleString()}
                      </div>
                  ...
                  <div className="mt-6 p-4 bg-green-50 rounded-lg">
                    ...
                    <Progress
                      value={workflowData.automationStats.automationSuccessRate}
                      className="h-2"
                    />
                  </div>
                </CardContent>
