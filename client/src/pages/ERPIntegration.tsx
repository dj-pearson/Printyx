...
export default function ERPIntegration() {
  ...
  const {
    ...
    select: (data: any) => ({
      ...
      erpSystems:
        data.erpSystems?.map((system: any) => ({
          ...system,
          lastSync: new Date(system.lastSync),
          endpoints:
            system.endpoints?.map((endpoint: any) => ({
              ...endpoint,
      ...
      dataSynchronization: {
        ...
        syncSchedules:
          data.dataSynchronization?.syncSchedules?.map((schedule: any) => ({
            ...schedule,
      ...
      monitoring: {
        ...data.monitoring,
        systemHealth:
          data.monitoring?.systemHealth?.map((health: any) => ({
            ...health,
            lastCheck: new Date(health.lastCheck),
          })) || [],
        alerts:
          data.monitoring?.alerts?.map((alert: any) => ({
            ...alert,
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Advanced multi-system integration with real-time data synchronization and business
              process automation
            </p>
          </div>
          ...
          <>
            ...
            <Tabs defaultValue="systems" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 sm:gap-0">
                <TabsTrigger value="systems" className="text-xs sm:text-sm px-2 py-2">
                  ERP
                </TabsTrigger>
                <TabsTrigger value="synchronization" className="text-xs sm:text-sm px-2 py-2">
                  Sync
                </TabsTrigger>
                <TabsTrigger value="automation" className="text-xs sm:text-sm px-2 py-2">
                  Auto
                </TabsTrigger>
                <TabsTrigger value="monitoring" className="text-xs sm:text-sm px-2 py-2">
                  Monitor
                </TabsTrigger>
                <TabsTrigger value="mapping" className="text-xs sm:text-sm px-2 py-2">
                  Mapping
                </TabsTrigger>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <CardDescription className="mt-1">
                              {system.type} • {system.category.replace('_', ' ')} • v
                              {system.version}
                            </CardDescription>
                          </div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4 text-sm">
                            <div>
                              ...
                              <div className="font-medium">
                                {formatNumber(system.recordsProcessed)}
                              </div>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <div className="font-medium">
                                {format(system.lastSync, 'MMM dd, HH:mm')}
                              </div>
                            </div>
                            <div>
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap gap-1">
                              {system.capabilities
                                .slice(0, 4)
                                .map((capability: string, capIdx: number) => (
                          ...
                          <div className="p-3 bg-gray-50 rounded">
                            <div className="flex items-center justify-between text-sm">
                              <div>
                                ...
                                <span className="ml-2 font-medium capitalize">
                                  {system.authentication.type.replace('_', ' ')}
                                </span>
                              </div>
                            ...
                            <div className="text-xs text-gray-500 mt-1">
                              Token expires:{' '}
                              {format(system.authentication.tokenExpiry, 'MMM dd, yyyy')}
                            </div>
                          </div>
              ...
              <TabsContent value="synchronization" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Data quality metrics across all integrated systems
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                      <div className="p-3 border rounded-lg">
                        ...
                        <div className="text-red-600">
                          {erpData.dataSynchronization.dataQuality.duplicates} duplicates,{' '}
                          {erpData.dataSynchronization.dataQuality.missingFields} missing fields
                        </div>
                      </div>
                      <div className="p-3 border rounded-lg">
                        <div className="font-medium text-yellow-900">Validation Errors</div>
                        <div className="text-yellow-600">
                          {erpData.dataSynchronization.dataQuality.validationErrors} validation
                          errors detected
                        </div>
                      </div>
                      <div className="p-3 border rounded-lg">
                        ...
                        <div className="text-green-600">
                          {formatPercentage(erpData.dataSynchronization.dataQuality.timeliness)}{' '}
                          data freshness
                        </div>
                      </div>
                    </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Automated data synchronization across ERP systems
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {erpData.dataSynchronization.syncSchedules.map(
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="text-right">
                                  <div className="text-sm font-bold">
                                    {formatPercentage(schedule.successRate)}
                                  </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm mb-3">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {formatNumber(schedule.recordsProcessed)}
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Duration:</span>
                                <span className="ml-2 font-medium">
                                  {schedule.averageDuration} min
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Conflicts:</span>
                                <span className="ml-2 font-medium">
                                  {schedule.resolvedConflicts}/{schedule.conflicts}
                                </span>
                              </div>
                              <div>
                            ...
                            <div className="flex justify-between items-center">
                              <div className="text-xs text-gray-500">
                                {schedule.conflicts > 0 &&
                                  `${schedule.conflicts - schedule.resolvedConflicts} unresolved conflicts`}
                              </div>
                              <div className="flex gap-2">
                                <Button size="sm" variant="outline">
                                  <Eye className="h-4 w-4 mr-2" />
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Data conflict management and resolution strategies
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-900">
                          {formatPercentage(
                            erpData.dataSynchronization.conflictResolution.autoResolutionRate,
                          )}
                        </div>
                    ...
                    <div className="space-y-3">
                      <div className="text-sm text-gray-600 mb-3">
                        Resolution Rules Performance:
                      </div>
                      {erpData.dataSynchronization.conflictResolution.resolutionRules.map(
                        (rule: any, idx: number) => (
                          <div
                            key={idx}
              ...
              <TabsContent value="automation" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Business process automation and workflow execution metrics
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-8 gap-4">
                      ...
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-lg font-bold text-indigo-900">
                          {formatPercentage(
                            erpData.businessProcessAutomation.workflowOrchestration.successRate,
                          )}
                        </div>
                      ...
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-lg font-bold text-teal-900">
                          {
                            erpData.businessProcessAutomation.workflowOrchestration
                              .parallelExecutions
                          }
                        </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      End-to-end business process automation across ERP systems
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                      {erpData.businessProcessAutomation.automatedProcesses.map(
                          ...
                          <div key={idx} className="p-6 border rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm mb-4">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {process.averageProcessingTime} min
                                </span>
                              </div>
                              <div>
                                  ...
                                  >
                                    ...
                                    <div className="flex items-center gap-2">
                                      ...
                                      <div className="text-xs font-medium text-green-600">
                                        {formatPercentage(step.successRate)}
                                      </div>
                                    </div>
                                  </div>
                                ))}
                            ...
                            <div className="mb-4">
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div className="text-center p-3 bg-green-50 rounded">
                                  <div className="font-bold text-green-900">
                                    {formatPercentage(process.kpis.cycleTimeReduction)}
                                  </div>
                                  <div className="text-green-600 text-xs">Cycle Time Reduction</div>
                                </div>
                                <div className="text-center p-3 bg-blue-50 rounded">
                                  <div className="font-bold text-blue-900">
                                    {formatPercentage(process.kpis.errorReduction)}
                                  </div>
                                  <div className="text-blue-600 text-xs">Error Reduction</div>
                                </div>
                                <div className="text-center p-3 bg-purple-50 rounded">
                                  <div className="font-bold text-purple-900">
                                    {formatCurrency(process.kpis.costSavings)}
                                  </div>
                                  <div className="text-purple-600 text-xs">Monthly Savings</div>
                                </div>
                                <div className="text-center p-3 bg-orange-50 rounded">
                                  <div className="font-bold text-orange-900">
                                    {process.kpis.customerSatisfaction
                                      ? formatPercentage(process.kpis.customerSatisfaction)
                                      : process.kpis.complianceScore
                                        ? formatPercentage(process.kpis.complianceScore)
                                        : 'N/A'}
                                  </div>
              ...
              <TabsContent value="monitoring" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Real-time health status of all integrated ERP systems
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4">
                      ...
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-purple-900">
                          {formatPercentage(
                            erpData.monitoring.performanceMetrics.availabilityScore,
                          )}
                        </div>
