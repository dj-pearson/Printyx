...
const recentActivity = [
  {
    id: 1,
    type: 'delivery',
    message: 'Canon IR-ADV C3330i delivered to TechCorp Solutions',
    time: '2 hours ago',
    status: 'completed',
  },
  {
    id: 2,
    type: 'installation',
    message: 'Xerox VersaLink C405 - Installation scheduled for tomorrow',
    time: '4 hours ago',
    status: 'pending',
  },
  {
    id: 3,
    type: 'warehouse',
    message: 'HP LaserJet Pro 4301fdw - Quality control completed',
    time: '6 hours ago',
    status: 'completed',
  },
  {
    id: 4,
    type: 'procurement',
    message: 'Purchase order #PO-2025-001 approved',
    time: '1 day ago',
    status: 'completed',
  },
  {
    id: 5,
    type: 'documentation',
    message: 'Warranty registration pending for 3 devices',
    time: '1 day ago',
    status: 'warning',
  },
];
...
export default function EquipmentLifecycle() {
  ...
  const totalActiveItems = lifecycleStages.reduce(
    (sum, stage) => sum + (stage.activeItems || 0),
    0,
  );
  const averageCompletion =
    lifecycleStages.reduce((sum, stage) => sum + (stage.completionRate || 0), 0) /
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" onClick={() => setIsAssetTrackingDialogOpen(true)}>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <Input
                  aria-label="Search lifecycle stages"
                  ...
                  >
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          variant={
                            template.automationLevel === 'Very High'
                              ? 'default'
                              : template.automationLevel === 'High'
                                ? 'secondary'
                                : 'outline'
                          }
                        >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {assetTrackingMetrics.integrationHealth}%
                  </div>
          ...
          <TabsContent value="analytics" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>AI-powered insights and performance metrics</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Dialog open={isAssetTrackingDialogOpen} onOpenChange={setIsAssetTrackingDialogOpen}>
          <DialogContent className="max-w-lg">
            <DialogHeader>
              ...
              <DialogDescription>Real-time equipment tracking and monitoring</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 border rounded">
                  <div className="text-2xl font-bold text-green-600">
                    {assetTrackingMetrics.installed}
                  </div>
                  <div className="text-sm text-muted-foreground">Installed</div>
                </div>
                <div className="text-center p-4 border rounded">
                  <div className="text-2xl font-bold text-orange-600">
                    {assetTrackingMetrics.warrantyExpiring}
                  </div>
