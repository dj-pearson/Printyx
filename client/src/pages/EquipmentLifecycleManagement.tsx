      ...
      <div className="container mx-auto p-6 space-y-6">
                  ...
                  >
                    ...
                    <div className="flex justify-end space-x-2">
                      ...
                      <Button type="submit" disabled={scheduleInstallationMutation.isPending}>
                        {scheduleInstallationMutation.isPending
                          ? 'Scheduling...'
                          : 'Schedule Installation'}
                      </Button>
                    </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 sm:gap-0">
            ...
            <TabsTrigger value="lifecycle" className="text-xs sm:text-sm px-2 py-2">
              Lifecycle
            </TabsTrigger>
            <TabsTrigger value="orders" className="text-xs sm:text-sm px-2 py-2">
              Orders
            </TabsTrigger>
            <TabsTrigger value="deliveries" className="text-xs sm:text-sm px-2 py-2">
              Deliveries
            </TabsTrigger>
            <TabsTrigger value="installations" className="text-xs sm:text-sm px-2 py-2">
              Installs
            </TabsTrigger>
            <TabsTrigger value="assets" className="text-xs sm:text-sm px-2 py-2">
              Assets
            </TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">Currently in lifecycle workflow</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">In customer locations</p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                        ...
                        <div className="flex space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`h-3 w-3 ${
                                i < (metrics?.customerSatisfactionRating || 0)
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-medium">{metrics?.scheduledInstallations || 0}</span>
                    </div>
                  </div>
                </CardContent>
              </Card>
                      ...
                      <div key={stage.id} className="border rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <div className="text-lg font-bold">{stage.progress_percentage}%</div>
