    ...
    select: (data: any) => {
      ...
      return {
        ...
        apiMarketplace: {
          ...data.apiMarketplace,
          availableAPIs:
            data.apiMarketplace?.availableAPIs?.map((api: any) => ({
              ...api,
        ...
        activeIntegrations:
          data.activeIntegrations?.map((integration: any) => ({
            ...
            configuredAt: integration.configuredAt
              ? new Date(integration.configuredAt)
              : new Date(),
            lastSync: integration.lastSync ? new Date(integration.lastSync) : new Date(),
            recentActivity:
              integration.recentActivity?.map((activity: any) => ({
                ...activity,
        ...
        webhookManagement: {
          ...
          recentDeliveries:
            data.webhookManagement?.recentDeliveries?.map((delivery: any) => ({
              ...delivery,
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Comprehensive API marketplace, webhook management, and third-party service
              orchestration
            </p>
          </div>
          ...
          <>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mt-2 text-sm">
                    ...
                    <span className="text-green-600">
                      {formatPercentage(
                        integrationData.integrationOverview?.integrationSuccessRate,
                      )}{' '}
                      success rate
                    </span>
                  </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mt-2 text-sm">
                    ...
                    <span className="text-purple-600">
                      {formatNumber(integrationData.integrationOverview?.webhooksDelivered)}{' '}
                      webhooks
                    </span>
                  </div>
                </CardContent>
            ...
            <Tabs defaultValue="marketplace" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 sm:gap-0">
                ...
                <TabsTrigger value="webhooks" className="text-xs sm:text-sm px-2 py-2">
                  Webhooks
                </TabsTrigger>
                <TabsTrigger value="analytics" className="text-xs sm:text-sm px-2 py-2">
                  Analytics
                </TabsTrigger>
                <TabsTrigger value="transformations" className="text-xs sm:text-sm px-2 py-2">
                  Transform
                </TabsTrigger>
                    ...
                    <div className="flex flex-col md:flex-row gap-4">
                      ...
                      <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                        ...
                        <SelectContent>
                          ...
                          {(integrationData.apiMarketplace?.categories || []).map(
                            (category: any) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      {(integrationData.apiMarketplace?.availableAPIs || []).map(
                        (api: any, idx: number) => (
                          <div
                            key={idx}
                            ...
                            <div className="flex items-start justify-between mb-4">
                              ...
                              <div className="flex flex-col items-end gap-1">
                                ...
                                <div className="text-xs text-gray-500">
                                  {formatNumber(api.integrations)} users
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="text-sm">
                                ...
                                <span className="ml-1 font-medium">
                                  {formatPercentage(api.popularity)}
                                </span>
                              </div>
                            </div>
              ...
              <TabsContent value="active" className="space-y-6">
                            ...
                            <div className="flex-1 flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <CardDescription className="mt-1">
                                  ...
                                  Created {format(integration.createdAt, 'MMM dd, yyyy')}
                                </CardDescription>
                              </div>
                            </div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <div className="font-medium">
                                  {format(integration.updatedAt, 'MMM dd, HH:mm')}
                                </div>
                              </div>
                            </div>
                              ...
                              <div>
                                ...
                                <div className="text-xs p-2 bg-gray-50 rounded border">
                                  <pre className="text-gray-700 whitespace-pre-wrap">
                                    {JSON.stringify(integration.configuration, null, 2).substring(
                                      0,
                                      200,
                                    )}
                                    ...
                  ...
                  <Card>
                    <CardContent className="p-12 text-center">
                      ...
                      <p className="text-gray-600 mb-4">
                        You don't have any active integrations yet. Add integrations from the API
                ...
                {integrationData &&
                  ...
                  integrationData.activeIntegrations.length > 0 && (
                    <>
                      <div className="border-t pt-6 mt-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">
                          Demo Mock Integrations (Example Data)
                        </h3>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                          {(integrationData.activeIntegrations || []).map(
                            (integration: any, idx: number) => (
                                ...
                                <CardHeader>
                                  <div className="flex items-start justify-between">
                                    <div className="flex-1">
                                      <CardTitle className="text-lg">{integration.name}</CardTitle>
                                      <CardDescription className="mt-1">
                                        {integration.apiId} • Configured{' '}
                                        {format(integration.configuredAt, 'MMM dd, yyyy')}
                                      </CardDescription>
                                    </div>
                                  ...
                                  <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 text-sm">
                                      <div>
                                        ...
                                        <div className="font-medium">
                                          {formatNumber(integration.recordsSynced)}
                                        </div>
                                      </div>
                                      <div>
                                        <span className="text-gray-500">API Calls Today:</span>
                                        <div className="font-medium">
                                          {formatNumber(integration.apiCallsToday)}
                                        </div>
                                      </div>
                                      <div>
                                        <span className="text-gray-500">Data Volume:</span>
                                        <div className="font-medium">
                                          {integration.dataVolume} GB
                                        </div>
                                      </div>
                                      <div>
                                          ...
                                          .map((webhook: any, webhookIdx: number) => (
                                            ...
                                            >
                                              ...
                                              <div className="flex items-center gap-2">
                                                ...
                                                <span>
                                                  {formatPercentage(webhook.deliveryRate)}
                                                </span>
                                              </div>
                                            </div>
                                          ))}
              ...
              <TabsContent value="webhooks" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Monitor webhook delivery performance and manage configurations
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-green-900">
                          {formatNumber(
                            integrationData.webhookManagement?.deliveryMetrics?.last24Hours
                              ?.delivered,
                          )}
                        </div>
                      ...
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-blue-900">
                          {formatNumber(
                            integrationData.webhookManagement?.deliveryMetrics?.last7Days
                              ?.delivered,
                          )}
                        </div>
                      ...
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-purple-900">
                          {formatNumber(
                            integrationData.webhookManagement?.deliveryMetrics?.last30Days
                              ?.delivered,
                          )}
                        </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {(integrationData.webhookManagement?.recentDeliveries || []).map(
                          ...
                          <div key={idx} className="p-4 border rounded-lg">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                              <div>
                                ...
                                <span className="ml-2">
                                  {format(delivery.timestamp, 'MMM dd, HH:mm:ss')}
                                </span>
                              </div>
                              <div>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-900">
                          {formatNumber(
                            integrationData?.integrationAnalytics?.usageStatistics?.totalApiCalls,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-900">
                          {integrationData?.integrationAnalytics?.usageStatistics
                      ...
                      <div>
                        <div className="text-center mb-4">
                          <div className="text-3xl font-bold text-red-900">
                            {formatCurrency(
                              integrationData?.integrationAnalytics?.costAnalysis?.totalMonthlyCost,
                            )}
                          </div>
                        ...
                        <div className="space-y-2">
                          {Object.entries(
                            integrationData?.integrationAnalytics?.costAnalysis?.costByProvider ||
                              {},
                      ...
                      <div>
                        <div className="text-center mb-4">
                          <div className="text-3xl font-bold text-green-900">
                            {formatCurrency(
                              integrationData?.integrationAnalytics?.costAnalysis
                        ...
                        <div className="p-4 bg-green-50 border border-green-200 rounded">
                          <div className="text-sm text-green-700">
                            <div className="font-medium">
                              Cost per API call:{' '}
                              {formatCurrency(
                                integrationData?.integrationAnalytics?.costAnalysis?.costPerApiCall,
                              )}
                            </div>
