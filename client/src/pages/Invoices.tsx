        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">
              Generate and manage customer invoices from meter readings
            </p>
          </div>
          <Dialog
          ...
          >
            ...
            <DialogContent className="sm:max-w-[400px]">
              <DialogHeader>
                ...
                <DialogDescription>
                  Create an invoice from meter readings for a specific billing
                  period
                </DialogDescription>
              </DialogHeader>
              ...
              <CardHeader>
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <CardDescription>
                      {getCustomerName(invoice.customerId)} • Contract:{" "}
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Generate your first invoice from meter readings to start
                  billing customers.
                </p>
