...
import { FileText, Plus, Search, Calendar, Edit, Trash2, Eye, Calculator } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="font-medium text-gray-900">{entry.entryNumber}</span>
                      ...
                      <div className="text-sm text-gray-600 mt-1">
                        ...
                        <div className="flex items-center space-x-4 mt-1">
                          ...
                          <span className="flex items-center">
                            ...
                            Debit: ${entry.totalDebit.toFixed(2)} | Credit: $
                  ...
                  <div className="flex items-center space-x-2">
                    <Button size="sm" variant="outline" onClick={() => setViewingEntry(entry)}>
        ...
        <Dialog open={!!viewingEntry} onOpenChange={() => setViewingEntry(null)}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>View complete journal entry information.</DialogDescription>
            </DialogHeader>
            {viewingEntry && (
                    ...
                    <div className="mt-2 space-y-1 text-sm">
                      ...
                      <div>
                        ...
                        <Badge className={`ml-1 ${getStatusColor(viewingEntry.status)}`}>
                          {viewingEntry.status.charAt(0).toUpperCase() +
                            viewingEntry.status.slice(1)}
                        </Badge>
                      </div>
                      {viewingEntry.reference && (
                        <div>
                          <span className="text-gray-600">Reference:</span> {viewingEntry.reference}
                        </div>
                      )}
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="mt-2 space-y-1 text-sm">
                      <div>
                        ...
                        {viewingEntry.totalDebit.toFixed(2)}
                      </div>
                      <div>
                        <span className="text-gray-600">Total Credit:</span> $
                        {viewingEntry.totalCredit.toFixed(2)}
                      </div>
                      <div>
