...
export default function LeadDetailHubspot() {
  ...
  const lead = rawData
    ? {
        ...rawData,
        companyName: rawData.companyName || rawData.companyName,
        ...
        postalCode: rawData.postalCode || rawData.postalCode,
        ...
        createdBy: rawData.createdBy || rawData.createdBy,
        updatedBy: rawData.updatedBy || rawData.updatedBy,
        employeeCount: rawData.employee_count || rawData.employeeCount,
        annualRevenue: rawData.annual_revenue || rawData.annualRevenue,
        tenantId: rawData.tenantId || rawData.tenantId,
