...
import { 
  ...
  Calculator, Shield, Zap, BarChart3, FileCheck, Clock3, MapPin2
} from "lucide-react";
        ...
        <div className="flex items-center justify-between mb-6 bg-white p-6 rounded-lg shadow-sm border">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-semibold text-gray-900">{lead.companyName || 'Unnamed Lead'}</h1>
                <div className="flex items-center space-x-2 text-sm text-gray-600">
                  ...
                  <span>•</span>
                  <span>Created {lead.createdAt ? format(new Date(lead.createdAt), 'MMM d, yyyy') : 'Recently'}</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <Tabs defaultValue="overview" className="w-full">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.accountNumber || '--'}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Select value={editForm.companySize} onValueChange={(value) => setEditForm(prev => ({ ...prev, companySize: value }))}>
                              <SelectTrigger>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.employeeCount || '--'}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.annualRevenue ? `$${Number(lead.annualRevenue).toLocaleString()}` : '--'}
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.primaryContactName || '--'}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.primaryContactTitle || '--'}</p>
                          )}
                        </div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.primaryContactEmail ? (
                                <a href={`mailto:${lead.primaryContactEmail}`} className="text-blue-600 hover:underline">
                                  {lead.primaryContactEmail}
                                </a>
                              ) : '--'}
                            </p>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.primaryContactPhone ? (
                                <a href={`tel:${lead.primaryContactPhone}`} className="text-blue-600 hover:underline">
                                  {lead.primaryContactPhone}
                                </a>
                              ) : '--'}
                            </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.billingContactName || '--'}</p>
                          )}
                        </div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.billingContactEmail ? (
                                <a href={`mailto:${lead.billingContactEmail}`} className="text-blue-600 hover:underline">
                                  {lead.billingContactEmail}
                                </a>
                              ) : '--'}
                            </p>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.billingContactPhone ? (
                                <a href={`tel:${lead.billingContactPhone}`} className="text-blue-600 hover:underline">
                                  {lead.billingContactPhone}
                                </a>
                              ) : '--'}
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="md:col-span-2">
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.addressLine1 || '--'}</p>
                            )}
                          </div>
                          ...
                          <div className="md:col-span-2">
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.addressLine2 || '--'}</p>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.postalCode || '--'}</p>
                            )}
                          </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="md:col-span-2">
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingAddressLine1 || '--'}</p>
                            )}
                          </div>
                          ...
                          <div className="md:col-span-2">
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingAddressLine2 || '--'}</p>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingCity || '--'}</p>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingState || '--'}</p>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingPostalCode || '--'}</p>
                            )}
                          </div>
                          ...
                          <div>
                            ...
                            {isEditing ? (
                              ...
                              <p className="text-sm text-gray-900 mt-1">{lead.billingCountry || 'US'}</p>
                            )}
                          </div>
                        </div>
                      </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          {isEditing ? (
                            <Select value={editForm.leadSource} onValueChange={(value) => setEditForm(prev => ({ ...prev, leadSource: value }))}>
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Select value={editForm.salesStage} onValueChange={(value) => setEditForm(prev => ({ ...prev, salesStage: value }))}>
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Input
                              ...
                              onChange={(e) => setEditForm(prev => ({ ...prev, estimatedAmount: e.target.value ? parseFloat(e.target.value) : null }))}
                            />
                          ) : (
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.estimatedAmount ? `$${Number(lead.estimatedAmount).toLocaleString()}` : '--'}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Input
                              ...
                              onChange={(e) => setEditForm(prev => ({ ...prev, probability: e.target.value ? parseInt(e.target.value) : 0 }))}
                            />
                          ) : (
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">
                              {lead.closeDate ? format(new Date(lead.closeDate), 'MMM d, yyyy') : '--'}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Select value={editForm.interestLevel} onValueChange={(value) => setEditForm(prev => ({ ...prev, interestLevel: value }))}>
                              <SelectTrigger>
                                <SelectValue />
                              </SelectTrigger>
                              <SelectContent>
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.interestLevel || '--'}</p>
                          )}
                        </div>
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            <Input
                              ...
                              onChange={(e) => setEditForm(prev => ({ ...prev, leadScore: e.target.value ? parseInt(e.target.value) : 0 }))}
                            />
                          ) : (
                        ...
                        <div>
                          ...
                          {isEditing ? (
                            ...
                            <p className="text-sm text-gray-900 mt-1">{lead.assignedSalesRep || '--'}</p>
                          )}
                        </div>
              ...
              <TabsContent value="deals" className="mt-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-gray-600">Deals associated with this lead will be displayed here.</p>
                  </CardContent>
                </Card>
              </TabsContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant={lead.interestLevel === 'hot' ? 'destructive' : lead.interestLevel === 'warm' ? 'default' : 'secondary'}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-gray-900">
                      {lead.lastContactDate ? format(new Date(lead.lastContactDate), 'MMM d, yyyy') : '--'}
                    </span>
                  </div>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="text-sm text-gray-900 mt-1">{lead.externalCustomerId || '--'}</p>
                    )}
                  </div>
