...
const leaseFormSchema = z.object({
  ...
  status: z.enum(["pending", "active", "pending_renewal", "renewed", "expired", "terminated", "defaulted"]),
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Canon MFP Lease 2024" {...field} data-testid="input-lease-name" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="LS-2024-001" {...field} data-testid="input-lease-number" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="450.00" {...field} data-testid="input-monthly-payment" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
