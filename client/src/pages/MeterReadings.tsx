                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      {(reading.blackCopies || 0) > 0 && (
                        <p className="text-xs text-green-600">
                          +{(reading.blackCopies || 0).toLocaleString()} copies
                        </p>
                      )}
                    </div>
                  </div>
                    ...
                    <div>
                      ...
                      {(reading.colorCopies || 0) > 0 && (
                        <p className="text-xs text-blue-600">
                          +{(reading.colorCopies || 0).toLocaleString()} copies
                        </p>
                      )}
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="font-semibold">
                        {format(
                          new Date(reading.createdAt || new Date()),
                          "MMM dd, yyyy"
                        )}
                      </p>
                    </div>
            ...
            <Card>
              <CardContent className="p-12 text-center">
                ...
                <p className="text-gray-600 mb-4">
                  Start by adding your first meter reading to track equipment
                  usage and generate accurate billing.
                </p>
