          ...
          <div className="flex space-x-2">
            ...
            >
              ...
              <DialogContent className="max-w-2xl">
                ...
                <Form {...technicianForm}>
                  <form
                    onSubmit={technicianForm.handleSubmit(onTechnicianSubmit)}
                    className="space-y-4"
                  >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder="Printer Repair, Installation, Network Setup"
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
            ...
            >
              ...
              <DialogContent className="max-w-2xl">
                ...
                <Form {...workOrderForm}>
                  <form
                    onSubmit={workOrderForm.handleSubmit(onWorkOrderSubmit)}
                    className="space-y-4"
                  >
                    <div className="grid grid-cols-2 gap-4">
                      <FormField
            ...
            >
              ...
              <DialogContent className="max-w-2xl">
                ...
                <Form {...voiceNoteForm}>
                  <form
                    onSubmit={voiceNoteForm.handleSubmit(onVoiceNoteSubmit)}
                    className="space-y-4"
                  >
                    <FormField
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground">During travel</p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
