...
export default function MobileFieldService() {
  ...
  const currentSession = sessions.find(
    (s: MobileServiceSession) => s.status === 'checked_in' || s.status === 'in_progress',
  );
      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current GPS location and accuracy</CardDescription>
          </CardHeader>
          <CardContent>
            {locationError ? (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Check in and out of service locations</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Upload photos for service documentation</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <ObjectUploader
              maxNumberOfFiles={5}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>History of service visits and time tracking</CardDescription>
          </CardHeader>
          <CardContent>
            {sessions.length === 0 ? (
              <p className="text-muted-foreground text-center py-8">No service sessions found</p>
            ) : (
              <div className="space-y-4">
