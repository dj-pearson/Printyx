...
export default function MobileServiceApp() {
  ...
  const updateJobMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest(`/api/mobile/jobs/${data.jobId}/status`, {
        method: 'POST',
  ...
  const submitReportMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest('/api/mobile/service-report', {
        method: 'POST',
        body: JSON.stringify(data),
      }),
    onSuccess: () => {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {mobileData.technician.certification}
                    </div>
                  ...
                  <CardContent className="py-4">
                    <div className="flex justify-between items-start mb-3">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-700 mb-3">{job.issueDescription}</div>
                        ...
                        <div className="bg-gray-50 rounded p-2 text-sm">
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                {job.routeOptimization.distanceFromPrevious.toFixed(1)} miles
                              </span>
                            </div>
                            <div
                              className={`font-medium ${getTrafficColor(job.routeOptimization.trafficConditions)}`}
                            >
                ...
                <CardContent>
                  <div className="bg-blue-50 rounded-lg p-4 mb-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                      ...
                      <div>
                        <div className="text-lg font-bold text-blue-600">
                          {Math.floor(routeData.optimizedRoute.totalDriveTime / 60)}h{' '}
                          {routeData.optimizedRoute.totalDriveTime % 60}m
                        </div>
                        <div className="text-sm text-blue-700">Drive Time</div>
                      </div>
                      <div>
                        <div className="text-lg font-bold text-blue-600">
                          {Math.floor(routeData.optimizedRoute.totalServiceTime / 60)}h{' '}
                          {routeData.optimizedRoute.totalServiceTime % 60}m
                        </div>
                      ...
                      <div key={stop.jobId} className="border rounded-lg p-3">
                        ...
                        <div className="mt-2 text-sm text-gray-600">
                          <div className="flex justify-between">
                            ...
                            <span>
                              Window: {stop.serviceWindow.start} - {stop.serviceWindow.end}
                            </span>
                          </div>
                ...
                <CardContent>
                  ...
                  {mobileData.partsInventory.criticalLowItems.length > 0 && (
                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                      ...
                      <div className="space-y-1">
                        {mobileData.partsInventory.criticalLowItems.map(
                  ...
                  <div className="mt-4 flex justify-between items-center text-sm text-gray-600">
                    <span>
                      Last Restocked:{' '}
                      {format(new Date(mobileData.partsInventory.lastRestocked), 'MMM dd, yyyy')}
                    </span>
