...
import { TrendingUp, TrendingDown, AlertTriangle, CheckCircle, DollarSign, Target, BarChart3, ArrowRight } from "lucide-react";
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center p-3 bg-blue-50 rounded-lg border-2 border-blue-200">
                          ...
                          <span className={`font-bold text-xl ${getMarginColor(selectedContract.margin)}`}>
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          ...
                          <span className="font-bold text-orange-600">{selectedContract.emergencyCalls}</span>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                          <span className="text-gray-700">Renewal Date</span>
                          <span className="font-bold text-gray-900">{selectedContract.renewalDate}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-xl border-2 border-purple-200">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-white p-4 rounded-lg">
                        <div className="text-sm text-gray-600 mb-1">Predicted Next 12 Months Cost</div>
                          ...
                          {selectedContract.predictedCost > selectedContract.actualCost ? (
                            <>
                              ...
                              <span className="text-red-600">
                                +${(selectedContract.predictedCost - selectedContract.actualCost).toLocaleString()} vs current
                              </span>
                            </>
                          ) : (
                            <>
                              ...
                              <span className="text-green-600">
                                -${(selectedContract.actualCost - selectedContract.predictedCost).toLocaleString()} vs current
                              </span>
                            </>
                          )}
                        </div>
                      ...
                      <div className="bg-white p-4 rounded-lg">
                        ...
                        <div className={`text-2xl font-bold ${getMarginColor(selectedContract.predictedMargin)}`}>
                        ...
                        <div className="flex items-center mt-2 text-sm">
                          {selectedContract.predictedMargin < selectedContract.margin ? (
                            <>
                              ...
                              <span className="text-red-600">
                                {(selectedContract.margin - selectedContract.predictedMargin).toFixed(1)}% decline
                              </span>
                            </>
                          ) : (
                            <>
                              ...
                              <span className="text-green-600">
                                {(selectedContract.predictedMargin - selectedContract.margin).toFixed(1)}% improvement
                              </span>
                            </>
                          )}
                        </div>
                    ...
                    <div className="mt-4 p-4 bg-white rounded-lg">
                      <div className="text-sm text-gray-600 mb-1">Predicted Emergency Calls (Next 12 Mo)</div>
                      <div className="flex items-center justify-between">
                        <div className="text-2xl font-bold text-orange-600">
                          {selectedContract.predictedEmergencyCalls}
                        </div>
                        {selectedContract.predictedEmergencyCalls > selectedContract.emergencyCalls && (
                          <Badge className="bg-red-100 text-red-700">
                            +{selectedContract.predictedEmergencyCalls - selectedContract.emergencyCalls} increase expected
                          </Badge>
                        )}
                      </div>
                    </div>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg border-2 border-yellow-200">
                    <div className="flex items-start">
                      ...
                      <div className="text-sm text-gray-700">
                        ...
                        <p className="mt-1">
                          Based on 18 months of historical data, similar equipment profiles, and current service trends.
                        </p>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="space-y-2">
                          <div className="flex items-start">
                            ...
                            <span className="text-gray-700">
                              Schedule renewal conversation 60 days before {selectedContract.renewalDate}
                            </span>
                          </div>
                          <div className="flex items-start">
                            <CheckCircle className="h-5 w-5 text-blue-600 mr-2 mt-0.5" />
                          ...
                          {selectedContract.risk === "high" && (
                            <div className="flex items-start">
                              ...
                              <span className="text-gray-700 font-semibold">
                                If customer rejects repricing, prepare equipment replacement proposal
                              </span>
                            </div>
                          )}
                        </div>
