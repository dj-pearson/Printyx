                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-muted-foreground space-y-1">
                              <p>
                                Frequency: Every {schedule.frequency_value} {schedule.frequency}
                              </p>
                              ...
                              {schedule.business_record_name && (
                                <p>Company: {schedule.business_record_name}</p>
                              )}
                            </div>
                          </div>
                          <div className="text-right">
                    ...
                    {dueSchedules.map((schedule) => (
                      <div key={schedule.id} className="border rounded-lg p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right">
                            <p
                              className={`font-medium ${schedule.is_overdue ? 'text-red-600' : ''}`}
                            >
                              {format(new Date(schedule.next_service_date), 'MMM dd, yyyy HH:mm')}
                            </p>
                            {schedule.estimated_cost && (
