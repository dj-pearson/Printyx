      ...
      <div className="space-y-8">
          ...
          <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 pt-4 border-t">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {qbStatus.tokenExpires
                      ? new Date(qbStatus.tokenExpires).toLocaleString()
                      : 'Unknown'}
                  </p>
                </div>
              </div>
            ...
            {isConnecting && (
              <Alert>
                ...
                <AlertDescription>
                  Please complete the authorization in the popup window. This page will update
        ...
        {qbStatus?.connected && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Sync data between QuickBooks and Printyx</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>What you gain by connecting QuickBooks with Printyx</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
