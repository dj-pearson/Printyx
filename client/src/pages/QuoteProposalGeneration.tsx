...
export default function QuoteProposalGeneration() {
  ...
  const createTemplateMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest('/api/proposals/proposal-templates', {
        method: 'POST',
  ...
  const updateStatusMutation = useMutation({
    mutationFn: ({
      ...
      apiRequest(`/api/proposals/${id}/status`, {
        method: 'PATCH',
              ...
              <DialogContent className="w-[95vw] h-[95vh] max-w-none max-h-none p-0 gap-0 overflow-hidden">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-auto p-4 sm:p-6">
                    <Form {...templateForm}>
                      <form
                        onSubmit={templateForm.handleSubmit(onCreateTemplate)}
                        className="space-y-4"
                      >
              ...
              <DialogContent className="w-[95vw] h-[95vh] max-w-none max-h-none p-0 gap-0 overflow-hidden">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 overflow-auto p-4 sm:p-6">
                    <Form {...proposalForm}>
                      <form
                        onSubmit={proposalForm.handleSubmit(onCreateProposal)}
                        className="space-y-4"
                      >
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <FormField
                      ...
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Build comprehensive quotes with detailed product selection
                          </p>
                        </div>
                      </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Manage all your quotes and track their progress
                          </p>
                        </div>
                      </div>
                      <ul className="space-y-2 text-sm mb-4">
          ...
          <TabsContent value="proposals" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage and track all your customer proposals</CardDescription>
              </CardHeader>
              <CardContent>
                {proposalsLoading ? (
