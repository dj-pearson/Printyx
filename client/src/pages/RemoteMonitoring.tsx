...
export default function RemoteMonitoring() {
  ...
  const acknowledgeAlertMutation = useMutation({
    mutationFn: (data: any) =>
      apiRequest('/api/remote-monitoring/acknowledge-alert', {
        method: 'POST',
  ...
  const onlineEquipment = equipmentStatus.filter(
    (eq) => eq.connectionStatus === 'connected',
  ).length;
  const offlineEquipment = equipmentStatus.filter(
    (eq) => eq.connectionStatus === 'disconnected',
  ).length;
  const criticalAlerts = equipmentStatus.reduce(
    (sum, eq) => sum + eq.alerts.filter((alert) => alert.severity === 'critical').length,
    0,
  );
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-4">
                    Start monitoring your copier fleet to see real-time status.
                  </p>
                  <Button>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        {Object.entries(fleetOverview.statusDistribution).map(
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="w-20 bg-gray-200 rounded-full h-2">
                                  <div
                                    ...
                                    style={{
                                      width: `${(count / fleetOverview.summary.totalEquipment) * 100}%`,
                                    }}
                                  />
                                </div>
                              </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={200}>
                        <LineChart
                          data={fleetOverview.performanceTrends.weeklyUptime.map(
                            (uptime, index) => ({
                              day: `Day ${index + 1}`,
                              uptime,
                            ...
                            <div className="flex justify-between items-start mb-2">
                              <div>
                                ...
                                <div className="text-sm text-gray-600">
                                  {performer.customerName}
                                </div>
                              </div>
                              <Badge className="bg-green-100 text-green-800">#{idx + 1}</Badge>
                            </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="bg-blue-50 rounded-lg p-4">
                        ...
                        {sensorData.predictions.recommendedActions.map(
                            ...
                            <div key={idx} className="bg-white rounded p-3 mb-2">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <div className="text-sm text-gray-600">
                                    Prevents: {action.preventsPotentialIssue}
                                  </div>
                                </div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex justify-between">
                              ...
                              <span className="font-bold">
                                {sensorData.predictions.probabilityOfFailure.next7Days}%
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span>Next 30 days:</span>
                              <span className="font-bold">
                                {sensorData.predictions.probabilityOfFailure.next30Days}%
                              </span>
                            </div>
                            <div className="flex justify-between">
                              <span>Next 90 days:</span>
                              <span className="font-bold">
                                {sensorData.predictions.probabilityOfFailure.next90Days}%
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-green-50 rounded-lg p-4">
                          ...
                          <div className="space-y-2 text-sm">
                            {Object.entries(
                              sensorData.predictions.estimatedTonerReplacementDates,
                            ).map(([color, date]: [string, any]) => (
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">
                    Select Equipment for Analytics
                  </h3>
                  <p className="text-gray-600">
                    Choose equipment from the status tab to view detailed analytics.
                  </p>
                </CardContent>
              </Card>
            )}
              ...
              <CardContent>
                <div className="space-y-4">
                  {equipmentStatus
                    ...
                    .map((alert) => (
                      <div
                        key={`${alert.equipmentId}-${alert.id}`}
