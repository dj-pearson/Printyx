  ...
  const {
    ...
    select: (data: any) => ({
      ...
      threatDetection: {
        ...
        detectedThreats:
          data.threatDetection?.detectedThreats?.map((threat: any) => ({
            ...threat,
      ...
      complianceManagement: {
        ...
        regulations:
          data.complianceManagement?.regulations?.map((reg: any) => ({
            ...reg,
        ...
        actionItems:
          data.complianceManagement?.actionItems?.map((item: any) => ({
            ...item,
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Comprehensive security monitoring, threat detection, and regulatory compliance
              management
            </p>
          </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p
                        className={`text-2xl font-bold ${getSecurityScoreColor(securityData.securityOverview.overallSecurityScore)}`}
                      >
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">
                        {formatPercentage(
                          securityData.complianceManagement.complianceMetrics
            ...
            <Tabs defaultValue="threats" className="space-y-6">
              ...
              <TabsContent value="threats" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Live security monitoring and threat detection status
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-6">
                      ...
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-lg font-bold text-orange-900">
                          {securityData.threatDetection.realTimeMonitoring.threatScore.toFixed(1)}
                          /10
                        </div>
                      ...
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-lg font-bold text-green-900">
                          {formatPercentage(
                            securityData.threatDetection.realTimeMonitoring.monitoringUptime,
                          )}
                        </div>
                      ...
                      <div className="text-center p-3 border rounded-lg">
                        <div className="text-lg font-bold text-purple-900">
                          {format(
                            securityData.threatDetection.realTimeMonitoring.nextScheduledScan,
                            'HH:mm',
                          )}
                        </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {securityData.threatDetection.detectedThreats.map(
                        (threat: any, idx: number) => (
                          <div
                            key={idx}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {format(threat.detectedAt, 'MMM dd, HH:mm')}
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Investigator:</span>
                                <span className="ml-2 font-medium capitalize">
                                  {threat.investigator.replace('_', ' ')}
                                </span>
                              </div>
                            </div>
              ...
              <TabsContent value="compliance" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Current regulatory compliance status and metrics
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Status of regulatory frameworks and compliance requirements
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      {securityData.complianceManagement.regulations.map(
                          ...
                          <div key={idx} className="p-4 border rounded-lg">
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {regulation.compliantRequirements}/{regulation.requirements}
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Action Items:</span>
                                <span className="ml-2 font-medium">
                                  {regulation.actionItemsOpen} open
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Last Audit:</span>
                                <span className="ml-2 font-medium">
                                  {format(regulation.lastAudit, 'MMM dd, yyyy')}
                                </span>
                              </div>
                              <div>
                                <span className="text-gray-600">Next Audit:</span>
                                <span className="ml-2 font-medium">
                                  {format(regulation.nextAudit, 'MMM dd, yyyy')}
                                </span>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {format(regulation.expiryDate, 'MMM dd, yyyy')}
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="mb-3">
                              ...
                              <Progress
                                value={
                                  (regulation.compliantRequirements / regulation.requirements) * 100
                                }
                                className="h-2"
                              />
                            </div>
                            ...
                            <div className="flex justify-between items-center">
                              <Badge
                                className={
                                  regulation.certificationStatus === 'active'
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Outstanding compliance tasks and their progress
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {securityData.complianceManagement.actionItems.map(
                        (item: any, idx: number) => (
                          <div
                            key={idx}
                          ...
                          >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm mb-3">
                              ...
                              <div>
                                ...
                                <span className="ml-2 font-medium">
                                  {item.completedHours}/{item.estimatedHours}
                                </span>
                              </div>
                            </div>
              ...
              <TabsContent value="access" className="space-y-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      User access management and identity security metrics
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                      <div className="text-center p-4 border rounded-lg">
                        ...
                        <div className="text-xs text-blue-600 mt-1">
                          {securityData.accessControl.roleBasedAccess.customRoles} custom,{' '}
                          {securityData.accessControl.roleBasedAccess.defaultRoles} default
                        </div>
                      </div>
                      <div className="text-center p-4 border rounded-lg">
                      ...
                      <div className="text-center p-4 border rounded-lg">
                        <div className="text-2xl font-bold text-purple-900">
                          {formatPercentage(
                            securityData.accessControl.roleBasedAccess.leastPrivilegeCompliance,
                          )}
                        </div>
                    ...
                    <div className="mt-6 p-4 bg-green-50 rounded-lg border border-green-200">
                      ...
                      <p className="text-sm text-green-700">
                        No segregation of duties violations detected. All critical business
                        functions maintain proper access separation.
                      </p>
                    </div>
                  </CardContent>
                </Card>
              ...
              <TabsContent value="audits" className="space-y-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Security audit reports, compliance documentation, and regulatory filing
                    management
                  </p>
                  <Button>
