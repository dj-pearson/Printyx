...
export default function ServiceAnalytics() {
  ...
  const { data: technicianAnalytics = [], isLoading: techniciansLoading } = useQuery<
    TechnicianPerformanceAnalytic[]
  >({
      ...
      <div className="container mx-auto p-6 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-1 sm:gap-0">
            ...
            <TabsTrigger value="technicians" className="text-xs sm:text-sm px-2 py-2">
              Technicians
            </TabsTrigger>
            ...
            <TabsTrigger value="benchmarks" className="text-xs sm:text-sm px-2 py-2">
              Benchmarks
            </TabsTrigger>
          </TabsList>
              ...
              <Card>
                ...
                <CardContent>
                  {metricsLoading ? (
                    ...
                    <div className="space-y-3">
                      {(performanceMetrics as ServicePerformanceMetric[])
                        .slice(0, 5)
                        .map((metric) => (
                          <div
                            key={metric.id}
                          ...
                          >
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                {metric.total_service_calls} calls •{' '}
                                {metric.average_response_time_minutes.toFixed(0)} min avg
                              </p>
                            </div>
                            <div className="text-right">
                              ...
                              <div className="flex items-center space-x-1">
                                {getTrendIcon(
                                  metric.month_over_month_growth > 0
                                    ? 'up'
                                    : metric.month_over_month_growth < 0
                                      ? 'down'
                                      : 'stable',
                                ...
                                <span
                                  className={`text-xs ${getTrendColor(metric.month_over_month_growth > 0 ? 'up' : metric.month_over_month_growth < 0 ? 'down' : 'stable')}`}
                                >
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              ...
                              <Badge variant="outline">{metric.metric_period}</Badge>
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              <div>
                                ...
                                <p className="text-xs text-orange-600">
                                  {metric.emergency_calls} emergency
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Response Time</p>
                                <p className="font-medium">
                                  {metric.average_response_time_minutes.toFixed(0)} min
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">First Call Resolution</p>
                                <p className="font-medium">
                                  {metric.first_call_resolution_rate.toFixed(1)}%
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Satisfaction</p>
                                <p className="font-medium">
                                  {metric.average_satisfaction_score.toFixed(1)}/5
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Revenue</p>
                                <p className="font-medium">
                                  {formatCurrency(metric.total_service_revenue)}
                                </p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="text-xs text-red-600">
                                  {metric.jobs_completed_late} late
                                </p>
                              </div>
                              <div>
                                ...
                                <div className="flex items-center space-x-1">
                                  ...
                                  <span
                                    className={`font-medium ${getTrendColor(metric.month_over_month_growth > 0 ? 'up' : metric.month_over_month_growth < 0 ? 'down' : 'stable')}`}
                                  >
                                    {formatPercentage(metric.month_over_month_growth)}
                                  </span>
                                </div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              ...
                              <Badge variant="outline">{tech.analysis_type}</Badge>
                              {getTrendIcon(tech.improvement_trend)}
                              {tech.efficiency_ranking && (
                                <Badge variant="secondary">Rank #{tech.efficiency_ranking}</Badge>
                              )}
                            </div>
                            <div className="text-sm text-muted-foreground mb-3">
                              Period: {format(new Date(tech.analysis_period_start), 'MMM dd')} -{' '}
                              {format(new Date(tech.analysis_period_end), 'MMM dd, yyyy')}
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              <div>
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {tech.first_time_fix_rate.toFixed(1)}%
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Satisfaction</p>
                                <p className="font-medium">
                                  {tech.customer_satisfaction_avg.toFixed(1)}/5
                                </p>
                              </div>
                              <div>
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {tech.productivity_score.toFixed(0)}/100
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Target Achievement</p>
                                <p className="font-medium">
                                  {tech.monthly_target_achievement.toFixed(1)}%
                                </p>
                              </div>
                              <div>
                                ...
                                <div className="flex items-center space-x-1">
                                  {getTrendIcon(tech.improvement_trend)}
                                  <span
                                    className={`font-medium ${getTrendColor(tech.improvement_trend)}`}
                                  >
                      ...
                      <div key={customer.id} className="border rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-muted-foreground mb-3">
                              Period: {format(new Date(customer.analysis_period_start), 'MMM dd')} -{' '}
                              {format(new Date(customer.analysis_period_end), 'MMM dd, yyyy')}
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              <div>
                                <p className="text-muted-foreground">Service Calls</p>
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {customer.average_response_time.toFixed(1)}h
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Satisfaction</p>
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {formatCurrency(customer.total_service_spend)}
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Equipment Uptime</p>
                                <p className="font-medium">
                                  {customer.equipment_uptime_percentage.toFixed(1)}%
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Churn Risk</p>
                                <p className="font-medium">
                                  {customer.churn_risk_score.toFixed(0)}%
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Renewal Probability</p>
                                <p className="font-medium">
                                  {customer.contract_renewal_probability.toFixed(0)}%
                                </p>
                              </div>
                              <div>
                                <p className="text-muted-foreground">Upsell Opportunities</p>
                                <p className="font-medium">
                                  {customer.upsell_opportunities
                                    ? Object.keys(customer.upsell_opportunities).length
                                    : 0}
                                </p>
                              </div>
                            </div>
                      ...
                      <div key={trend.id} className="border rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              <h3 className="font-medium">
                                {trend.trend_category.replace('_', ' ')}
                              </h3>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              {trend.previous_value && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {trend.previous_value.toLocaleString()}
                                  </p>
                                </div>
                              )}
                              {trend.percentage_change && (
                                <div>
                                  ...
                                  <div className="flex items-center space-x-1">
                                    ...
                                    <span
                                      className={`font-medium ${getTrendColor(trend.percentage_change > 0 ? 'up' : trend.percentage_change < 0 ? 'down' : 'stable')}`}
                                    >
                              ...
                              {trend.forecasted_next_period && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {trend.forecasted_next_period.toLocaleString()}
                                  </p>
                      ...
                      <div key={benchmark.id} className="border rounded-lg p-4">
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center space-x-2 mb-2">
                              ...
                              {benchmark.performance_grade && (
                                <Badge
                                  variant={
                                    benchmark.performance_grade === 'A'
                                      ? 'default'
                                      : benchmark.performance_grade === 'B'
                                        ? 'secondary'
                                        : 'destructive'
                                  }
                                >
                            ...
                            <div className="text-sm text-muted-foreground mb-3">
                              Category: {benchmark.benchmark_category.replace('_', ' ')} • Impact:{' '}
                              {benchmark.business_impact}
                            </div>
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              {benchmark.current_performance && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {benchmark.current_performance.toLocaleString()}
                                  </p>
                                </div>
                              )}
                              {benchmark.company_target && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {benchmark.company_target.toLocaleString()}
                                  </p>
                                </div>
                              )}
                              {benchmark.industry_average && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {benchmark.industry_average.toLocaleString()}
                                  </p>
                                </div>
                              )}
                              {benchmark.percentile_ranking && (
                                <div>
                                  ...
                                  <p className="font-medium">
                                    {Number(benchmark.percentile_ranking || 0).toFixed(0)}th
                                  </p>
                                </div>
                              )}
                            </div>
                          ...
                          <div className="text-right space-y-2">
                            {benchmark.performance_grade && (
                              <div
                                className={`text-2xl font-bold ${getPerformanceColor(benchmark.performance_grade)}`}
                              >
                                {benchmark.performance_grade}
                              </div>
                            )}
