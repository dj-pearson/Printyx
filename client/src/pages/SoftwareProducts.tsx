...
export default function SoftwareProducts() {
  ...
  const handleEdit = (product: SoftwareProduct) => {
    ...
    const formData = {
      ...
      standardCost: product.standardCost != null ? String(product.standardCost) : '',
      standardRepPrice: product.standardRepPrice != null ? String(product.standardRepPrice) : '',
      newActive: product.newActive ?? false,
      newCost: product.newCost != null ? String(product.newCost) : '',
      newRepPrice: product.newRepPrice != null ? String(product.newRepPrice) : '',
      upgradeActive: product.upgradeActive ?? false,
      upgradeCost: product.upgradeCost != null ? String(product.upgradeCost) : '',
      upgradeRepPrice: product.upgradeRepPrice != null ? String(product.upgradeRepPrice) : '',
