...
import { CheckSquare, Brain, Folder, User, Layout, Plus, Settings, Zap } from 'lucide-react';
...
export default function TaskHub() {
  ...
  // Listen for createProject events from child components (e.g., ProjectsView empty state)
  useEffect(() => {
            ...
            <CardContent>
              <Tabs value={activeTab} className="space-y-6">
                ...
                <TabsContent value="ai-insights">
                  <AIInsightsView tasks={tasks} stats={taskStats} isLoading={isLoading} />
                </TabsContent>
