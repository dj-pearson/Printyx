                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Copier Repair, Network Setup, Maintenance"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span>
                      Active Tickets: <strong>{technician.activeTickets}</strong>
                    </span>
                    <span>
                      Completed: <strong>{technician.completedThisMonth}</strong>
                    </span>
                  </div>
                ...
                <div className="mt-4 pt-4 border-t">
                  <div className="flex justify-between">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        updateStatusMutation.mutate({ id: technician.id, status: value })
                      }
                    >
