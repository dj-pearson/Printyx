...
export default function TerritoryManagement() {
  ...
  const { data: territoriesData, isLoading } = useQuery({
    ...
    queryFn: () =>
      apiRequest(
        `/api/territories?${typeFilter !== 'all' ? `type=${typeFilter}&` : ''}${searchTerm ? `search=${searchTerm}` : ''}`,
      ),
  });
    ...
    <MainLayout>
      <div className="space-y-6">
          ...
          >
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                ...
                <DialogDescription>Define the territory rules and boundaries</DialogDescription>
              </DialogHeader>
                ...
                <div className="space-y-4 border-t pt-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="countries" {...register('countries')} placeholder="e.g., US, CA" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="states">States (comma-separated)</Label>
                      <Input id="states" {...register('states')} placeholder="e.g., NY, NJ, CT" />
                    </div>
                  </div>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div className="space-y-2">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">With available capacity</p>
            </CardContent>
          </Card>
        ...
        <div className="flex gap-4">
          ...
          <Button
            variant="outline"
            onClick={() => queryClient.invalidateQueries({ queryKey: ['/api/territories'] })}
          >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your sales territories and their rules</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
