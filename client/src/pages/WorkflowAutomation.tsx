  ...
  const {
    ...
    select: (data: any) => ({
      ...
      rulesEngine: {
        ...data.rulesEngine,
        rules:
          data.rulesEngine?.rules?.map((rule: any) => ({
            ...rule,
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Intelligent process automation with dynamic rules and smart orchestration
            </p>
          </div>
                    ...
                    <Card key={idx} className="hover:shadow-lg transition-shadow">
                      ...
                      <CardContent className="pt-0">
                        ...
                        <div className="flex flex-wrap gap-1 mb-3">
                          {template.features
                            .slice(0, 2)
                            .map((feature: string, featureIdx: number) => (
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-4 sm:mb-6">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center mt-2 text-sm">
                    ...
                    <span className="text-blue-600">
                      {formatDuration(workflowData.automationOverview.averageExecutionTime)} avg
                      time
                    </span>
                  </div>
                </CardContent>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="mt-2">
                    <Progress
                      value={workflowData.automationOverview.automationCoverage}
                      className="h-2"
                    />
            ...
            <Tabs defaultValue="workflows" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-1 sm:gap-0">
                <TabsTrigger value="workflows" className="text-xs sm:text-sm px-2 py-2">
                  Workflows
                </TabsTrigger>
                <TabsTrigger value="rules" className="text-xs sm:text-sm px-2 py-2">
                  Rules
                </TabsTrigger>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <CardDescription className="mt-1">
                              {workflow.category} • v{workflow.version} • Trigger:{' '}
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="font-medium text-green-600">
                                  {workflow.estimatedTimeSaved}h
                                </span>
                              </div>
                              <div className="flex justify-between">
                                <span>Cost Savings:</span>
                                <span className="font-medium text-green-600">
                                  {formatCurrency(workflow.metrics.costSavings)}
                                </span>
                              </div>
                            </div>
                          </div>
                                ...
                                <div key={stepIdx} className="flex items-center gap-2">
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="text-xs text-gray-500">
                                      ...
                                      {formatDuration(step.avgExecutionTime)}
                                    </div>
                                  </div>
                              ...
                              {workflow.triggers.map((trigger: any, triggerIdx: number) => (
                                <div key={triggerIdx} className="p-3 bg-gray-50 rounded-lg">
                                  <div className="text-sm font-medium capitalize mb-2">
                                    {trigger.type}{' '}
                                    {trigger.event && `(${trigger.event.replace('_', ' ')})`}
                                  </div>
                                  {trigger.conditions && (
                                    <div className="space-y-1">
                                      {trigger.conditions
                                        .slice(0, 2)
                                        .map((condition: any, condIdx: number) => (
                          ...
                          <div className="flex items-center justify-between text-sm">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                ...
                                <span className="ml-2">
                                  {format(workflow.lastModified, 'MMM dd, yyyy')}
                                </span>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <div className="text-sm text-green-600">
                              {formatPercentage(rule.successRate)} success
                            </div>
                          </div>
                        </div>
                              ...
                              <div className="space-y-1">
                                {rule.actions.map((action: any, actionIdx: number) => (
                                  <div key={actionIdx} className="text-xs text-green-700">
                                    ...
                                    {action.value && <span className="ml-1">: {action.value}</span>}
                                    {action.targets && (
              ...
              <TabsContent value="analytics" className="space-y-6">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-900">
                          {Math.round(
                            workflowData.performanceAnalytics.businessImpact.totalTimeSaved,
                          )}
                          h
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-900">
                          {formatCurrency(
                            workflowData.performanceAnalytics.businessImpact.totalCostSavings,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-900">
                          {formatPercentage(
                            workflowData.performanceAnalytics.businessImpact.errorReduction,
                          )}
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-purple-900">
                          {formatPercentage(
                            workflowData.performanceAnalytics.businessImpact
                      ...
                      <div className="text-center">
                        <div className="text-2xl font-bold text-orange-900">
                          {formatPercentage(
                            workflowData.performanceAnalytics.businessImpact.processEfficiencyGain,
                          )}
                        </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Best performing automation workflows by impact
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      {workflowData.performanceAnalytics.topPerformingWorkflows.map(
                        (workflow: any, idx: number) => (
                          <div
                            key={idx}
                          ...
                          >
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-gray-600">
                                ...
                                {formatPercentage(workflow.successRate)} success rate
                              </div>
                            </div>
                            <div className="text-right">
                              <div className="font-bold text-green-600">
                                {workflow.timeSaved}h saved
                              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      {workflowData.performanceAnalytics.errorAnalysis.map(
                        (error: any, idx: number) => (
                          ...
                          >
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-gray-600">
                                {error.count} occurrences • {formatPercentage(error.percentage)} of
                                total errors
                              </div>
                            </div>
                            <div className="text-right">
                      ...
                      <CardContent>
                        ...
                        <div className="space-y-3 mb-4">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="text-sm font-medium">
                              {formatPercentage(template.popularity)}
                            </span>
                          </div>
                          <div className="flex justify-between">
              ...
              <TabsContent value="builder" className="space-y-6">
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-6 max-w-md mx-auto">
                    Build custom workflows using our drag-and-drop interface with smart triggers,
