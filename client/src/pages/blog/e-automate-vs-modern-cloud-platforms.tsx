  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <section>
          <p className="text-lg">
            For years, e-automate dominated the copier dealer management space. It was the industry
            standard—because there wasn't much alternative. But technology has evolved dramatically
            since e-automate's architecture was designed in the early 2000s.
          </p>
          <p className="text-lg mt-4">
            Today's modern cloud-native platforms aren't just "better versions" of legacy systems.
            They're built on fundamentally different architecture that makes features like
            AI-powered predictive maintenance, real-time profitability analysis, and offline-first
            mobile apps not just possible—but standard.
          </p>
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">
                    Legacy Architecture (e-automate)
                  </h3>
                </div>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      <strong>Monolithic design</strong> from early 2000s
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>On-premise servers</strong> requiring IT maintenance
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Desktop-first UI</strong> built for Windows
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Quarterly updates</strong> at best
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-red-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>SQL Server database</strong> optimized for transactions
                    </span>
                  </li>
                </ul>
              </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      <strong>Microservices</strong> built in 2024
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Cloud-native</strong> on AWS/GCP infrastructure
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Mobile-first React</strong> running everywhere
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Weekly releases</strong> with continuous deployment
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-green-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>PostgreSQL + ML pipeline</strong> for analytics
                    </span>
                  </li>
                </ul>
              </CardContent>
          ...
          <Card className="bg-blue-50 border-2 border-blue-300 my-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-800">
                Architecture isn't just "technical details"—it's what determines what features are
                possible, how fast you can innovate, and whether you can compete in 2025. Legacy
                architecture creates a <strong>2-3 year innovation gap</strong> that compounds over
                time.
              </p>
            </CardContent>
          </Card>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-900 mb-6">
            Technical Deep Dive: Why Legacy Can't Compete
          </h2>

          <p className="text-lg mb-6">
            Let's break down the specific technical limitations that make modern features impossible
            on legacy platforms:
          </p>
          ...
          <div className="space-y-8">
            ...
            <div className="border-l-4 border-purple-600 pl-6 py-2">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-4">
                ...
                <p className="text-gray-700 mb-3">
                  Traditional SQL Server database optimized for CRUD operations. Schema designed for
                  transactional processing, not analytical queries.
                </p>
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6">
                ...
                <p className="text-gray-700 mb-3">
                  PostgreSQL with specialized extensions for time-series and analytics, plus
                  separate data warehouse for ML training.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            <div className="border-l-4 border-blue-600 pl-6 py-2">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-4">
                ...
                <p className="text-gray-700 mb-3">
                  No AI/ML infrastructure. "Analytics" means pre-built SQL reports. No capability
                  for pattern recognition or prediction.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
            ...
            <div className="border-l-4 border-orange-600 pl-6 py-2">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-4">
                ...
                <p className="text-gray-700 mb-3">
                  Desktop app wrapped in mobile container. Requires constant connectivity. Limited
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6">
                ...
                <p className="text-gray-700 mb-3">
                  Offline-first Progressive Web App with native capabilities. Works anywhere for 72
                ...
                <p className="text-gray-800 font-semibold mt-4">
                  Result: Technicians complete 30% more calls daily with offline-first mobile
                  architecture.
                </p>
              </div>
            </div>
            ...
            <div className="border-l-4 border-green-600 pl-6 py-2">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-4">
                ...
                <p className="text-gray-700 mb-3">
                  Proprietary APIs with limited documentation. Custom development required for each
                  integration. Vendor lock-in by design.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6">
                ...
                <p className="text-gray-700 mb-3">
                  RESTful API with comprehensive documentation. Open partner ecosystem with revenue
                  sharing. Network effects that compound value.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                ...
                <p className="text-gray-800 font-semibold mt-4">
                  Result: Every integration makes the platform more valuable—network effects
            ...
            <div className="border-l-4 border-indigo-600 pl-6 py-2">
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-4">
                ...
                <p className="text-gray-700 mb-3">
                  Monolithic codebase where changes in one area break others. Quarterly releases
                  after extensive testing. Can't iterate fast.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
              ...
              <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6">
                ...
                <p className="text-gray-700 mb-3">
                  Microservices architecture enables independent updates. Continuous deployment
                  means weekly feature releases and same-day bug fixes.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
          ...
          <Card className="bg-gradient-to-r from-yellow-50 to-orange-50 border-2 border-orange-300">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                The 2-3 Year Technical Advantage
              </h3>
              <p className="text-gray-800 mb-4">
                Modern platforms aren't just "a bit ahead"—they have a structural advantage that
                compounds over time:
              </p>
              <div className="space-y-4 mt-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Modern platforms match legacy features while adding AI capabilities legacy
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      52 releases vs. 4 means modern platforms add features 13x faster. Gap widens
                      to 12-18 months.
                    </p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Network effects kick in (integrations, ML models). Legacy vendors can't catch
                      up without complete rebuild.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Offline-first mobile</strong> boosts technician productivity 30%
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Weekly updates</strong> mean continuous improvement
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      <strong>Integration marketplace</strong> adds value continuously
                    </span>
                  </li>
                </ul>
              </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      Manual pricing guesswork leaves money on table
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      Technicians struggle with clunky mobile tools
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0 mt-0.5" />
                    <span className="text-gray-700">
                      Wait months for bug fixes and new features
                    </span>
                  </li>
                  <li className="flex items-start">
                    <XCircle className="h-5 w-5 text-gray-600 mr-2 flex-shrink-0 mt-0.5" />
        ...
        <section>
          ...
          <p className="text-lg mb-6">
            The biggest objection we hear: "But we have years of data in e-automate. Migration seems
            impossible."
          </p>

          <p className="text-lg mb-6">
            Reality: Modern platforms are designed for seamless migration. Here's how it actually
            works:
          </p>
          ...
          <Card className="bg-green-50 border-2 border-green-300 mt-8">
            <CardContent className="p-6">
              ...
              <p className="text-gray-800">
                Most dealers are fully operational on modern platforms within 2 months—with full
                data history intact and immediate access to features impossible on legacy systems.
              </p>
            </CardContent>
          </Card>
        </section>
        ...
        <section>
          ...
          <p className="text-lg mb-4">
            This isn't about brand loyalty or "what you're used to." It's about fundamental
            technology architecture and what's possible in 2025.
          </p>

          <p className="text-lg mb-4">
            Legacy systems like e-automate were great for their time. But their architecture can't
            support modern AI/ML capabilities, real-time analytics, or offline-first mobile
            experiences. No amount of updates or "cloud versions" can fix fundamental architectural
            limitations.
          </p>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white my-8">
            ...
            <p className="text-lg mb-6">
              You can either lead the transition to modern architecture—or spend the next 2-3 years
              falling further behind competitors who made the switch.
            </p>
