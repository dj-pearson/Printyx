...
import { CalendarIcon, RefreshCw, Building2, Wrench, Clock, CheckCircle2 } from 'lucide-react';
 ...
 * summary.totalLocations, summary.avgFirstTimeFixRate, insights.healthStatus, an
 * `aggregated` priority breakdown, `locations`, `slas` and `activities` collections, and
 * per-row ranking / locationCount / technicianCount / firstTimeFixRate /
...
export default function ServiceSupervisorDashboard() {
  ...
  // Fetch service call volume per unit (Report 29)
  const {
  ...
  // Fetch performance per unit (Report 30)
  ...
  // Fetch SLA per unit (Report 31) — degraded upstream, see below
  ...
  // Fetch technician activity per unit (Report 32)
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Monitor location service volume, resolution times, and technician activity
          </p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            {/* CR-034: read summary.overallCompliance / locationsOnTrack /
                locationsAtRisk, none of which exist. The endpoint is degraded
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Service Calls by Location</CardTitle>
            ...
            <CardContent>
              {/* CR-034: this was "Service Calls by Priority", mapping an
                  `aggregated` array of { priority, avgCallsPerLocation, avgDuration }.
        ...
        <TabsContent value="sla" className="space-y-4">
          <Card>
            ...
            <CardContent>
              {/* CR-034: mapped slaData.slas with locationId, locationName,
