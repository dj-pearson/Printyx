            ...
            <CardContent className="p-8 space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  ("User," "you," or "your") and Printyx LLC ("Company," "we," "us," or "our") for
                  the use of the Printyx software platform and related services ("Software" or
                  "Platform"). By accessing, downloading, installing, or using the Software, you
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Subject to the terms of this Agreement, Company grants you a non-exclusive,
                      non-transferable, revocable license to use the Software solely for your
                      internal business operations as a copier dealer, distributor, or related
                      business entity.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You may permit your employees, contractors, and authorized representatives to
                      use the Software on your behalf, provided they comply with this Agreement. You
                      are responsible for ensuring all authorized users comply with these terms.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">2.3 Multi-Tenant Access</h3>
                    <p className="text-gray-700 leading-relaxed">
                      The Software operates on a multi-tenant architecture. Your license grants
                      access to your designated tenant environment only. You may not access, attempt
                      to access, or interfere with other tenant environments.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <ul className="list-disc pl-6 space-y-2 text-gray-700">
                    ...
                    <li>
                      Distribute, sell, lease, rent, or sublicense the Software to third parties
                    </li>
                    <li>
                    ...
                    <li>
                      Interfere with or disrupt the Software's functionality or security measures
                    </li>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      remains the exclusive property of Company and its licensors. This Agreement
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You retain ownership of all data, content, and information you input into the
                      Software ("Customer Data"). Company will handle Customer Data in accordance
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Any suggestions, feedback, or improvements you provide regarding the Software
                      may be used by Company without restriction or compensation to you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Company implements industry-standard security measures to protect your data,
                      including encryption, access controls, and regular security assessments.
                      However, no system is completely secure, and you acknowledge the inherent
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      applicable laws, regulations, and industry standards, including but not
                      limited to data protection, privacy, and financial regulations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  QuickBooks, Salesforce, E-Automate, ZoomInfo, and Apollo.io. Your use of these
                  integrations is subject to the respective third-party terms of service and privacy
                  policies. Company is not responsible for third-party services' availability,
                  functionality, or data handling practices.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Access to the Software is provided on a subscription basis. Subscription
                      terms, features, and pricing are specified in your subscription agreement or
                      order form.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You agree to pay all applicable fees as specified in your subscription plan.
                      Fees are non-refundable except as expressly provided in your subscription
                      agreement.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Either party may terminate this Agreement with written notice. Company may
                      immediately terminate or suspend your access if you breach this Agreement or
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Upon termination, your right to use the Software immediately ceases. Company
                      will provide reasonable assistance for data export within 30 days of
                      termination, after which your data may be permanently deleted.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  THE SOFTWARE IS PROVIDED "AS IS" WITHOUT WARRANTIES OF ANY KIND. COMPANY DISCLAIMS
                  ...
                  DOES NOT WARRANT THAT THE SOFTWARE WILL BE ERROR-FREE, UNINTERRUPTED, OR
                  COMPLETELY SECURE.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, COMPANY'S LIABILITY FOR ANY CLAIMS ARISING
                  FROM OR RELATED TO THIS AGREEMENT SHALL NOT EXCEED THE TOTAL AMOUNT PAID BY YOU
                  FOR THE SOFTWARE IN THE TWELVE MONTHS PRECEDING THE CLAIM. IN NO EVENT SHALL
                  COMPANY BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  You agree to indemnify and hold harmless Company from any claims, damages, or
                  expenses arising from your use of the Software, violation of this Agreement, or
                  infringement of third-party rights through your use of the Software.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      This Agreement, together with your subscription agreement and our Privacy
                      Policy, constitutes the entire agreement between the parties and supersedes
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Company may modify this Agreement with reasonable notice. Continued use of the
                      Software after notice constitutes acceptance of the modified terms.
                    </p>
                  </div>
                  <div>
