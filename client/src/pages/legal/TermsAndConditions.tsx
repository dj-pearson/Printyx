            ...
            <CardContent className="p-8 space-y-8">
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  These Terms and Conditions ("Terms," "Agreement") govern your use of the Printyx
                  software platform and related services ("Platform," "Services") provided by
                  Printyx LLC ("Company," "we," "us," or "our"). By accessing or using our Platform,
                  you ("User," "Customer," "you") agree to be bound by these Terms. If you disagree
                  with any part of these Terms, you may not access or use our Platform.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    Printyx is a comprehensive business management platform designed specifically
                    for copier dealers, distributors, and related businesses. Our Platform provides:
                  </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      this Agreement. Our Platform is intended for business use by copier dealers,
                      distributors, and related commercial entities.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">3.2 Account Registration</h3>
                    <p className="text-gray-700 leading-relaxed">
                      To access our Platform, you must create an account by providing accurate,
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You must immediately notify us of any unauthorized use of your account or any
                      security breach. We reserve the right to suspend or terminate accounts that
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Our Platform is offered on a subscription basis with various plans and pricing
                      tiers. Specific terms, features, and pricing are detailed in your subscription
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We may modify subscription pricing with 30 days' written notice. Price changes
                      will take effect at your next renewal period.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">4.4 Taxes</h3>
                    <p className="text-gray-700 leading-relaxed">
                      You are responsible for all applicable taxes, duties, and government-imposed
                      fees related to your use of our Platform.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You may use our Platform solely for legitimate business purposes related to
                      copier dealer operations, in compliance with all applicable laws and these
                      Terms.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      All content you upload or transmit through our Platform must be lawful,
                      accurate, and not infringe on third-party rights. You are solely responsible
                      for your content and its compliance with applicable laws.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      You retain ownership of all data, content, and information you input into our
                      Platform ("Customer Data"). We will handle Customer Data in accordance with
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Upon termination, we will provide reasonable assistance for data export within
                      30 days. After this period, your data may be permanently deleted from our
                      systems.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      QuickBooks, Salesforce, E-Automate, ZoomInfo, Apollo.io, and other business
                      systems.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Your use of third-party integrations is subject to the respective third-party
                      terms of service and privacy policies. We are not responsible for third-party
                      services' availability, functionality, or data handling practices.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">7.3 Integration Liability</h3>
                    <p className="text-gray-700 leading-relaxed">
                      We provide integrations "as is" and disclaim responsibility for any issues
                      arising from third-party service disruptions, changes, or data handling.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      outages that temporarily affect service availability.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">8.2 Customer Support</h3>
                    <p className="text-gray-700 leading-relaxed">
                      We provide customer support according to your subscription plan. Support
                      levels, response times, and availability are detailed in your service
                      agreement.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We may update, modify, or enhance our Platform at any time. Updates may
                      include new features, security improvements, or changes to existing
                      functionality.
                    </p>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      The Platform, including all software, technology, content, and intellectual
                      property rights, is owned by Company and protected by copyright, trademark,
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      Platform solely for your internal business purposes during your subscription
                      term.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Any feedback, suggestions, or improvements you provide regarding our Platform
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We may terminate your access immediately if you breach these Terms, fail to
                      pay fees, or engage in prohibited activities. We may also terminate with 30
                      days' notice for business reasons.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">10.3 Effect of Termination</h3>
                    <p className="text-gray-700 leading-relaxed">
                      Upon termination, your access to the Platform ceases, outstanding fees become
                      due, and we will provide data export assistance as specified in Section 6.3.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      OUR PLATFORM IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We do not guarantee that our Platform will meet your specific requirements, be
                      error-free, uninterrupted, or completely secure. You acknowledge the inherent
                      limitations of software platforms.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      ARISING FROM OR RELATED TO YOUR USE OF OUR PLATFORM SHALL NOT EXCEED THE TOTAL
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  (including attorney fees) arising from your use of our Platform, violation of
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      These Terms, together with your subscription agreement, Privacy Policy, and
                      any additional terms, constitute the entire agreement between the parties.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-medium mb-2">15.2 Modifications</h3>
                    <p className="text-gray-700 leading-relaxed">
                      We may modify these Terms at any time with reasonable notice. Continued use of
                      our Platform after modification constitutes acceptance of the updated Terms.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      these Terms to any affiliate or successor entity.
                    </p>
                  </div>
                </div>
              </div>
