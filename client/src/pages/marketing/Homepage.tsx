  ...
  const benefits = [
    {
      ...
      description: "Modern cloud-native architecture built on React, PostgreSQL, and AI/ML infrastructure. While competitors struggle with legacy codebases, we iterate and innovate weekly. Impossible to catch up without a complete platform rebuild.",
      highlight: "Modern vs. Legacy",
    },
    {
      icon: Activity,
      title: "Intelligence Layer: Predictive vs. Reactive",
      description: "AI models trained on dealer operations data predict equipment failures, optimize pricing, and identify opportunities. Competitors offer basic reporting—we offer intelligence that learns and improves daily. Cannot be replicated without massive ML investment.",
      highlight: "AI-Powered",
    },
    {
      icon: Users,
      title: "Network Effects: Growing Ecosystem",
      description: "Integration marketplace with 20+ partners and growing. Every integration makes the platform more valuable. Every dealer using our platform improves our AI models. Value compounds exponentially—competitors start at zero.",
      highlight: "Marketplace",
    },
    {
      icon: Printer,
      title: "Domain Expertise: Built by Dealer Operators",
      description: "Deep understanding of copier dealer operations from meter billing quirks to service dispatch realities. Every feature designed for real workflows, not abstract ERP concepts. Defensible through execution excellence.",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              AI-powered features that prevent problems before they happen, optimize pricing automatically, and transform copier dealer operations from reactive to predictive.
            </p>
          </div>
      ...
      <section id="benefits" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Four strategic advantages that compound over time and create an insurmountable lead over legacy dealer management systems.
            </p>
          </div>
          ...
          <div className="mt-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">Real results from copier dealers using Printyx</p>
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See why dealers are switching from e-automate and other legacy platforms to Printyx's modern, AI-powered architecture.
            </p>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Wait for equipment to fail, then react. No predictive insights.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">10+ year old codebase. Slow updates, expensive customization.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Guess at contract pricing. No profitability intelligence.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Limited integrations. Vendor lock-in. Expensive add-ons.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-red-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Mobile app is an afterthought. Requires constant connectivity.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">AI predicts failures 30 days ahead. Prevent 30-40% of emergencies.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Built in 2024 on React, PostgreSQL, AI/ML. 2-3 year technical lead.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Dynamic pricing engine. Increase margins 15-25% automatically.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">20+ integrations and growing. Open API. Network effects.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">Works offline 72 hours. Built for field technicians.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section id="testimonials" className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Real feedback from copier dealers who switched to predictive operations and never looked back.
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Stop Reacting. Start Predicting.<br/>Switch to Modern Architecture Today.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-gray-100 hover:scale-105 transition-transform text-lg px-10 py-7 shadow-2xl"
              onClick={() => window.location.href = '/signup'}
            >
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-10 py-7 border-2 border-white text-white hover:bg-white hover:text-blue-600 transition-all"
              onClick={() => window.location.href = '/login'}
            >
              Watch Platform Demo
            </Button>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-gray-400 text-sm mb-4">
                The AI-powered predictive intelligence platform for copier dealers. Modern architecture, 2-3 year technical advantage over legacy systems.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#features" className="text-gray-400 hover:text-white transition-colors">Predictive Intelligence</a></li>
                <li><a href="#features" className="text-gray-400 hover:text-white transition-colors">Contract Profitability</a></li>
                <li><a href="#features" className="text-gray-400 hover:text-white transition-colors">Smart Service Dispatch</a></li>
                <li><a href="#features" className="text-gray-400 hover:text-white transition-colors">Integration Marketplace</a></li>
                <li><a href="#features" className="text-gray-400 hover:text-white transition-colors">Mobile App</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#benefits" className="text-gray-400 hover:text-white transition-colors">AI Equipment Failure Detection</a></li>
                <li><a href="#benefits" className="text-gray-400 hover:text-white transition-colors">Dynamic Pricing Engine</a></li>
                <li><a href="#benefits" className="text-gray-400 hover:text-white transition-colors">Workflow Automation</a></li>
                <li><a href="#benefits" className="text-gray-400 hover:text-white transition-colors">Revenue Intelligence</a></li>
                <li><a href="#benefits" className="text-gray-400 hover:text-white transition-colors">Natural Language CRM</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="#testimonials" className="text-gray-400 hover:text-white transition-colors">Customer Stories</a></li>
                <li><a href="/login" className="text-gray-400 hover:text-white transition-colors">Login</a></li>
                <li><a href="/signup" className="text-gray-400 hover:text-white transition-colors">Start Free Trial</a></li>
