...
_Generated after automated schema validation and fixing_  
_Backup Location: `tests/backups/2026-01-27T03-43-16.643Z/`_  
_Next Validation: Run `npm run validate:schema` after any schema changes_
