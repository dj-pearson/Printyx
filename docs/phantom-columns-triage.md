...
322 references. 198 have a textually similar column on the same table, so they are probably renames; 124 have none.
...
| ---------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------- |
| `activity_reports.type`                        | **none — redesign, not a rename**                                   | root-admin/index.ts                       |
| `alert_configurations.recipient_user_id`       | `user_id`, `id`                                                     | voice-agent/index.ts                      |
...
| `audit_logs.created_at`                        | **none — redesign, not a rename**                                   | user-management/index.ts                  |
| `audit_logs.created_at`                        | **none — redesign, not a rename**                                   | user/index.ts                             |
| `blog_assets.filename`                         | **none — redesign, not a rename**                                   | blog-platform-api/index.ts                |
| `blog_dsar_requests.updated_at`                | `requested_at`, `completed_at`                                      | blog-platform-api/index.ts                |
| `blog_outreach_threads.has_link`               | **none — redesign, not a rename**                                   | blog-outreach/index.ts                    |
| `business_record_activities.notes`             | **none — redesign, not a rename**                                   | activities/index.ts                       |
| `business_records.assigned_to`                 | **none — redesign, not a rename**                                   | auto-lead-routing/index.ts                |
| `business_records.billing_postal_code`         | `postal_code`, `billing_zip_code`                                   | sales-rep-assignments/index.ts            |
...
| `business_records.estimated_amount`            | **none — redesign, not a rename**                                   | sales-rep-assignments/index.ts            |
...
| `business_records.routed_at`                   | `created_at`, `updated_at`                                          | auto-lead-routing/index.ts                |
| `business_records.routing_rule_id`             | `id`                                                                | auto-lead-routing/index.ts                |
| `business_records.tags`                        | **none — redesign, not a rename**                                   | chrome-extension/index.ts                 |
| `chart_of_accounts.account_number`             | `account_code`, `account_name`, `account_type`                      | chart-of-accounts/index.ts                |
| `chart_of_accounts.balance`                    | `current_balance`, `debit_balance`, `credit_balance`                | chart-of-accounts/index.ts                |
| `companies.company_code`                       | `sic_code`                                                          | company-ids/index.ts                      |
| `companies.company_name`                       | `business_name`                                                     | company-ids/index.ts                      |
| `companies.duns_number`                        | `customer_number`                                                   | company-ids/index.ts                      |
| `companies.email`                              | **none — redesign, not a rename**                                   | business-records/index.ts                 |
| `companies.email`                              | **none — redesign, not a rename**                                   | customers/index.ts                        |
| `companies.external_id`                        | `id`, `tenant_id`                                                   | company-ids/index.ts                      |
| `companies.metadata`                           | **none — redesign, not a rename**                                   | company-ids/index.ts                      |
| `companies.status`                             | **none — redesign, not a rename**                                   | demos/index.ts                            |
| `companies.tax_id`                             | `id`, `tenant_id`, `tax_state`                                      | company-ids/index.ts                      |
| `company_contacts.is_primary`                  | `is_primary_contact`                                                | business-records/index.ts                 |
| `company_contacts.is_primary`                  | `is_primary_contact`                                                | contacts/index.ts                         |
| `contract_renewals.final_value`                | `value_change`                                                      | contract-renewals/index.ts                |
| `contract_renewals.lost_at`                    | `created_at`, `updated_at`                                          | contract-renewals/index.ts                |
| `contract_renewals.lost_reason`                | `renewal_lost_reason`                                               | contract-renewals/index.ts                |
| `contract_renewals.notes`                      | `internal_notes`                                                    | contract-renewals/index.ts                |
| `contract_renewals.owner_id`                   | `account_owner_id`, `renewal_owner_id`, `id`                        | contract-renewals/index.ts                |
| `contract_renewals.proposed_value`             | `proposed_contract_value`, `proposed_mrr`, `proposed_arr`           | contract-renewals/index.ts                |
| `contract_renewals.renewal_date`               | `renewal_notice_date`, `renewal_target_date`, `renewal_closed_date` | contract-renewals/index.ts                |
| `contract_renewals.risk_calculated_at`         | **none — redesign, not a rename**                                   | contract-renewals/index.ts                |
| `contract_renewals.risk_level`                 | `renewal_risk_level`, `risk_factors`                                | contract-renewals/index.ts                |
| `contract_renewals.status`                     | `renewal_status`                                                    | contract-renewals/index.ts                |
| `contract_renewals.won_at`                     | `created_at`, `updated_at`                                          | contract-renewals/index.ts                |
| `contracts.churn_notes`                        | **none — redesign, not a rename**                                   | contract-renewal/index.ts                 |
| `contracts.churn_reason`                       | **none — redesign, not a rename**                                   | contract-renewal/index.ts                 |
| `contracts.churned_at`                         | `created_at`, `updated_at`                                          | contract-renewal/index.ts                 |
| `contracts.contract_type`                      | `contract_number`                                                   | contract-renewal/index.ts                 |
| `contracts.created_by`                         | `created_at`                                                        | contract-renewal/index.ts                 |
| `contracts.monthly_value`                      | `monthly_base`                                                      | contract-renewal/index.ts                 |
| `contracts.previous_contract_id`               | `id`                                                                | contract-renewal/index.ts                 |
| `contracts.renewal_status`                     | `status`                                                            | contract-renewal/index.ts                 |
| `contracts.renewed_contract_id`                | `id`                                                                | contract-renewal/index.ts                 |
| `customer_churn_scores.end_date`               | **none — redesign, not a rename**                                   | daily-briefing/briefing.ts                |
| `customer_churn_scores.status`                 | **none — redesign, not a rename**                                   | daily-briefing/briefing.ts                |
...
| `deals.current_stage_id`                       | `stage_id`, `id`                                                    | pipeline-config/index.ts                  |
...
| `deals.pipeline_template_id`                   | `id`                                                                | pipeline-config/index.ts                  |
...
| `device_alerts.acknowledged`                   | `acknowledged_at`, `acknowledged_by`                                | remote-monitoring/index.ts                |
...
| `device_alerts.triggered_at`                   | `acknowledged_at`, `resolved_at`, `created_at`                      | client-metrics/index.ts                   |
...
| `enriched_contacts.external_id`                | `company_external_id`, `id`, `tenant_id`                            | data-enrichment/index.ts                  |
| `enriched_contacts.external_id`                | `company_external_id`, `id`, `tenant_id`                            | enrichment/index.ts                       |
| `enriched_contacts.phone`                      | `direct_phone`, `mobile_phone`                                      | data-enrichment/index.ts                  |
| `enriched_contacts.phone`                      | `direct_phone`, `mobile_phone`                                      | enrichment/index.ts                       |
| `enriched_contacts.raw_data`                   | **none — redesign, not a rename**                                   | data-enrichment/index.ts                  |
| `enriched_contacts.raw_data`                   | **none — redesign, not a rename**                                   | enrichment/index.ts                       |
| `enriched_contacts.source`                     | `enrichment_source`                                                 | data-enrichment/index.ts                  |
| `enriched_contacts.source`                     | `enrichment_source`                                                 | enrichment/index.ts                       |
| `enriched_contacts.status`                     | `email_verification_status`, `prospecting_status`                   | data-enrichment/index.ts                  |
| `enriched_contacts.status`                     | `email_verification_status`, `prospecting_status`                   | enrichment/index.ts                       |
| `enriched_contacts.title`                      | `job_title`                                                         | data-enrichment/index.ts                  |
| `enriched_contacts.title`                      | `job_title`                                                         | enrichment/index.ts                       |
...
| `equipment.model`                              | `model_number`                                                      | manufacturer-integrations/index.ts        |
...
| `integration_sync_logs.created_at`             | `records_created`, `started_at`, `completed_at`                     | quickbooks/index.ts                       |
| `integration_sync_logs.integration_type`       | `integration_id`, `sync_type`, `entity_type`                        | quickbooks/index.ts                       |
| `integration_sync_logs.records_count`          | `records_fetched`, `records_created`, `records_updated`             | quickbooks/index.ts                       |
| `invoices.service_ticket_id`                   | `id`                                                                | cross-module/index.ts                     |
...
| `manufacturer_integrations.disconnected_at`    | `created_at`, `updated_at`                                          | manufacturer-integrations/index.ts        |
| `manufacturer_integrations.error_message`      | **none — redesign, not a rename**                                   | manufacturer-integrations/index.ts        |
| `manufacturer_integrations.last_sync_at`       | `last_sync`                                                         | manufacturer-integrations/index.ts        |
| `manufacturer_integrations.manufacturer_name`  | `manufacturer`, `integration_name`                                  | manufacturer-integrations/index.ts        |
...
| `meter_readings.customer_id`                   | `id`, `tenant_id`, `equipment_id`                                   | meter-readings/index.ts                   |
| `monitored_devices.customer_id`                | `id`, `tenant_id`, `client_id`                                      | remote-monitoring/index.ts                |
| `monitored_devices.status`                     | **none — redesign, not a rename**                                   | remote-monitoring/index.ts                |
| `monitoring_clients.config`                    | `configuration`                                                     | client-metrics/index.ts                   |
| `monitoring_clients.last_seen_at`              | **none — redesign, not a rename**                                   | client-metrics/index.ts                   |
| `oid_mappings.category`                        | **none — redesign, not a rename**                                   | oid-mappings/index.ts                     |
| `oid_mappings.name`                            | `mapping_name`                                                      | oid-mappings/index.ts                     |
| `oid_mappings.oid`                             | `id`, `oids`                                                        | oid-mappings/index.ts                     |
| `oid_mappings.tenant_id`                       | `id`                                                                | oid-mappings/index.ts                     |
| `onboarding_checklists.assigned_to`            | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_checklists.created_by`             | `created_at`                                                        | onboarding-checklists/index.ts            |
| `onboarding_checklists.customer_id`            | `id`, `tenant_id`, `user_id`                                        | onboarding-checklists/index.ts            |
| `onboarding_checklists.description`            | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_checklists.due_date`               | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_checklists.name`                   | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_checklists.status`                 | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_checklists.template_id`            | `id`, `tenant_id`, `user_id`                                        | onboarding-checklists/index.ts            |
| `onboarding_dynamic_sections.order_index`      | `section_order`                                                     | onboarding/index.ts                       |
| `onboarding_tasks.assignee_id`                 | `id`, `tenant_id`, `checklist_id`                                   | onboarding-checklists/index.ts            |
| `onboarding_tasks.description`                 | `task_description`                                                  | onboarding-checklists/index.ts            |
| `onboarding_tasks.order`                       | **none — redesign, not a rename**                                   | onboarding-checklists/index.ts            |
| `onboarding_tasks.task_order`                  | `task_title`, `task_description`, `task_type`                       | onboarding/index.ts                       |
| `onboarding_tasks.title`                       | `task_title`                                                        | onboarding-checklists/index.ts            |
...
| `parts_order_items.description`                | `part_description`                                                  | parts-orders/index.ts                     |
| `parts_order_items.part_id`                    | `id`, `tenant_id`, `order_id`                                       | parts-orders/index.ts                     |
| `parts_order_items.quantity`                   | `quantity_ordered`, `quantity_received`, `quantity_backordered`     | parts-orders/index.ts                     |
| `parts_order_items.total_cost`                 | `line_total`                                                        | parts-orders/index.ts                     |
| `parts_order_items.unit_cost`                  | `unit_price`                                                        | parts-orders/index.ts                     |
| `parts_orders.delivered_at`                    | `created_at`, `updated_at`                                          | parts-orders/index.ts                     |
| `parts_orders.notes`                           | **none — redesign, not a rename**                                   | parts-orders/index.ts                     |
| `parts_orders.ordered_by`                      | **none — redesign, not a rename**                                   | parts-orders/index.ts                     |
| `parts_orders.ordered_by`                      | **none — redesign, not a rename**                                   | service-analysis/index.ts                 |
| `parts_orders.parts`                           | **none — redesign, not a rename**                                   | parts-orders/index.ts                     |
| `parts_orders.parts`                           | **none — redesign, not a rename**                                   | service-analysis/index.ts                 |
| `parts_orders.shipped_at`                      | `created_at`, `updated_at`                                          | parts-orders/index.ts                     |
| `parts_orders.shipping_address`                | `shipping`, `delivery_address`                                      | parts-orders/index.ts                     |
| `parts_orders.ticket_id`                       | `service_ticket_id`, `id`, `tenant_id`                              | parts-orders/index.ts                     |
| `parts_orders.total_cost`                      | `total`                                                             | parts-orders/index.ts                     |
| `parts_orders.total_cost`                      | `total`                                                             | service-analysis/index.ts                 |
| `platform_business_records.created_by`         | `converted_by`, `created_at`                                        | platform-crm/index.ts                     |
| `platform_health_scores.assigned_csm`          | **none — redesign, not a rename**                                   | platform-cs/index.ts                      |
| `platform_integrations.last_error_at`          | `last_synced_at`, `last_error_message`                              | integrations/index.ts                     |
| `product_models.demo_active`                   | `new_active`, `upgrade_active`, `lexmark_active`                    | catalog/index.ts                          |
| `product_models.refurb_active`                 | `new_active`, `upgrade_active`, `lexmark_active`                    | catalog/index.ts                          |
| `product_models.rental_active`                 | `new_active`, `upgrade_active`, `lexmark_active`                    | catalog/index.ts                          |
| `product_models.status`                        | **none — redesign, not a rename**                                   | product-models/index.ts                   |
| `proposal_sections.order_index`                | `display_order`                                                     | proposals/index.ts                        |
...
| `report_definitions.record_type`               | **none — redesign, not a rename**                                   | reports/handlers/custom-reports.ts        |
| `roles.hierarchy_level`                        | `level`                                                             | role-management/index.ts                  |
| `roles.is_system`                              | `is_system_role`                                                    | role-management/index.ts                  |
| `roles.tenant_id`                              | `id`                                                                | admin/index.ts                            |
...
| `seo_keywords.previous_position`               | `current_position`, `target_position`, `best_position`              | seo/index.ts                              |
| `service_contracts.auto_renew`                 | `auto_renewal`                                                      | service-contracts/index.ts                |
| `service_contracts.base_fee`                   | **none — redesign, not a rename**                                   | service-contracts/index.ts                |
| `service_contracts.cancellation_reason`        | **none — redesign, not a rename**                                   | service-contracts/index.ts                |
| `service_contracts.cancelled_at`               | `created_at`, `updated_at`                                          | service-contracts/index.ts                |
| `service_contracts.cancelled_by`               | **none — redesign, not a rename**                                   | service-contracts/index.ts                |
| `service_contracts.created_by`                 | `created_at`                                                        | service-contracts/index.ts                |
| `service_contracts.previous_contract_id`       | `external_contract_id`, `id`                                        | service-contracts/index.ts                |
| `service_contracts.renewed_contract_id`        | `external_contract_id`, `id`                                        | service-contracts/index.ts                |
| `service_contracts.sla_level`                  | **none — redesign, not a rename**                                   | service-contracts/index.ts                |
| `service_contracts.status`                     | `contract_status`                                                   | service-contracts/index.ts                |
| `service_tickets.assigned_at`                  | `resolved_at`, `created_at`, `updated_at`                           | predictive-dispatch/index.ts              |
| `service_tickets.check_in_location`            | **none — redesign, not a rename**                                   | mobile-field/index.ts                     |
| `service_tickets.check_in_time`                | **none — redesign, not a rename**                                   | mobile-field/index.ts                     |
| `service_tickets.check_out_location`           | **none — redesign, not a rename**                                   | mobile-field/index.ts                     |
| `service_tickets.check_out_time`               | **none — redesign, not a rename**                                   | mobile-field/index.ts                     |
...
| `service_tickets.predicted_window_start`       | **none — redesign, not a rename**                                   | daily-briefing/briefing.ts                |
...
| `social_media_cron_jobs.next_run_at`           | **none — redesign, not a rename**                                   | social-media/index.ts                     |
| `social_media_posts.published_at`              | `created_at`, `updated_at`                                          | social-media/index.ts                     |
...
| `supplies.category`                            | **none — redesign, not a rename**                                   | supplies/index.ts                         |
...
| `supplies.quantity`                            | **none — redesign, not a rename**                                   | supplies/index.ts                         |
| `supplies.sku`                                 | **none — redesign, not a rename**                                   | supplies/index.ts                         |
...
| `technicians.availability_notes`               | **none — redesign, not a rename**                                   | technician-management/index.ts            |
| `technicians.employment_status`                | **none — redesign, not a rename**                                   | technicians/index.ts                      |
| `technicians.full_name`                        | `first_name`, `last_name`                                           | technician-management/index.ts            |
| `technicians.skill_set`                        | **none — redesign, not a rename**                                   | technicians/index.ts                      |
| `technicians.status`                           | **none — redesign, not a rename**                                   | technician-management/index.ts            |
| `tenants.settings`                             | **none — redesign, not a rename**                                   | admin/index.ts                            |
...
| `time_entries.activity_type`                   | **none — redesign, not a rename**                                   | mobile-field/index.ts                     |
| `time_entries.billable`                        | **none — redesign, not a rename**                                   | professional-services/index.ts            |
| `time_entries.project_id`                      | `id`, `tenant_id`, `task_id`                                        | professional-services/index.ts            |
| `time_entries.ticket_id`                       | `id`, `tenant_id`, `task_id`                                        | mobile-field/index.ts                     |
| `users.activated_at`                           | `created_at`, `updated_at`                                          | user-management/index.ts                  |
| `users.current_location`                       | **none — redesign, not a rename**                                   | predictive-dispatch/index.ts              |
| `users.deactivated_at`                         | `created_at`, `updated_at`                                          | user-management/index.ts                  |
| `users.department`                             | **none — redesign, not a rename**                                   | user-management/index.ts                  |
| `users.full_name`                              | `first_name`, `last_name`                                           | role-management/index.ts                  |
| `users.full_name`                              | `first_name`, `last_name`                                           | user-management/index.ts                  |
| `users.job_title`                              | **none — redesign, not a rename**                                   | user-management/index.ts                  |
| `users.name`                                   | `first_name`, `last_name`                                           | predictive-dispatch/index.ts              |
| `users.phone`                                  | **none — redesign, not a rename**                                   | user-management/index.ts                  |
| `users.skills`                                 | **none — redesign, not a rename**                                   | predictive-dispatch/index.ts              |
| `users.status`                                 | **none — redesign, not a rename**                                   | predictive-dispatch/index.ts              |
| `users.status`                                 | **none — redesign, not a rename**                                   | role-management/index.ts                  |
| `users.status`                                 | **none — redesign, not a rename**                                   | user-management/index.ts                  |
| `workflow_executions.trigger_data`             | `trigger_id`                                                        | workflows/index.ts                        |
| `workflow_executions.trigger_type`             | `trigger_id`                                                        | workflows/index.ts                        |
| `workflow_steps.step_order`                    | `step_name`, `step_started`, `step_completed`                       | workflows/index.ts                        |
| `workflow_steps.workflow_id`                   | `id`, `tenant_id`, `session_id`                                     | workflows/index.ts                        |
| `workflows.activated_at`                       | `created_at`, `updated_at`                                          | workflows/index.ts                        |
