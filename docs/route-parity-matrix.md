...
**Architecture:** prod frontend → `functions.printyx.net/<route>` (edge) for ALL `/api/*` via `getApiUrl`. The Express proxy map (49 prefixes) only affects **dev**. Express stays canonical for `/api/client-metrics/*` (agent) and `/install/*`.

**Totals:** 294 domains · 225 edge fns · 159 Express-served · 182 frontend-called · 49 proxied
...
| `both-divergent` | 57 | Express + edge both exist, not proxied → dev ≠ prod (maintenance trap) |
...
| `proxied` | 49 | In proxy map → dev forwards to edge (aligned) |
...
**missing-edge** (32): `accessories`, `ai`, `ai-analytics`, `approvals`, `assignment-groups`, `business-process`, `content`, `contract-tiered-rates`, `deals-management`, `documents`, `email-parser`, `equipment-disposal`, `erp-integration`, `financial-forecasting`, `incident-response`, `lead-intelligence`, `lease-payments`, `pipeline-forecast`, `platform`, `predictive-analytics`, `quote-templates`, `record-layout-config`, `sales-forecasts`, `sales-performance`, `salesforce`, `security-compliance`, `service`, `system-monitoring`, `task-workflows`, `technician-sessions`, `white-label`, `workflow-automation`

**both-divergent** (57): `admin`, `audit-logs`, `auto-lead-routing`, `auto-supply-replenishment`, `catalog`, `commission`, `content-gap-analysis`, `contract-renewal`, `contracts`, `crm`, `dashboard`, `dashboards`, `database-updater`, `deal-stages`, `demos`, `devices`, `document-management`, `enrichment`, `equipment`, `financial`, `fleet`, `gdpr`, `import`, `integrations`, `inventory`, `invoices`, `leads`, `maintenance`, `managed-services`, `manufacturer-integrations`, `meter-readings`, `mobile`, `mobile-field`, `onboarding`, `parts-orders`, `performance`, `platform-deals`, `predictive-dispatch`, `pricing`, `product-accessories`, `product-models`, `professional-services`, `projects`, `purchase-orders`, `quickbooks`, `rbac`, `remote-monitoring`, `seo`, `service-analysis`, `service-analytics`, `service-tickets`, `software-products`, `supplies`, `technician-management`, `templates`, `user`, `warehouse-operations`
