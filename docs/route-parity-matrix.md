...
**Totals:** 294 domains · 225 edge fns · 159 Express-served · 182 frontend-called · 55 proxied
...
| `both-divergent` | 51 | Express + edge both exist, not proxied → dev ≠ prod (maintenance trap) |
...
**both-divergent** (51): `admin`, `audit-logs`, `catalog`, `commission`, `content-gap-analysis`, `contracts`, `crm`, `dashboard`, `dashboards`, `database-updater`, `deal-stages`, `demos`, `devices`, `document-management`, `enrichment`, `equipment`, `financial`, `fleet`, `gdpr`, `import`, `integrations`, `inventory`, `invoices`, `maintenance`, `managed-services`, `manufacturer-integrations`, `meter-readings`, `mobile`, `mobile-field`, `onboarding`, `parts-orders`, `performance`, `platform-deals`, `pricing`, `product-accessories`, `product-models`, `professional-services`, `projects`, `purchase-orders`, `quickbooks`, `rbac`, `remote-monitoring`, `service-analysis`, `service-analytics`, `service-tickets`, `software-products`, `supplies`, `technician-management`, `templates`, `user`, `warehouse-operations`
