...
**Architecture:** prod frontend → `functions.printyx.net/<route>` (edge) for ALL `/api/*` via `getApiUrl`. The Express proxy map (65 prefixes) only affects **dev**. Express stays canonical for `/api/client-metrics/*` (agent) and `/install/*`.

**Totals:** 294 domains · 225 edge fns · 159 Express-served · 182 frontend-called · 65 proxied
...
| `both-divergent` | 42 | Express + edge both exist, not proxied → dev ≠ prod (maintenance trap) |
...
| `proxied` | 65 | In proxy map → dev forwards to edge (aligned) |
| `edge-only` | 102 | Edge function only, no Express handler → fully migrated |
...
**both-divergent** (42): `admin`, `audit-logs`, `catalog`, `content-gap-analysis`, `contracts`, `crm`, `dashboard`, `dashboards`, `database-updater`, `deal-stages`, `demos`, `devices`, `document-management`, `enrichment`, `equipment`, `financial`, `fleet`, `import`, `integrations`, `inventory`, `invoices`, `maintenance`, `managed-services`, `manufacturer-integrations`, `meter-readings`, `mobile`, `mobile-field`, `onboarding`, `platform-deals`, `pricing`, `product-accessories`, `product-models`, `professional-services`, `projects`, `rbac`, `service-analysis`, `service-analytics`, `service-tickets`, `software-products`, `technician-management`, `templates`, `user`
...
| `activities` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `api-keys` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `auto-lead-routing` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `auto-supply-replenishment` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `billing` | ✅ | ✅ | ✅ | ✅ | `proxied` |
...
| `products` | ✅ | ✅ | · | ✅ | `proxied` |
| `proposals` | ✅ | ✅ | · | ✅ | `proxied` |
| `purchase-orders` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `quickbooks` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `quotes` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `remote-monitoring` | ✅ | ✅ | ✅ | ✅ | `proxied` |
| `reporting` | ✅ | · | · | ✅ | `proxied` |
| `reports` | ✅ | ✅ | · | ✅ | `proxied` |
| `roles` | · | ✅ | · | ✅ | `proxied` |
| `root-admin` | ✅ | ✅ | ✅ | ✅ | `proxied` |
