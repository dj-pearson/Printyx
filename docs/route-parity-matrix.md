...
**Totals:** 294 domains · 225 edge fns · 159 Express-served · 182 frontend-called · 48 proxied
...
| `both-divergent` | 58 | Express + edge both exist, not proxied → dev ≠ prod (maintenance trap) |
