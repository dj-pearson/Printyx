...
| `supabase-kong`           | `kong:2.8.1`                     | `kong:2.8.1` _(unchanged)_               |
...
**Problem:** Studio showed _"SNIPPETS_MANAGEMENT_FOLDER env var is not set"_ and the SQL Editor would not load. The old compose had this using YAML map syntax inside a list-format env block:
