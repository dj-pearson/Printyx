  ...
  tutorial: {
    ...
    structure: {
      sections: [
        ...
        {
          type: 'list',
          content: ['Learning outcome 1', 'Learning outcome 2', 'Learning outcome 3'],
          order: 2,
        },
        {
          type: 'callout',
        ...
        {
          type: 'list',
          content: ['Prerequisite 1', 'Prerequisite 2'],
          order: 5,
        },
        {
          type: 'header',
        ...
        {
          type: 'list',
          content: ['Specific action 1', 'Specific action 2', 'Specific action 3'],
          order: 8,
        ...
        },
        {
          type: 'callout',
          content:
            '💡 **Pro Tip**: Share insider tips or shortcuts that experienced users would know',
          formatting: { style: 'info' },
          order: 11,
    ...
    structure: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            '**Step 1 Details**: Provide additional context, screenshots, or clarifications for users who need more guidance.',
          order: 7,
        },
        {
          type: 'header',
    ...
    structure: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Comprehensive overview explaining what this is, its purpose, and when to use it.',
          order: 2,
        },
        {
          type: 'header',
  ...
  troubleshooting: {
    ...
    structure: {
      sections: [
        ...
        {
          type: 'list',
          content: ['Step 1 of quick fix', 'Step 2 of quick fix', 'Expected result'],
          order: 9,
        },
        {
          type: 'paragraph',
        ...
        {
          type: 'list',
          content: ['Step 1 of advanced fix', 'Step 2 of advanced fix', 'Expected result'],
          order: 11,
        },
        {
          type: 'callout',
        ...
        },
        {
          type: 'paragraph',
          content:
            'If none of the above solutions work, contact support with: error message, steps attempted, and system details.',
          order: 16,
        },
      ],
    },
    ...
    structure: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Describe the business problem this best practice solves and the measurable impact.',
          order: 2,
        },
        {
          type: 'callout',
        ...
        },
        {
          type: 'paragraph',
          content:
            'Describe how a typical dealer implemented these practices and the results achieved.',
          order: 11,
        ...
        },
        {
          type: 'callout',
          content:
            "🎯 **Success Story**: Include measurable results (e.g., '35% increase in...', '50% reduction in...')",
          formatting: { style: 'success' },
          order: 12,
        },
        {
        ...
        {
          type: 'list',
          content: ["❌ Don't: Common mistake and why it fails", '✅ Do: Correct approach instead'],
          order: 14,
        },
        {
          type: 'header',
    ...
    structure: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            '**A**: Direct, concise answer in 1-3 sentences. Provide just enough detail to answer the question without overwhelming.',
          order: 4,
    ...
    structure: {
      sections: [
        ...
        },
        {
          type: 'callout',
          content:
            '⚠️ **Action Required**: List any required migration steps or configuration changes',
          formatting: { style: 'warning' },
          order: 11,
        },
        {
