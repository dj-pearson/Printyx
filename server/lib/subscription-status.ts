 ...
 * both sides. Those are pure, so they live here and
 * supabase/functions/_shared/subscription-status.ts mirrors them;
 * server/tests/unit/subscription-status-parity.test.ts fails on drift.
 *
 * Node copy.
 */
