...
export const sortSchema = z.object({
  sortBy: z.string().max(50).regex(/^[a-zA-Z_]+$/, 'Invalid sort field').optional(),
 ...
 */
export const ipWhitelistEntrySchema = z.string()
  .refine(val => {
    // IPv4
...
export async function validateData<T>(
  schema: ZodSchema<T>,
  data: unknown
): Promise<{ success: true; data: T } | { success: false; errors: ReturnType<typeof formatZodErrors> }> {
