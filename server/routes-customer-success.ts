          ...
          opportunities: [
            {
              ...
              description:
                'Usage patterns suggest business model change - reassess equipment needs',
              value: 5000,
              probability: 70,
...
router.get(
  ...
  async (req: AuthenticatedRequest, res) => {
    try {
            ...
            recommendations: [
              {
                ...
                priority: 'medium',
                description:
                  'Equipment MX-2020-001 nearing capacity - consider upgrade or load balancing',
            ...
            recommendations: [
              {
                ...
                priority: 'high',
                description:
                  'Significant underutilization - consider downsizing to lower-cost equipment',
      ...
      if (customerId) {
        const customerData = usageAnalytics.customerBreakdown.find(
        ...
        recentSurveys: [
          {
            ...
            category: 'promoter',
            feedback:
              'Excellent service team - always responsive and knowledgeable. Equipment runs smoothly.',
            actionItems: [],
          },
          {
            surveyId: 'surv-002',
            ...
            category: 'passive',
            feedback:
              'Service is adequate but response times could be better. Pricing seems high for our usage.',
            actionItems: [
              {
