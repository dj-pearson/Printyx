    ...
    const workflow = {
      ...
      steps: [
        ...
        { name: 'Proposal Generation', status: 'completed', canProceed: true },
        {
          ...
          status: 'pending',
          canProceed: false,
          blockers: ['Awaiting customer signature'],
        },
        {
          name: 'Purchase Order',
          status: 'not_started',
          canProceed: false,
          blockers: ['Contract must be signed first'],
        },
        {
          name: 'Warehouse Kitting',
          status: 'not_started',
          canProceed: false,
          blockers: ['PO must be approved first'],
        },
        {
          name: 'Delivery',
          status: 'not_started',
          canProceed: false,
          blockers: ['Kitting must be completed first'],
        },
      ],
