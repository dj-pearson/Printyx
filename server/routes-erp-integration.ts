      ...
      erpSystems: [
        {
          ...
          endpoints: [
            ...
            },
            {
              ...
              url: '/api/Orders',
              status: 'active',
              lastCall: new Date('2025-02-01T08:11:00Z'),
            },
            {
              name: 'Invoices',
              url: '/api/Invoices',
              status: 'active',
              lastCall: new Date('2025-02-01T08:10:00Z'),
            },
          ],
        ...
        },
        {
          ...
          endpoints: [
            ...
            {
              name: 'Items',
              url: '/services/rest/record/v1/item',
              status: 'active',
              lastCall: new Date('2025-02-01T08:12:00Z'),
            },
            {
              name: 'Sales Orders',
              url: '/services/rest/record/v1/salesorder',
              status: 'active',
              lastCall: new Date('2025-02-01T08:11:00Z'),
            },
            {
              name: 'Invoices',
              url: '/services/rest/record/v1/invoice',
              status: 'active',
              lastCall: new Date('2025-02-01T08:10:00Z'),
            },
          ],
        ...
        },
        {
          ...
          endpoints: [
            ...
            {
              name: 'Opportunities',
              url: '/api/data/v9.2/opportunities',
              status: 'active',
              lastCall: new Date('2025-02-01T08:10:00Z'),
            },
            {
              name: 'Orders',
              url: '/api/data/v9.2/salesorders',
              status: 'active',
              lastCall: new Date('2025-02-01T08:09:00Z'),
            },
          ],
        ...
        mappingSchemas: [
          {
            ...
            fieldMappings: [
              {
                sourceField: 'customer.companyName',
              ...
              {
                sourceField: 'customer.address.street',
                targetField: 'Address',
                transformation: 'concatenate',
                required: true,
              },
              {
                sourceField: 'customer.creditLimit',
                targetField: 'CreditLine',
            ...
            fieldMappings: [
              {
                ...
                targetField: 'msdyn_productnumber',
                transformation: 'prefix_code',
                required: true,
              },
              {
      ...
      monitoring: {
        systemHealth: [
          ...
          },
          {
            ...
            status: 'healthy',
            uptime: 99.9,
            lastCheck: new Date('2025-02-01T08:12:00Z'),
            responseTime: 156,
          },
          {
            system: 'API Gateway',
            status: 'healthy',
            uptime: 99.94,
            lastCheck: new Date('2025-02-01T08:15:00Z'),
            responseTime: 234,
          },
        ],
