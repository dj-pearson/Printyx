    ...
    const mobileDashboard = {
      ...
      jobsQueue: [
        ...
        },
        {
          ...
          requiredParts: [
            {
              partNumber: 'PF-5855-ROLL',
              description: 'Paper Feed Roller',
              quantity: 2,
              available: false,
            },
            {
              partNumber: 'FUS-5855-UNIT',
        ...
        },
        {
          ...
          requiredParts: [
            {
              partNumber: 'NET-C3004-KIT',
              description: 'Network Setup Kit',
              quantity: 1,
              available: true,
            },
            {
              partNumber: 'TNR-C3004-SET',
              description: 'Full Toner Set',
              quantity: 1,
              available: true,
            },
          ],
  ...
  try {
    ...
    const serviceReport = {
      ...
      partsAndMaterials: {
        partsUsed: partsUsed || [],
        totalPartsCost:
          partsUsed?.reduce((sum: number, part: any) => sum + (part.cost || 0), 0) || 0,
    ...
    serviceReport.partsAndMaterials.totalCost =
      serviceReport.partsAndMaterials.totalPartsCost + serviceReport.partsAndMaterials.laborCost;
  ...
  try {
    ...
    const serviceReport = {
      ...
      customerApproval: {
        signedAt: new Date(),
        customerNotes:
          'Service completed promptly and professionally. Equipment working perfectly.',
