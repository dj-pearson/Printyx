...
export function registerSampleDataRoutes(app: Express) {
  ...
  // ──────────────────────────────────────────────
  // E-signature Integration Routes — REMOVED (EDGE-005e)
  // The /api/signature-{requests,templates,analytics} sample mocks were
  // consolidated under the signatures edge function (/api/signatures/*,
  // proxied in dev). See supabase/functions/signatures/handlers/page.ts.
  // ──────────────────────────────────────────────
