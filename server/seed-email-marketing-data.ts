    ...
    const templates = await db
      ...
      .values([
        ...
        },
        {
          ...
          variableFields: JSON.stringify(["firstName", "equipmentModel", "serviceDate", "serviceTime", "technicianName", "supportPhone"]),
          category: "retention",
        ...
        },
        {
          ...
          variableFields: JSON.stringify(["firstName", "offerTitle", "discountPercent", "productCategory", "promoCode", "expiryDate", "ctaLink"]),
          category: "promotion",
