...
async function seedManufacturerOrders() {
  try {
    ...
    await storage.createOrderShipment({
      ...
      shippingCost: 150.00,
      trackingEvents: [
        { timestamp: new Date(Date.now() - 15 * 24 * 60 * 60 * 1000), status: "picked_up", location: "Canon Distribution Center" },
        { timestamp: new Date(Date.now() - 14 * 24 * 60 * 60 * 1000), status: "in_transit", location: "Memphis, TN" },
        { timestamp: new Date(Date.now() - 12 * 24 * 60 * 60 * 1000), status: "out_for_delivery", location: "Austin, TX" },
        { timestamp: new Date(Date.now() - 11 * 24 * 60 * 60 * 1000), status: "delivered", location: "Austin, TX" },
      ],
    ...
    await storage.createOrderShipment({
      ...
      shippingCost: 250.00,
      trackingEvents: [
        { timestamp: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000), status: "picked_up", location: "Xerox Distribution Center" },
        { timestamp: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000), status: "in_transit", location: "Fort Worth, TX" },
      ],
