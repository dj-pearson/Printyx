    ...
    const insightsData = [
      {
        ...
        insightDescription:
          'Call answer rate of 20% is significantly below team average of 30%. This impacts meeting conversion and overall pipeline.',
        recommendedActions: [
          {
            action: 'Optimize call timing to 9-11 AM and 2-4 PM',
            impact: 'Increase answer rate by 8-12%',
          },
      ...
      },
      {
        ...
        insightDescription:
          'Based on current 20% closing rate and $45K average deal size, need 600 monthly activities to hit $100K revenue goal.',
        recommendedActions: [
          {
            action: 'Increase daily activities from 16 to 27',
            impact: 'Hit monthly revenue target',
          },
          {
            action: 'Focus on improving conversion rates first',
            impact: 'Reduce total activities needed',
          },
          {
            action: 'Track daily progress with activity dashboard',
            impact: 'Stay on target throughout month',
          },
        ],
        supportingData: {
