...
export const crmSalesArticles = [
  {
    ...
    excerpt:
      "Master Printyx's unified business records system. Learn how leads and customers are managed in a zero-data-loss architecture that preserves your entire customer journey.",
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Printyx uses a revolutionary unified business records system. Unlike traditional CRMs that separate leads and customers, our approach treats them as a single entity with different lifecycle stages. This means zero data loss when converting a lead to a customer!',
          order: 2,
        },
        {
          type: 'callout',
          content:
            '🎯 **Key Advantage**: When you convert a lead to a customer, all historical data, notes, interactions, and attachments are automatically preserved. No manual data migration needed!',
        ...
        },
        {
          type: 'paragraph',
          content:
            "To create a new lead, navigate to CRM → Business Records → Create New. You'll be prompted to enter:",
          order: 5,
        },
        {
          type: 'list',
...

{
  ...
  "notes": "Interested in lease program for 5 copiers"
        ...
        },
        {
          type: 'paragraph',
          content:
            'Printyx automatically scores leads based on multiple factors including company size, engagement level, budget indicators, and timeline. The AI-powered lead scoring helps you prioritize your sales efforts.',
          order: 9,
        },
        {
          type: 'table',
        ...
        },
        {
          type: 'callout',
          content:
            "💡 **Pro Tip**: Before converting, ensure you've added all relevant notes, attachments, and interaction history. Your service team will thank you for the complete customer context!",
        ...
        },
        {
          type: 'paragraph',
          content:
            'Once converted to a customer, additional fields become available such as contract details, billing information, installed equipment, and service history. The customer view provides a 360-degree perspective of the relationship.',
          order: 15,
        },
        {
          type: 'list',
    ...
    metaDescription:
      "Complete guide to Printyx's unified business records system for leads and customers with zero data loss.",
  ...
  },
  {
    ...
    categorySlug: 'crm-sales',
    excerpt:
      "Optimize your sales process with Printyx's visual pipeline. Track deals, forecast revenue, and never miss a follow-up opportunity.",
    contentType: 'tutorial',
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Opportunities represent potential revenue. To create one, navigate to Sales → Pipeline → New Opportunity:',
          order: 6,
        },
        {
          type: 'list',
        ...
        },
        {
          type: 'callout',
          content:
            '📊 **Forecasting**: Printyx automatically calculates weighted pipeline value by multiplying opportunity value by win probability for accurate revenue forecasting.',
          formatting: { style: 'info' },
          order: 8,
        },
        {
        ...
        },
        {
          type: 'paragraph',
          content:
            'Simply drag and drop opportunities between stages in the visual pipeline view. Each stage change updates the win probability and triggers any configured automation workflows.',
          order: 10,
        },
        {
          type: 'header',
        ...
        },
        {
          type: 'paragraph',
          content:
            'Each opportunity has an activity timeline showing all interactions: calls, emails, meetings, quotes sent, and contract negotiations. Set reminders to ensure timely follow-ups.',
          order: 14,
        },
        {
          type: 'callout',
          content:
            "⚡ **Automation Tip**: Set up workflow automations to notify you when deals have been in a stage too long, or when a high-value opportunity isn't receiving attention.",
          formatting: { style: 'success' },
          order: 15,
        },
      ],
    ...
    metaDescription:
      'Master the sales pipeline in Printyx with visual deal tracking, forecasting, and sales process optimization.',
  ...
  },
  {
    ...
    categorySlug: 'crm-sales',
    excerpt:
      'Generate professional, branded quotes and proposals in minutes. Include equipment specs, pricing tiers, lease options, and digital signatures.',
    contentType: 'how_to',
    difficultyLevel: 'beginner',
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'callout',
          content:
            '💰 **Pricing Tip**: Set up automated discount rules based on quantity, customer tier, or promotional periods. The quote builder will auto-apply the best price!',
          formatting: { style: 'success' },
          order: 7,
        },
        {
        ...
        },
        {
          type: 'paragraph',
          content:
            "Save time with quote templates for common scenarios like '5 MFP Bundle', 'Production Printer Package', or 'Service Contract Renewal'. Templates include pre-configured products, standard pricing, and approved terms.",
          order: 9,
        },
        {
          type: 'header',
        ...
        },
        {
          type: 'paragraph',
          content:
            'Quotes progress through statuses: Draft → Sent → Viewed → Accepted → Won/Lost. Email tracking shows when customers open your quote, helping you time your follow-up perfectly.',
          order: 11,
        },
        {
          type: 'callout',
          content:
            "📧 **Follow-up Automation**: Enable automatic reminders 3 days after sending if the quote hasn't been opened, and 7 days before expiration.",
          formatting: { style: 'info' },
          order: 12,
        },
      ],
    ...
    metaDescription:
      "Learn how to create professional, branded quotes and proposals with Printyx's powerful quote builder.",
  ...
  },
  {
    ...
    categorySlug: 'crm-sales',
    excerpt:
      "Understand how Printyx's AI analyzes dozens of factors to score and prioritize your leads. Learn to interpret scores and optimize your sales strategy.",
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Printyx uses machine learning models trained on thousands of successful deals to predict which leads are most likely to convert. The AI analyzes demographic data, behavioral signals, engagement patterns, and historical trends.',
          order: 2,
        },
        {
          type: 'header',
        ...
        },
        {
          type: 'paragraph',
          content:
            "While the AI provides a baseline score, you can add custom rules specific to your business. For example, boost scores for leads in your geographic sweet spot, or decrease scores for industries you don't serve well.",
          order: 10,
        },
        {
          type: 'code',
          content: `// Example: Custom scoring rule configuration
{
  "customRules": [
    ...
    },
    {
      ...
      "reason": "Referrals have 3x conversion rate"
        ...
        },
        {
          type: 'callout',
          content:
            '📈 **Success Story**: Dealers using AI lead scoring report 35% higher conversion rates and 50% reduction in time wasted on unqualified leads.',
          formatting: { style: 'success' },
          order: 14,
        },
      ],
    ...
    metaDescription:
      'Master AI lead scoring in Printyx to prioritize prospects and maximize sales efficiency.',
