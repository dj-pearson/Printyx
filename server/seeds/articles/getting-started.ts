...
export const gettingStartedArticles = [
  {
    ...
    excerpt: "Learn the basics of Printyx and get your copier dealership up and running in minutes. This comprehensive guide covers everything from initial setup to your first customer interaction.",
    ...
    content: {
      sections: [
        ...
        {
          type: "paragraph",
          content: "Printyx is the complete business management platform designed specifically for copier dealers. Whether you're managing leads, dispatching technicians, tracking inventory, or billing customers, Printyx streamlines every aspect of your dealership operations.",
          order: 2
        },
        {
          type: "callout",
          content: "💡 **Quick Start Tip**: Follow this guide step-by-step to get your dealership up and running in less than 30 minutes!",
        ...
        {
          type: "paragraph",
          content: "The Printyx dashboard is your command center. It provides real-time insights into your business performance with customizable widgets for sales, service, and operational metrics.",
          order: 7
        },
        {
          type: "image",
        ...
        },
        {
          ...
          content: {
            ...
            rows: [
              ["CRM & Sales", "Manage leads and customers", "Lead tracking, quotes, proposals, pipeline"],
              ["Service Management", "Dispatch and service calls", "Mobile dispatch, technician tracking, parts"],
              ["Inventory", "Stock and warehouse", "Product catalog, FPY, purchase orders"],
              ["Billing", "Invoicing and payments", "Meter billing, contracts, automated invoicing"],
        ...
        {
          type: "callout",
          content: "🚀 **Next Steps**: Once you've completed this checklist, explore our category-specific guides for deep dives into each module.",
        ...
        {
          type: "paragraph",
          content: "Need assistance? Our knowledge base is searchable, and each article includes step-by-step instructions. You can also access contextual help throughout the platform by clicking the question mark icons.",
          order: 15
        }
      ]
    },
    ...
    metaDescription: "Complete getting started guide for Printyx. Learn how to set up your copier dealership management platform in minutes.",
  ...
  },
  {
    ...
    categorySlug: "getting-started",
    excerpt: "Master the Printyx dashboard with this comprehensive guide. Learn how to customize widgets, interpret metrics, and make data-driven decisions.",
    contentType: "tutorial",
    difficultyLevel: "beginner",
    ...
    content: {
      sections: [
        ...
        {
          type: "paragraph",
          content: "The Printyx dashboard is designed to give you a real-time snapshot of your business performance. It's fully customizable, allowing you to focus on the metrics that matter most to your dealership.",
          order: 2
        },
        {
          type: "header",
        ...
        {
          type: "paragraph",
          content: "To customize your dashboard, click the 'Customize' button in the top right corner. You can:",
          order: 6
        },
        {
          type: "list",
          ...
          content: `// Example: Dashboard widgets are stored in user preferences
{
  ...
  "refreshInterval": 300000
        ...
        {
          type: "callout",
          content: "💡 **Pro Tip**: Create role-specific dashboards! Sales managers can focus on pipeline metrics, while service managers prioritize dispatch and technician data.",
          formatting: { style: "info" },
          order: 9
        },
        {
        ...
        {
          type: "paragraph",
          content: "The left sidebar provides access to all major modules. Use the search bar at the top to quickly find any feature or customer record.",
          order: 11
        }
      ]
    },
    ...
    metaDescription: "Learn how to navigate and customize the Printyx dashboard for maximum productivity.",
  ...
  },
  {
    ...
    categorySlug: "getting-started",
    excerpt: "Understand Printyx's 8-level role hierarchy and permission system. Learn how to assign appropriate access levels to your team members.",
    ...
    content: {
      sections: [
        ...
        {
          type: "paragraph",
          content: "Printyx implements a sophisticated 8-level role hierarchy designed to match your organizational structure. Each role has specific permissions that control what users can see and do within the platform.",
          order: 2
        },
        {
          type: "header",
        ...
        },
        {
          ...
          content: {
            ...
            rows: [
              ["Platform Admin", "1 (Highest)", "Platform operators", "Full system access, tenant management"],
        ...
        {
          type: "callout",
          content: "⚠️ **Security Best Practice**: Always assign the minimum permissions needed for each role. You can always grant additional access later.",
        ...
        {
          type: "paragraph",
          content: "Higher-level roles automatically inherit all permissions from lower-level roles. For example, a Manager has all Standard User permissions plus additional management capabilities.",
          order: 7
        },
        {
          type: "header",
        ...
        {
          type: "paragraph",
          content: "To modify user permissions, navigate to Settings → Users. Select a user and adjust their role or customize individual permissions using the granular permission controls.",
          order: 11
        }
      ]
    },
    ...
    metaDescription: "Complete guide to understanding and managing user roles and permissions in Printyx.",
