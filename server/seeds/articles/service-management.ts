...
export const serviceManagementArticles = [
  {
    ...
    excerpt:
      'Master service dispatch with intelligent routing, real-time technician tracking, and automated scheduling. Reduce response times and maximize technician productivity.',
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            "Printyx's dispatch dashboard gives you a real-time view of all active service calls, technician locations, and upcoming appointments. The drag-and-drop interface makes scheduling intuitive and efficient.",
          order: 2,
        },
        {
          type: 'callout',
          content:
            '🚀 **Quick Win**: Enable GPS tracking for technicians to see real-time locations and estimated arrival times. Customers love the transparency!',
        ...
        },
        {
          type: 'paragraph',
          content:
            "Printyx's AI considers multiple factors when suggesting technician assignments:",
          order: 10,
        },
        {
          type: 'list',
          ...
          content: `// Example: AI technician assignment scoring
{
  ...
  "suggestedTechnicians": [
    {
      ...
      "currentLocation": { "lat": 34.0489, "lng": -118.2500 }
        ...
        },
        {
          type: 'paragraph',
          content:
            'Technicians use the mobile app to receive assignments, navigate to sites, log service details, capture photos, order parts, and collect signatures. Everything syncs in real-time with the dispatch dashboard.',
          order: 14,
        },
        {
          type: 'callout',
          content:
            '📱 **Productivity Boost**: Techs can complete paperwork in the mobile app while on-site, eliminating end-of-day data entry and improving billing accuracy.',
    ...
    metaDescription:
      'Complete guide to service dispatch in Printyx with intelligent routing, technician assignment, and mobile field service.',
  ...
  },
  {
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'callout',
          content:
            '📸 **Pro Tip**: Always take photos of error codes, damaged parts, and completed repairs. Visual documentation reduces disputes and helps with warranty claims.',
          formatting: { style: 'info' },
          order: 19,
        },
        {
        ...
        },
        {
          type: 'paragraph',
          content:
            'The mobile app works offline! Service calls sync automatically when you regain connectivity. This is essential for basements or areas with poor signal.',
          order: 21,
        },
      ],
    },
    ...
    metaDescription:
      'Complete mobile app guide for field technicians using Printyx for service calls, parts management, and customer signatures.',
  ...
  },
  {
    ...
    categorySlug: 'service-management',
    excerpt:
      'Set up automated preventive maintenance schedules to catch issues before they become emergencies. Increase customer satisfaction and reduce costly emergency service calls.',
    ...
    content: {
      sections: [
        ...
        },
        {
          type: 'paragraph',
          content:
            'Preventive maintenance (PM) programs identify and fix small issues before they become major problems. Dealers with robust PM programs report 60% fewer emergency calls, 40% longer equipment life, and 25% higher customer satisfaction scores.',
          order: 2,
        },
        {
          type: 'callout',
          content:
            '💰 **ROI Insight**: Every dollar spent on preventive maintenance saves $4-6 in emergency service costs and lost customer productivity.',
          formatting: { style: 'success' },
          order: 3,
        },
        {
        ...
        },
        {
          type: 'paragraph',
          content:
            'Navigate to Service → Preventive Maintenance → New PM Schedule. Configure based on:',
          order: 5,
        },
        {
          type: 'list',
          ...
          content: {
            ...
            rows: [
              [
                'Desktop Printers',
                'Annual',
                'Clean internals, check toner system, test all functions',
              ],
              [
                'Office MFPs',
                'Semi-annual',
                'Clean/lubricate rollers, check fuser, calibrate color',
              ],
              [
                'Production Printers',
                'Quarterly',
                'Full inspection, replace wear items, precision alignment',
              ],
              [
                'Wide Format',
                'Quarterly',
                'Print head maintenance, media path cleaning, calibration',
              ],
              [
                'Mail Inserters',
                'Monthly',
                'Lubricate mechanisms, align feeders, test all stations',
              ],
            ],
          },
          order: 8,
        ...
        },
        {
          type: 'paragraph',
          content:
            'Printyx automatically creates PM work orders based on your configured schedules. The system:',
          order: 10,
        },
        {
          type: 'list',
          ...
          content: `// Example: Automated PM Schedule Configuration
{
  ...
  "requiredSkills": ["mfp-certified"]
        ...
        },
        {
          type: 'callout',
          content:
            '📊 **Benchmark**: Top-performing dealers maintain a 35% PM-to-total-service ratio, meaning 35% of all service calls are preventive rather than reactive.',
          formatting: { style: 'info' },
          order: 16,
        },
        {
    ...
    metaDescription:
      'Set up automated preventive maintenance schedules in Printyx to reduce emergency calls and increase customer satisfaction.',
