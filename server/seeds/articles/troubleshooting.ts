...
export const troubleshootingArticles = [
  {
    ...
    excerpt: "Resolve QuickBooks, Salesforce, and manufacturer integration problems with step-by-step diagnostic guides. Get your data flowing again quickly.",
    ...
    content: {
      sections: [
        ...
        {
          type: "paragraph",
          content: "Integration issues typically fall into three categories: authentication failures, sync errors, and data mapping problems. This guide helps you diagnose and resolve the most common scenarios.",
          order: 2
        },
        {
          type: "callout",
          content: "🔧 **First Step**: Before troubleshooting, check the Integration Hub status dashboard (Settings → Integrations) to see if the issue is service-wide or specific to your connection.",
          ...
          content: `// Example: QuickBooks sync error log
{
  ...
  "retryCount": 3
        ...
        },
        {
          ...
          content: {
            ...
            rows: [
              ["All devices offline", "Network/firewall issue", "Check Printyx Client status, verify network connectivity"],
              ["Single device offline", "Device IP changed or offline", "Ping device, update IP if changed, check device power"],
              ["Meters showing zeros", "Wrong SNMP OID for model", "Update device model in Printyx, verify SNMP community string"],
              ["Permission denied errors", "SNMPv3 auth failure", "Verify SNMPv3 credentials, confirm device SNMP enabled"],
              ["Timeout errors", "Network latency or device slow", "Increase timeout setting, check network quality"]
            ]
          },
          order: 18
        },
        ...
        {
          type: "paragraph",
          content: "When bi-directional sync is enabled, conflicts can occur when the same record is modified in both systems:",
          order: 20
        },
        {
          type: "list",
        ...
        {
          type: "callout",
          content: "⚠️ **Best Practice**: Use Printyx as authoritative source for operational data (service calls, quotes) and external system for financial/CRM strategy data.",
        ...
        {
          type: "paragraph",
          content: "When contacting support, include: Integration type, error message, timestamp, affected records (invoice numbers, customer names), and steps already attempted.",
          order: 28
        }
      ]
    },
    ...
    metaDescription: "Resolve QuickBooks, Salesforce, and manufacturer integration problems with step-by-step diagnostic guides.",
  ...
  },
  {
    ...
    categorySlug: "troubleshooting",
    excerpt: "Can't log in? Lost access to features? This guide walks you through authentication, password, and permission issues step-by-step.",
    contentType: "troubleshooting",
    ...
    content: {
      sections: [
        ...
        {
          type: "callout",
          content: "🔒 **Security Note**: After 5 failed login attempts, accounts lock for 30 minutes to prevent brute force attacks. Contact your admin for immediate unlock.",
          formatting: { style: "warning" },
          order: 4
        },
        {
        ...
        },
        {
          ...
          content: {
            ...
            rows: [
              ["Can't access Admin settings", "User role insufficient", "Ask admin to upgrade role or grant specific permission"],
              ["Can't edit customer records", "Read-only role", "Admin must change to Standard User or higher"],
              ["Can't create service calls", "Service module not enabled for role", "Admin grants 'Create Service Calls' permission"],
              ["Can't see certain customers", "Tenant/location restriction", "Admin adjusts tenant/location access in user settings"],
              ["Can't delete records", "Typically requires Manager+ role", "Ask manager/admin to delete, or request role upgrade"]
            ]
          },
          order: 12
        },
        {
          type: "callout",
          content: "💡 **Permission Hierarchy**: Printyx uses 8 role levels. Higher roles inherit all lower role permissions. You may need a role upgrade to access certain features.",
          formatting: { style: "info" },
          order: 13
        },
        {
        ...
        {
          type: "paragraph",
          content: "Printyx sessions expire after 8 hours of inactivity for security. If you see 'Session expired, please log in again':",
          order: 18
        },
        {
          type: "list",
    ...
    metaDescription: "Troubleshoot authentication, password, and permission issues in Printyx with step-by-step solutions.",
