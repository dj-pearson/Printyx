...
export class TerritoryManagementService {
  ...
  private matchesTerritory(
    ...
    if (accountRules) {
      ...
      if (
        accountRules.companySizeMin &&
        leadData.companySize &&
        leadData.companySize < accountRules.companySizeMin
      ) {
        return false;
      }
      if (
        accountRules.companySizeMax &&
        leadData.companySize &&
        leadData.companySize > accountRules.companySizeMax
      ) {
        return false;
      }
      if (
        accountRules.revenueMin &&
        leadData.revenue &&
        leadData.revenue < accountRules.revenueMin
      ) {
        return false;
      }
      if (
        accountRules.revenueMax &&
        leadData.revenue &&
        leadData.revenue > accountRules.revenueMax
      ) {
        return false;
      }
    }
