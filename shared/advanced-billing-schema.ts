...
export const billingRules = pgTable(
  ...
  (table) => ({
    ...
    tenantContractIdx: index('billing_rules_tenant_contract_idx').on(
      table.tenantId,
      table.contractId,
    ),
    tenantCustomerIdx: index('billing_rules_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
    tenantEffectiveIdx: index('billing_rules_tenant_effective_idx').on(
      table.tenantId,
...
export const meterAnomalies = pgTable(
  ...
  (table) => ({
    ...
    tenantMeterIdx: index('meter_anomalies_tenant_meter_idx').on(
      table.tenantId,
      table.meterReadingId,
    ),
    tenantEquipmentIdx: index('meter_anomalies_tenant_equipment_idx').on(
      table.tenantId,
      table.equipmentId,
    ),
    tenantTypeIdx: index('meter_anomalies_tenant_type_idx').on(table.tenantId, table.anomalyType),
    tenantSeverityIdx: index('meter_anomalies_tenant_severity_idx').on(
      table.tenantId,
      table.severity,
    ),
    tenantResolvedIdx: index('meter_anomalies_tenant_resolved_idx').on(
      table.tenantId,
      table.resolved,
    ),
  }),
...
export const billingDisputes = pgTable(
  'billing_disputes',
  {
    ...
    approvedCreditAmount: decimal('approved_credit_amount', { precision: 10, scale: 2 }).default(
      '0',
    ),
  ...
  (table) => ({
    ...
    tenantStatusIdx: index('billing_disputes_tenant_status_idx').on(
      table.tenantId,
      table.disputeStatus,
    ),
    tenantInvoiceIdx: index('billing_disputes_tenant_invoice_idx').on(
      table.tenantId,
      table.invoiceId,
    ),
    tenantCustomerIdx: index('billing_disputes_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
    tenantDisputeNumIdx: index('billing_disputes_tenant_dispute_num_idx').on(
      table.tenantId,
      table.disputeNumber,
    ),
  }),
...
export const invoiceGenerationLogs = pgTable(
  ...
  (table) => ({
    ...
    tenantInvoiceIdx: index('invoice_gen_logs_tenant_invoice_idx').on(
      table.tenantId,
      table.invoiceId,
    ),
    tenantCustomerIdx: index('invoice_gen_logs_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
  }),
...
export const billingSchedules = pgTable(
  ...
  (table) => ({
    ...
    tenantActiveIdx: index('billing_schedules_tenant_active_idx').on(
      table.tenantId,
      table.isActive,
    ),
    tenantContractIdx: index('billing_schedules_tenant_contract_idx').on(
      table.tenantId,
      table.contractId,
    ),
    tenantNextRunIdx: index('billing_schedules_tenant_next_run_idx').on(
      table.tenantId,
      table.nextRunDate,
    ),
  }),
...
export const creditMemos = pgTable(
  ...
  (table) => ({
    ...
    tenantCustomerIdx: index('credit_memos_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
    tenantInvoiceIdx: index('credit_memos_tenant_invoice_idx').on(table.tenantId, table.invoiceId),
    tenantMemoNumIdx: index('credit_memos_tenant_memo_num_idx').on(
      table.tenantId,
