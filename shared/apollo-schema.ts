...
export const centralizedApolloContacts = pgTable(
  'centralized_apollo_contacts',
  {
    id: varchar('id')
      .primaryKey()
...
export const tenantApolloLeads = pgTable(
  'tenant_apollo_leads',
  {
    id: varchar('id')
      .primaryKey()
...
export const apolloSearchCache = pgTable(
  'apollo_search_cache',
  {
    id: varchar('id')
      .primaryKey()
...
export const apolloApiUsage = pgTable(
  'apollo_api_usage',
  {
    id: varchar('id')
      .primaryKey()
...
export const insertCentralizedApolloContactSchema = createInsertSchema(
