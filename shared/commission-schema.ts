...
export const commissionPlans = pgTable(
  'commission_plans',
  {
    ...
    minimumCommissionPayment: decimal('minimum_commission_payment', {
      precision: 10,
      scale: 2,
    }).default('0.00'),
...
export const commissionPlanTiers = pgTable(
...
export const commissionProductRates = pgTable(
...
export const employeeCommissionAssignments = pgTable(
  ...
  (table) => ({
    ...
    effectiveDateIdx: index('employee_commission_assignments_effective_date_idx').on(
      table.effectiveDate,
    ),
  }),
);
...
export const commissionCalculations = pgTable(
  ...
  (table) => ({
    ...
    periodIdx: index('commission_calculations_period_idx').on(
      table.calculationPeriodStart,
      table.calculationPeriodEnd,
    ),
...
export const commissionCalculationDetails = pgTable(
  'commission_calculation_details',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (table) => ({
    calculationIdIdx: index('commission_calculation_details_calculation_id_idx').on(
      table.calculationId,
    ),
...
export const commissionBonuses = pgTable(
  'commission_bonuses',
  {
    id: varchar('id')
      .primaryKey()
...
// Commission Disputes
export const commissionDisputes = pgTable(
  'commission_disputes',
  {
    id: varchar('id')
      .primaryKey()
...
export const commissionDisputeHistory = pgTable(
  'commission_dispute_history',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const commissionSalesTransactions = pgTable(
  'commission_sales_transactions',
  {
    id: varchar('id')
      .primaryKey()
      .default(sql`gen_random_uuid()`),
  ...
  (table) => ({
    ...
    calculationIdIdx: index('commission_sales_transactions_calculation_id_idx').on(
      table.calculationId,
    ),
    employeeIdIdx: index('commission_sales_transactions_employee_id_idx').on(table.employeeId),
    transactionTypeIdx: index('commission_sales_transactions_transaction_type_idx').on(
      table.transactionType,
    ),
    transactionIdIdx: index('commission_sales_transactions_transaction_id_idx').on(
      table.transactionId,
    ),
    transactionDateIdx: index('commission_sales_transactions_transaction_date_idx').on(
...
export const employeeCommissionAssignmentsRelations = relations(
...
export const commissionCalculationsRelations = relations(
...
export const commissionCalculationDetailsRelations = relations(
...
export const commissionSalesTransactionsRelations = relations(
...
export const insertEmployeeCommissionAssignmentSchema = createInsertSchema(
  employeeCommissionAssignments,
);
export const insertCommissionCalculationSchema = createInsertSchema(commissionCalculations);
export const insertCommissionCalculationDetailSchema = createInsertSchema(
  commissionCalculationDetails,
);
...
export const insertCommissionSalesTransactionSchema = createInsertSchema(
  commissionSalesTransactions,
);
