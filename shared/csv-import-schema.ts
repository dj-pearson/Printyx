...
export const ENTITY_TEMPLATES: Record<string, TemplateColumn[]> = {
  ...
  service_products: [
    { name: "Product Code", dbField: "productCode", type: "string", required: true, description: "Unique product code", example: "SVC-001", aliases: ["code", "sku", "product_id"] },
    { name: "Product Name", dbField: "productName", type: "string", required: true, description: "Service product name", example: "Installation Service", aliases: ["name", "title", "service_name"] },
    { name: "Category", dbField: "category", type: "string", required: false, description: "Product category", example: "Service", aliases: ["product_category", "type"] },
    { name: "Service Type", dbField: "serviceType", type: "string", required: false, description: "Type of service", example: "Installation", aliases: ["type", "service_category"] },
    { name: "Pricing Level", dbField: "pricingLevel", type: "string", required: false, description: "Pricing tier", example: "Standard", aliases: ["tier", "level"] },
    { name: "Description", dbField: "description", type: "string", required: false, description: "Product description", example: "On-site installation service", aliases: ["desc", "details"] },
    { name: "Summary", dbField: "summary", type: "string", required: false, description: "Short summary", example: "Professional installation", aliases: ["short_desc"] },
    { name: "Note", dbField: "note", type: "string", required: false, description: "Additional notes", example: "Requires scheduling", aliases: ["notes", "comments"] },
    { name: "EA Notes", dbField: "eaNotes", type: "string", required: false, description: "E-Automate notes", example: "Sync from EA", aliases: ["ea_notes", "integration_notes"] },
    { name: "Related Products", dbField: "relatedProducts", type: "string", required: false, description: "Related product codes", example: "SVC-002,SVC-003", aliases: ["related", "linked_products"] },
    { name: "Is Active", dbField: "isActive", type: "boolean", required: false, description: "Product is active", example: "true", aliases: ["active", "enabled"] },
    { name: "Available For All", dbField: "availableForAll", type: "boolean", required: false, description: "Available to all reps", example: "false", aliases: ["all_reps"] },
    { name: "Sales Rep Credit", dbField: "salesRepCredit", type: "boolean", required: false, description: "Gives rep credit", example: "true", aliases: ["rep_credit"] },
    { name: "Funding", dbField: "funding", type: "boolean", required: false, description: "Eligible for funding", example: "true", aliases: ["fundable"] },
    { name: "Lease", dbField: "lease", type: "boolean", required: false, description: "Leasable product", example: "false", aliases: ["leasable"] },
    { name: "Payment Type", dbField: "paymentType", type: "string", required: false, description: "Payment method", example: "one-time", aliases: ["payment_method"] },
    { name: "New Rep Price", dbField: "newRepPrice", type: "currency", required: false, description: "Price for new reps", example: "99.99", aliases: ["new_price"] },
    { name: "Upgrade Rep Price", dbField: "upgradeRepPrice", type: "currency", required: false, description: "Price for upgrades", example: "79.99", aliases: ["upgrade_price"] },
    { name: "Lexmark Rep Price", dbField: "lexmarkRepPrice", type: "currency", required: false, description: "Lexmark rep price", example: "89.99", aliases: ["lexmark_price"] },
    { name: "Graphic Rep Price", dbField: "graphicRepPrice", type: "currency", required: false, description: "Graphic rep price", example: "109.99", aliases: ["graphic_price"] },
  ],

  software_products: [
    { name: "Product Code", dbField: "productCode", type: "string", required: true, description: "Unique product code", example: "SW-001", aliases: ["code", "sku", "product_id"] },
    { name: "Product Name", dbField: "productName", type: "string", required: true, description: "Software product name", example: "Document Management Pro", aliases: ["name", "title", "software_name"] },
    { name: "Category", dbField: "category", type: "string", required: false, description: "Software category", example: "Document Management", aliases: ["product_category", "type"] },
    { name: "Vendor", dbField: "vendor", type: "string", required: false, description: "Software vendor", example: "Adobe", aliases: ["manufacturer", "publisher"] },
    { name: "Description", dbField: "description", type: "string", required: false, description: "Product description", example: "Enterprise document management", aliases: ["desc", "details"] },
    { name: "Version", dbField: "version", type: "string", required: false, description: "Software version", example: "2024.1", aliases: ["ver", "release"] },
    { name: "Price", dbField: "price", type: "currency", required: false, description: "List price", example: "499.99", aliases: ["list_price", "msrp"] },
    { name: "Cost Price", dbField: "costPrice", type: "currency", required: false, description: "Cost/wholesale price", example: "299.99", aliases: ["cost", "wholesale"] },
    { name: "License Type", dbField: "licenseType", type: "string", required: false, description: "License type", example: "subscription", aliases: ["license", "lic_type"], validation: { enum: ["perpetual", "subscription", "open_source", "trial", "freeware"] } },
    { name: "Support Included", dbField: "supportIncluded", type: "boolean", required: false, description: "Includes support", example: "true", aliases: ["support", "has_support"] },
    { name: "System Requirements", dbField: "systemRequirements", type: "string", required: false, description: "System requirements", example: "Windows 10+, 8GB RAM", aliases: ["requirements", "specs"] },
    { name: "Status", dbField: "status", type: "string", required: false, description: "Product status", example: "active", aliases: ["product_status"], validation: { enum: ["active", "inactive", "discontinued", "coming_soon"] } },
  ],
};
