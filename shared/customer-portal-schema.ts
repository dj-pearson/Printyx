...
export const customerServiceRequests = pgTable(
  'customer_service_requests',
  {
    ...
    customerPortalUserId: uuid('customer_portal_user_id')
      .notNull()
...
export const customerMeterSubmissions = pgTable(
...
// Supply Orders
export const customerSupplyOrders = pgTable(
...
// Supply Order Items
export const customerSupplyOrderItems = pgTable(
  'customer_supply_order_items',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    orderId: uuid('order_id')
      .notNull()
      .references(() => customerSupplyOrders.id, { onDelete: 'cascade' }),
...
export const customerNotifications = pgTable(
  'customer_notifications',
  {
    ...
    // Related records
    relatedServiceRequestId: uuid('related_service_request_id').references(
      () => customerServiceRequests.id,
    ),
  ...
  (table) => ({
    tenantCustomerIdx: index('tenant_customer_notification_idx').on(
      table.tenantId,
      table.customerId,
    ),
...
export const customerServiceRequestStatusHistory = pgTable(
  'customer_service_request_status_history',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    tenantId: uuid('tenant_id').notNull(),
...
export const customerPortalActivityLog = pgTable(
...
export const customerServiceRequestStatusHistoryRelations = relations(
...
export const customerSatisfactionSurveyTemplates = pgTable(
...
export const customerSatisfactionSurveyQuestions = pgTable(
  'customer_satisfaction_survey_questions',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    templateId: uuid('template_id')
      .notNull()
      .references(() => customerSatisfactionSurveyTemplates.id, { onDelete: 'cascade' }),
  ...
  (table) => ({
    templateOrderIdx: index('survey_question_template_order_idx').on(
      table.templateId,
      table.orderIndex,
    ),
...
export const customerSatisfactionSurveys = pgTable(
  'customer_satisfaction_surveys',
  {
    ...
    templateId: uuid('template_id')
      .notNull()
      .references(() => customerSatisfactionSurveyTemplates.id),
    ...
    relatedMaintenanceAppointmentId: uuid('related_maintenance_appointment_id').references(
      () => customerMaintenanceAppointments.id,
    ),
    relatedSupplyOrderId: uuid('related_supply_order_id').references(() => customerSupplyOrders.id),
    relatedPaymentId: uuid('related_payment_id').references(() => customerPayments.id),
...
export const customerSatisfactionSurveyResponses = pgTable(
  'customer_satisfaction_survey_responses',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    surveyId: uuid('survey_id')
      .notNull()
      .references(() => customerSatisfactionSurveys.id, { onDelete: 'cascade' }),
    questionId: uuid('question_id')
      .notNull()
      .references(() => customerSatisfactionSurveyQuestions.id),
  ...
  (table) => ({
    surveyQuestionIdx: index('survey_response_survey_question_idx').on(
      table.surveyId,
      table.questionId,
    ),
...
export const customerSatisfactionAnalytics = pgTable(
  ...
  (table) => ({
    tenantPeriodIdx: index('analytics_tenant_period_idx').on(
      table.tenantId,
      table.periodType,
      table.periodStart,
    ),
...
export const customerMaintenanceAppointmentsRelations = relations(
...
export const technicianAvailabilitySlotsRelations = relations(
...
export const insertCustomerServiceRequestStatusHistorySchema = createInsertSchema(
  customerServiceRequestStatusHistory,
);
...
export const insertCustomerMaintenanceAppointmentSchema = createInsertSchema(
  customerMaintenanceAppointments,
).omit({
  id: true,
  createdAt: true,
...
export const insertTechnicianAvailabilitySlotSchema = createInsertSchema(
  technicianAvailabilitySlots,
).omit({
  id: true,
  createdAt: true,
...
export type CustomerServiceRequestStatusHistory =
  typeof customerServiceRequestStatusHistory.$inferSelect;
export type InsertCustomerServiceRequestStatusHistory =
  typeof customerServiceRequestStatusHistory.$inferInsert;
...
export type InsertCustomerMaintenanceAppointment =
  typeof customerMaintenanceAppointments.$inferInsert;
...
export const insertCustomerSatisfactionSurveyTemplateSchema = createInsertSchema(
...
export const insertCustomerSatisfactionSurveyQuestionSchema = createInsertSchema(
...
export const insertCustomerSatisfactionSurveyResponseSchema = createInsertSchema(
...
export const insertCustomerSatisfactionAnalyticsSchema = createInsertSchema(
...
export type CustomerSatisfactionSurveyTemplate =
  typeof customerSatisfactionSurveyTemplates.$inferSelect;
export type CustomerSatisfactionSurveyQuestion =
  typeof customerSatisfactionSurveyQuestions.$inferSelect;
...
export type CustomerSatisfactionSurveyResponse =
  typeof customerSatisfactionSurveyResponses.$inferSelect;
export type CustomerSatisfactionAnalytics = typeof customerSatisfactionAnalytics.$inferSelect;

export type InsertCustomerSatisfactionSurveyTemplate = z.infer<
  typeof insertCustomerSatisfactionSurveyTemplateSchema
>;
export type InsertCustomerSatisfactionSurveyQuestion = z.infer<
  typeof insertCustomerSatisfactionSurveyQuestionSchema
>;
export type InsertCustomerSatisfactionSurvey = z.infer<
  typeof insertCustomerSatisfactionSurveySchema
>;
export type InsertCustomerSatisfactionSurveyResponse = z.infer<
  typeof insertCustomerSatisfactionSurveyResponseSchema
>;
export type InsertCustomerSatisfactionAnalytics = z.infer<
  typeof insertCustomerSatisfactionAnalyticsSchema
>;
