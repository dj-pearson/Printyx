...
export const customerHealthScores = pgTable(
  ...
  (table) => ({
    tenantCustomerIdx: index('health_scores_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
    tenantStatusIdx: index('health_scores_tenant_status_idx').on(
      table.tenantId,
      table.healthStatus,
    ),
...
export const churnPredictions = pgTable(
  ...
  (table) => ({
    ...
    tenantProbabilityIdx: index('churn_pred_tenant_probability_idx').on(
      table.tenantId,
      table.churnProbability,
    ),
    tenantInterventionIdx: index('churn_pred_tenant_intervention_idx').on(
      table.tenantId,
      table.interventionRequired,
    ),
...
export const successInterventions = pgTable(
  ...
  (table) => ({
    tenantCustomerIdx: index('interventions_tenant_customer_idx').on(
      table.tenantId,
      table.customerId,
    ),
    tenantStatusIdx: index('interventions_tenant_status_idx').on(table.tenantId, table.status),
    tenantTypeIdx: index('interventions_tenant_type_idx').on(
      table.tenantId,
      table.interventionType,
    ),
    tenantPriorityIdx: index('interventions_tenant_priority_idx').on(
      table.tenantId,
      table.priority,
    ),
...
export const renewalOpportunities = pgTable(
  ...
  (table) => ({
    ...
    tenantDaysUntilIdx: index('renewals_tenant_days_until_idx').on(
      table.tenantId,
      table.daysUntilRenewal,
    ),
