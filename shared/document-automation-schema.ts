...
export const generatedDocuments = pgTable('generated_documents', {
  ...
  // Related entities
  workflowId: varchar('workflow_id'), // If generated by workflow
  taskId: varchar('task_id'), // If generated for task
  businessRecordId: varchar('business_record_id'),
  quoteId: varchar('quote_id'),
  dealId: varchar('deal_id'),
  serviceCallId: varchar('service_call_id'),
...
export const documentUploads = pgTable('document_uploads', {
  ...
  targetEntityId: varchar('target_entity_id'), // ID of created/updated entity
