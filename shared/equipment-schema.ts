...
export const equipmentLifecycleTransitionsRelations = relations(equipmentLifecycleTransitions, ({ one }) => ({
...
export const insertLifecycleTransitionRuleSchema = createInsertSchema(lifecycleTransitionRules).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
