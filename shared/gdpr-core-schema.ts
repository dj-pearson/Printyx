...
export const exportFormatEnum = pgEnum('export_format', ['json', 'csv', 'xml', 'pdf', 'zip']);
 ...
 */
export const consentPreferencesTemplate = pgTable(
  'consent_preferences_template',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    tenantId: uuid('tenant_id').notNull(),
 ...
 */
export const dataProcessingAgreements = pgTable(
  'data_processing_agreements',
  {
    ...
    subprocessors: jsonb('subprocessors')
      .$type<
        Array<{
          name: string;
          purpose: string;
 ...
 */
export const dpaComplianceChecks = pgTable(
 ...
 */
export const personalDataExports = pgTable(
 ...
 */
export const dataExportTemplates = pgTable(
 ...
 */
export const duplicateDetectionRules = pgTable(
  'duplicate_detection_rules',
  {
    ...
    fieldMergeRules: jsonb('field_merge_rules')
      .$type<
        Record<
          string,
          {
 ...
 */
export const contactMergeHistory = pgTable(
  'contact_merge_history',
  {
    ...
    relatedUpdates: jsonb('related_updates')
      .$type<
        Array<{
          tableName: string;
          recordCount: number;
 ...
 */
export const duplicateScanJobs = pgTable(
  'duplicate_scan_jobs',
  {
    id: uuid('id').primaryKey().defaultRandom(),
    tenantId: uuid('tenant_id').notNull(),
...
export const dataProcessingAgreementsRelations = relations(
...
export const insertConsentPreferencesTemplateSchema = createInsertSchema(
...
export const insertDataProcessingAgreementSchema = createInsertSchema(
  dataProcessingAgreements,
).omit({
  id: true,
  createdAt: true,
...
export type InsertConsentPreferencesTemplate = z.infer<
  typeof insertConsentPreferencesTemplateSchema
>;
