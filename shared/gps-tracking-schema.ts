...
export const technicianLocations = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("technician_locations_technician_id_idx").on(table.tenantId, table.technicianId),
    statusIdx: index("technician_locations_status_idx").on(table.tenantId, table.status),
    ticketIdIdx: index("technician_locations_ticket_id_idx").on(table.tenantId, table.currentTicketId),
...
export const locationHistory = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("location_history_technician_id_idx").on(table.tenantId, table.technicianId),
    ...
    activityTypeIdx: index("location_history_activity_type_idx").on(table.tenantId, table.activityType),
  })
);
...
export const routeAssignments = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("route_assignments_technician_id_idx").on(table.tenantId, table.technicianId),
...
export const routeDeviations = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("route_deviations_technician_id_idx").on(table.tenantId, table.technicianId),
...
export const etaCalculations = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("eta_calculations_technician_id_idx").on(table.tenantId, table.technicianId),
    routeIdIdx: index("eta_calculations_route_id_idx").on(table.tenantId, table.routeId),
    calculatedAtIdx: index("eta_calculations_calculated_at_idx").on(table.tenantId, table.calculatedAt),
  })
);
...
export const geofenceEvents = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index("geofence_events_technician_id_idx").on(table.tenantId, table.technicianId),
