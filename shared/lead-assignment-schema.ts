...
export const salesTerritories = pgTable('sales_territories', {
  ...
  tenantActiveIdx: index('sales_territories_tenant_active_idx').on(table.tenantId, table.isActive),
...
export const leadAssignmentRules = pgTable('lead_assignment_rules', {
  ...
  tenantActiveIdx: index('lead_assignment_rules_tenant_active_idx').on(table.tenantId, table.isActive),
...
export const repCapacity = pgTable('rep_capacity', {
  id: varchar('id').primaryKey().default(sql`gen_random_uuid()`),
  tenantId: varchar('tenant_id').notNull(),
...
export const leadAssignmentHistory = pgTable('lead_assignment_history', {
  ...
  tenantLeadIdx: index('lead_assignment_history_tenant_lead_idx').on(table.tenantId, table.leadId),
...
export const leadAssignmentQueue = pgTable('lead_assignment_queue', {
  id: varchar('id').primaryKey().default(sql`gen_random_uuid()`),
  tenantId: varchar('tenant_id').notNull(),
  leadId: varchar('lead_id').notNull(),
  ...
  tenantStatusIdx: index('lead_assignment_queue_tenant_status_idx').on(table.tenantId, table.status),
