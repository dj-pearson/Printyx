...
export const leadScoringRules = pgTable(
  ...
  (table) => ({
    ...
    tenantCategoryIdx: index('lead_scoring_rules_tenant_category_idx').on(
      table.tenantId,
      table.category,
    ),
    tenantActiveIdx: index('lead_scoring_rules_tenant_active_idx').on(
      table.tenantId,
      table.isActive,
    ),
...
export const leadScoringFactors = pgTable(
...
export const bantQualificationCriteria = pgTable(
  ...
  (table) => ({
    ...
    tenantStatusIdx: index('bant_qualification_tenant_status_idx').on(
      table.tenantId,
      table.qualificationStatus,
    ),
    statusIdx: index('bant_qualification_status_idx').on(table.qualificationStatus),
    tenantScoreIdx: index('bant_qualification_tenant_score_idx').on(
      table.tenantId,
      table.totalBantScore,
    ),
  }),
);
...
export const leadScoreCalculations = pgTable(
  ...
  (table) => ({
    ...
    tenantLeadIdx: index('lead_score_calculations_tenant_lead_idx').on(
      table.tenantId,
      table.leadId,
    ),
    tenantIdx: index('lead_score_calculations_tenant_idx').on(table.tenantId),
    tenantScoreIdx: index('lead_score_calculations_tenant_score_idx').on(
      table.tenantId,
      table.totalScore,
    ),
    tenantCalculatedAtIdx: index('lead_score_calculations_tenant_calc_at_idx').on(
      table.tenantId,
      table.calculatedAt,
    ),
...
export const leadQualificationHistory = pgTable(
  ...
  (table) => ({
    ...
    tenantLeadIdx: index('lead_qualification_history_tenant_lead_idx').on(
      table.tenantId,
      table.leadId,
    ),
    tenantIdx: index('lead_qualification_history_tenant_idx').on(table.tenantId),
    tenantChangedAtIdx: index('lead_qualification_history_tenant_changed_idx').on(
      table.tenantId,
      table.changedAt,
    ),
...
export const leadEngagementTracking = pgTable(
  ...
  (table) => ({
    ...
    tenantLeadIdx: index('lead_engagement_tracking_tenant_lead_idx').on(
      table.tenantId,
      table.leadId,
    ),
    tenantIdx: index('lead_engagement_tracking_tenant_idx').on(table.tenantId),
    tenantEngagedAtIdx: index('lead_engagement_tracking_tenant_engaged_idx').on(
      table.tenantId,
      table.engagedAt,
    ),
...
export const insertLeadQualificationHistorySchema = createInsertSchema(
