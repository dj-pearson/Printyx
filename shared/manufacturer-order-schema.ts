...
export const manufacturerOrderLineItems = pgTable(
  ...
  (table) => ({
    ...
    productCodeIdx: index("manufacturer_order_line_items_product_code_idx").on(
      table.productCode
    ),
...
export const manufacturerOrderShipments = pgTable(
  ...
  (table) => ({
    ...
    shippedDateIdx: index("manufacturer_order_shipments_shipped_date_idx").on(
      table.shippedDate
    ),
  })
);
...
export const manufacturerOrderExceptions = pgTable(
  ...
  (table) => ({
    ...
    connectionIdx: index("manufacturer_order_exceptions_connection_idx").on(
      table.connectionId
    ),
...
// Insert Schemas
export const insertManufacturerConnectionSchema = createInsertSchema(
...
export type InsertManufacturerOrderLineItem = z.infer<
  typeof insertManufacturerOrderLineItemSchema
>;
...
export type InsertManufacturerOrderShipment = z.infer<
  typeof insertManufacturerOrderShipmentSchema
>;
