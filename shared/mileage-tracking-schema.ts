...
export const technicianMileage = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index('technician_mileage_technician_id_idx').on(
      table.tenantId,
      table.technicianId,
    ),
    dateIdx: index('technician_mileage_date_idx').on(table.tenantId, table.date),
    yearMonthIdx: index('technician_mileage_year_month_idx').on(
      table.tenantId,
      table.year,
      table.monthNumber,
    ),
...
export const insertMileageReimbursementRateSchema = createInsertSchema(
...
export const mileageReports = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index('mileage_reports_technician_id_idx').on(
      table.tenantId,
      table.technicianId,
    ),
    periodIdx: index('mileage_reports_period_idx').on(
      table.tenantId,
      table.periodStart,
      table.periodEnd,
    ),
...
export const vehicleAssignments = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index('vehicle_assignments_technician_id_idx').on(
      table.tenantId,
      table.assignedToTechnicianId,
    ),
...
export const irsMileageLogs = pgTable(
  ...
  (table) => ({
    ...
    technicianIdIdx: index('irs_mileage_logs_technician_id_idx').on(
      table.tenantId,
      table.technicianId,
    ),
