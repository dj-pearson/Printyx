...
export const exportFormatEnum = pgEnum('export_format', ['json', 'csv', 'xlsx', 'pdf']);
...
export const targetTypeEnum = pgEnum('target_type', ['absolute', 'percentage', 'ratio']);
...
export const userReportPreferences = pgTable(
...
export const userReportActivity = pgTable(
