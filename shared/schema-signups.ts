...
export const trialActivityLog = pgTable('trial_activity_log', {
  id: varchar('id').primaryKey().default(sql`gen_random_uuid()`),
  signupId: varchar('signup_id').notNull().references(() => platformSignups.id, { onDelete: 'cascade' }),
...
export const trialCommunications = pgTable('trial_communications', {
  id: varchar('id').primaryKey().default(sql`gen_random_uuid()`),
  signupId: varchar('signup_id').notNull().references(() => platformSignups.id, { onDelete: 'cascade' }),
