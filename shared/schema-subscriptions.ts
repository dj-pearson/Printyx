...
export const subscriptionPlans = pgTable('subscription_plans', {
  ...
  // Stripe integration - Price IDs for checkout
...
export const tenantSubscriptions = pgTable(
  ...
  (table) => ({
    ...
    stripeSubscriptionIdx: index('tenant_subscriptions_stripe_subscription_id_idx').on(
...
export const dailyUsageSnapshots = pgTable(
...
export const subscriptionPaymentMethods = pgTable(
...
export const tenantAddonSubscriptions = pgTable(
  ...
  (table) => ({
    ...
    subscriptionIdIdx: index('tenant_addon_subscriptions_subscription_id_idx').on(
