...
export const roles = pgTable("roles", {
  ...
  canViewCompanyFinancials: boolean("can_view_company_financials").default(
    false
  ), // For C-level roles
...
export const userSettings = pgTable("user_settings", {
  ...
  accessibility: jsonb("accessibility").default(
    '{"highContrast": false, "reducedMotion": false, "fontSize": "medium", "screenReader": false, "keyboardNavigation": false, "colorBlind": "none", "soundEnabled": true, "voiceCommands": false}'
  ),
...
export const userCustomerAssignments = pgTable("user_customer_assignments", {
  ...
  assignmentType: varchar("assignment_type", { length: 20 })
    .notNull()
    .default("primary"), // primary, secondary, support
  createdAt: timestamp("created_at").defaultNow(),
});
...
export const companies = pgTable("companies", {
  ...
  businessRecordType: varchar("business_record_type")
    .notNull()
    .default("Customer"),
...
export const serviceCalls = pgTable("service_calls", {
  ...
  // Financial Information
  laborChargeAmount: decimal("labor_charge_amount", {
    precision: 10,
    scale: 2,
  }), // E-Automate LaborCharge
  partsChargeAmount: decimal("parts_charge_amount", {
    precision: 10,
    scale: 2,
  }), // E-Automate PartsCharge
  travelChargeAmount: decimal("travel_charge_amount", {
    precision: 10,
    scale: 2,
  }), // E-Automate TravelCharge
  totalChargeAmount: decimal("total_charge_amount", {
    precision: 10,
    scale: 2,
  }), // E-Automate TotalCharge
...
export const invoices = pgTable("invoices", {
  ...
  monthlyBase: decimal("monthly_base", { precision: 10, scale: 2 }).default(
    "0"
  ),
  blackCopiesTotal: integer("black_copies_total").default(0),
  colorCopiesTotal: integer("color_copies_total").default(0),
  blackAmount: decimal("black_amount", { precision: 10, scale: 2 }).default(
    "0"
  ),
  colorAmount: decimal("color_amount", { precision: 10, scale: 2 }).default(
    "0"
  ),
...
export type InsertCustomerRelatedRecord =
  typeof customerRelatedRecords.$inferInsert;
...
export const salesMetrics = pgTable("sales_metrics", {
  ...
  // Conversion Metrics
  callAnswerRate: decimal("call_answer_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  emailResponseRate: decimal("email_response_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  activityToMeetingRate: decimal("activity_to_meeting_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  meetingToProposalRate: decimal("meeting_to_proposal_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  proposalClosingRate: decimal("proposal_closing_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  ...
  activitiesPerDeal: decimal("activities_per_deal", {
    precision: 8,
    scale: 2,
  }).default("0"),
  ...
  projectedRevenue: decimal("projected_revenue", {
    precision: 12,
    scale: 2,
  }).default("0"),
...
export const conversionFunnel = pgTable("conversion_funnel", {
  ...
  activityToConnectionRate: decimal("activity_to_connection_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  connectionToMeetingRate: decimal("connection_to_meeting_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  meetingToProposalRate: decimal("meeting_to_proposal_rate", {
  ...
  proposalToWinRate: decimal("proposal_to_win_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
  overallConversionRate: decimal("overall_conversion_rate", {
    precision: 5,
    scale: 2,
  }).default("0"),
...
export const managerInsights = pgTable("manager_insights", {
  ...
  // Key Metrics
  currentPerformance: decimal("current_performance", {
    precision: 10,
    scale: 2,
  }),
...
export const onboardingPrintManagement = pgTable(
...
export const onboardingDynamicSections = pgTable(
...
export type InsertOnboardingChecklist = z.infer<
  typeof insertOnboardingChecklistSchema
>;

export type OnboardingEquipment = typeof onboardingEquipment.$inferSelect;
export type InsertOnboardingEquipment = z.infer<
  typeof insertOnboardingEquipmentSchema
>;

export type OnboardingNetworkConfig =
  typeof onboardingNetworkConfig.$inferSelect;
export type InsertOnboardingNetworkConfig = z.infer<
  typeof insertOnboardingNetworkConfigSchema
>;

export type OnboardingPrintManagement =
  typeof onboardingPrintManagement.$inferSelect;
export type InsertOnboardingPrintManagement = z.infer<
  typeof insertOnboardingPrintManagementSchema
>;

export type OnboardingDynamicSection =
  typeof onboardingDynamicSections.$inferSelect;
export type InsertOnboardingDynamicSection = z.infer<
  typeof insertOnboardingDynamicSectionSchema
>;
...
export const userCustomerAssignmentsRelations = relations(
...
export const businessRecordsRelations = relations(
  businessRecords,
  ({ one, many }) => ({
    tenant: one(tenants, {
...
export const businessRecordActivitiesRelations = relations(
...
export const leadRelatedRecordsRelations = relations(
  leadRelatedRecords,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const contractTieredRatesRelations = relations(
  contractTieredRates,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const salesTeamMembersRelations = relations(
  salesTeamMembers,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const conversionFunnelRelations = relations(
  conversionFunnel,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const managerInsightsRelations = relations(
  managerInsights,
  ({ one }) => ({
    tenant: one(tenants, {
...
export type InsertCustomerNumberConfig =
  typeof customerNumberConfig.$inferInsert;
export type CustomerNumberHistory = typeof customerNumberHistory.$inferSelect;
export type InsertCustomerNumberHistory =
...
export const insertContractTieredRateSchema = createInsertSchema(
  contractTieredRates
).omit({
  id: true,
  createdAt: true,
...
export const insertServiceTicketSchema = createInsertSchema(
  serviceTickets
).omit({
  id: true,
  createdAt: true,
...
export type UserCustomerAssignment =
  typeof userCustomerAssignments.$inferSelect;
...
export const insertProductAccessorySchema = createInsertSchema(
  productAccessories
).omit({
  id: true,
  createdAt: true,
...
export const insertServiceProductSchema = createInsertSchema(
  serviceProducts
).omit({
  id: true,
  createdAt: true,
...
export const insertSoftwareProductSchema = createInsertSchema(
  softwareProducts
).omit({
  id: true,
  createdAt: true,
...
export const insertManagedServiceSchema = createInsertSchema(
  managedServices
).omit({
  id: true,
  createdAt: true,
...
export const enhancedContactsRelations = relations(
  enhancedContacts,
  ({ one, many }) => ({
    tenant: one(tenants, {
...
export const enhancedProductsRelations = relations(
  enhancedProducts,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const insertBusinessRecordSchema = createInsertSchema(
  businessRecords
).omit({
  id: true,
  createdAt: true,
...
export const insertEnhancedContactSchema = createInsertSchema(
  enhancedContacts
).omit({
  id: true,
  createdAt: true,
...
export const insertEnhancedProductSchema = createInsertSchema(
  enhancedProducts
).omit({
  id: true,
  createdAt: true,
...
export type InsertEnrichedOrgHierarchy =
  typeof enrichedOrgHierarchy.$inferInsert;
...
export type InsertProspectingCampaign =
...
export const enrichedContactsRelations = relations(
  enrichedContacts,
  ({ one, many }) => ({
    tenant: one(tenants, {
...
export const enrichedCompaniesRelations = relations(
  enrichedCompanies,
  ({ one, many }) => ({
    tenant: one(tenants, {
...
export const enrichedIntentDataRelations = relations(
  enrichedIntentData,
  ({ one }) => ({
    tenant: one(tenants, {
...
export const enrichedOrgHierarchyRelations = relations(
...
export const enrichmentActivitiesRelations = relations(
...
export const prospectingCampaignsRelations = relations(
...
export const insertSystemIntegrationSchema = createInsertSchema(
  systemIntegrations
).omit({
  id: true,
  createdAt: true,
...
export type InsertSystemIntegration = z.infer<
  typeof insertSystemIntegrationSchema
>;
...
// Insert schemas
export const insertEquipmentPackageSchema = createInsertSchema(
  equipmentPackages
).omit({
  id: true,
  createdAt: true,
...
export const insertProposalLineItemSchema = createInsertSchema(
  proposalLineItems
).omit({
  id: true,
  createdAt: true,
...
export const insertProposalCommentSchema = createInsertSchema(
  proposalComments
).omit({
  id: true,
  createdAt: true,
...
export const insertProposalAnalyticsSchema = createInsertSchema(
  proposalAnalytics
).omit({
  id: true,
  createdAt: true,
...
export const insertProposalApprovalSchema = createInsertSchema(
  proposalApprovals
).omit({
  id: true,
  createdAt: true,
...
export const productPricing = pgTable("product_pricing", {
  ...
  companyMarkupPercentage: decimal("company_markup_percentage", {
    precision: 5,
    scale: 2,
  ...
  suggestedRetailPrice: decimal("suggested_retail_price", {
    precision: 12,
    scale: 2,
  }), // MSRP
...
export const quotePricing = pgTable("quote_pricing", {
  ...
  blanketGrossProfitPercentage: decimal("blanket_gross_profit_percentage", {
    precision: 5,
    scale: 2,
  }).default("10.00"),
  ...
  // Quote Totals
  totalDealerCost: decimal("total_dealer_cost", { precision: 12, scale: 2 })
    .notNull()
    .default("0"),
  totalCompanyPrice: decimal("total_company_price", { precision: 12, scale: 2 })
    .notNull()
    .default("0"),
  totalSalePrice: decimal("total_sale_price", { precision: 12, scale: 2 })
    .notNull()
    .default("0"),
  totalGrossProfit: decimal("total_gross_profit", { precision: 12, scale: 2 })
    .notNull()
    .default("0"),
  totalGrossProfitPercentage: decimal("total_gross_profit_percentage", {
    precision: 5,
    scale: 2,
  }).default("0"),
...
export const quotePricingLineItems = pgTable("quote_pricing_line_items", {
  ...
  // Line Item Totals
  totalDealerCost: decimal("total_dealer_cost", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalCompanyPrice: decimal("total_company_price", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalSalePrice: decimal("total_sale_price", {
    precision: 12,
    scale: 2,
  }).notNull(),

  // Profit Calculations
  unitGrossProfit: decimal("unit_gross_profit", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalGrossProfit: decimal("total_gross_profit", {
    precision: 12,
    scale: 2,
  }).notNull(),
  grossProfitPercentage: decimal("gross_profit_percentage", {
    precision: 5,
    scale: 2,
  }).notNull(),
  ...
  customGrossProfitPercentage: decimal("custom_gross_profit_percentage", {
    precision: 5,
    scale: 2,
  }),
...
export const chartOfAccounts = pgTable("chart_of_accounts", {
  ...
  debitBalance: decimal("debit_balance", { precision: 12, scale: 2 }).default(
    "0"
  ),
...
export type InsertCompanyPricingSetting =
  typeof companyPricingSettings.$inferInsert;
...
export type InsertQuotePricingLineItem =
  typeof quotePricingLineItems.$inferInsert;

// Pricing Schema Validations
export const insertCompanyPricingSettingSchema = createInsertSchema(
...
export const insertProductPricingSchema = createInsertSchema(
  productPricing
).omit({
  id: true,
  createdAt: true,
...
export const insertQuotePricingLineItemSchema = createInsertSchema(
...
export const insertAccountsPayableSchema = createInsertSchema(
  accountsPayable
).omit({
  id: true,
  createdAt: true,
...
export const insertAccountsReceivableSchema = createInsertSchema(
  accountsReceivable
).omit({
  id: true,
  createdAt: true,
...
export const insertSocialMediaCronJobSchema = createInsertSchema(
  socialMediaCronJobs
).omit({
  id: true,
  createdAt: true,
...
export type InsertSocialMediaCronJob = z.infer<
  typeof insertSocialMediaCronJobSchema
>;

// ============= PROPOSAL SYSTEM SCHEMAS =============

// Proposal Template Schemas
export const insertProposalTemplateSchema = createInsertSchema(
  proposalTemplates
).omit({
  id: true,
  createdAt: true,
...
export const insertProposalTemplateSectionSchema = createInsertSchema(
...
export const insertProposalContentBlockSchema = createInsertSchema(
...
export const insertProposalSectionSchema = createInsertSchema(
  proposalSections
).omit({
  id: true,
  createdAt: true,
...
export const insertCompanyBrandingProfileSchema = createInsertSchema(
  companyBrandingProfiles
).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
...
export type ProposalTemplate = typeof proposalTemplates.$inferSelect;
export type InsertProposalTemplate = z.infer<
  typeof insertProposalTemplateSchema
>;
export type ProposalTemplateSection =
  typeof proposalTemplateSections.$inferSelect;
export type InsertProposalTemplateSection = z.infer<
  typeof insertProposalTemplateSectionSchema
>;
export type ProposalContentBlock = typeof proposalContentBlocks.$inferSelect;
export type InsertProposalContentBlock = z.infer<
  typeof insertProposalContentBlockSchema
>;
...
export type CompanyBrandingProfile =
  typeof companyBrandingProfiles.$inferSelect;
export type InsertCompanyBrandingProfile = z.infer<
  typeof insertCompanyBrandingProfileSchema
>;

// Master Product Catalog - Platform-maintained product database
export const masterProductModels = pgTable(
  ...
  (table) => ({
    manufacturerModelIdx: index("master_models_manufacturer_model_idx").on(
      table.manufacturer,
      table.modelCode
    ),
...
export const enabledProducts = pgTable(
  "enabled_products",
  {
    enabledProductId: varchar("enabled_product_id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
    tenantId: varchar("tenant_id").notNull(),
...
export const masterProductAccessoryRelationships = pgTable(
  "master_product_accessory_relationships",
  {
    ...
    relationshipType: varchar("relationship_type")
      .notNull()
      .default("compatible"), // compatible, recommended, required
    category: varchar("category"), // Hardware Accessories, Showroom, etc.
    createdAt: timestamp("created_at").defaultNow(),
  },
  (table) => ({
    baseProductIdx: index("master_relationships_base_idx").on(
      table.baseProductId
    ),
    accessoryIdx: index("master_relationships_accessory_idx").on(
      table.accessoryId
    ),
    uniqueRelationship: index("master_relationships_unique_idx").on(
      table.baseProductId,
      table.accessoryId
    ),
  })
...
export const tenantEnabledProducts = pgTable(
  "tenant_enabled_products",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export type MasterProductAccessory =
  typeof masterProductAccessories.$inferSelect;
export type InsertMasterProductAccessory =
  typeof masterProductAccessories.$inferInsert;
...
export type InsertTenantEnabledProduct =
  typeof tenantEnabledProducts.$inferInsert;
export type MasterProductAccessoryRelationship =
  typeof masterProductAccessoryRelationships.$inferSelect;
export type InsertMasterProductAccessoryRelationship =
  typeof masterProductAccessoryRelationships.$inferInsert;

// Insert schemas for master catalog
export const insertMasterProductModelSchema = createInsertSchema(
  masterProductModels
).omit({
  id: true,
  createdAt: true,
...
export const insertEnabledProductSchema = createInsertSchema(
  enabledProducts
).omit({
...
export const insertTenantEnabledProductSchema = createInsertSchema(
...
export const seoSettings = pgTable("seo_settings", {
  id: varchar("id")
    .primaryKey()
    .default(sql`gen_random_uuid()`),
  tenantId: varchar("tenant_id"), // null for platform/global
  ...
  allowAiCrawling: boolean("allow_ai_crawling").default(true),
  sitemapChangefreq: varchar("sitemap_changefreq").default("weekly"),
  sitemapPriorityDefault: decimal("sitemap_priority_default", {
    precision: 2,
    scale: 1,
  }).default("0.5" as any),
...
export const seoPages = pgTable(
  "seo_pages",
  {
    ...
    title: varchar("title"),
    description: text("description"),
    lastmod: timestamp("lastmod").defaultNow(),
    changefreq: varchar("changefreq").default("monthly"),
    priority: decimal("priority", { precision: 2, scale: 1 }).default(
      "0.5" as any
    ),
    includeInSitemap: boolean("include_in_sitemap").default(true),
    schemaType: varchar("schema_type"), // WebSite, SoftwareApplication, Product, Article, FAQPage, Organization, Service
    schemaData: jsonb("schema_data"),
    createdAt: timestamp("created_at").defaultNow(),
    updatedAt: timestamp("updated_at").defaultNow(),
  },
  (table) => ({
    pathIdx: index("seo_pages_path_idx").on(table.path),
  })
);
...
// Re-export workflow automation schemas
export {
  workflows,
  workflowVersions,
  workflowTriggers,
  ...
  insertWorkflowStepTransitionSchema,
  insertWorkflowExecutionSchema,
  insertWorkflowExecutionStepSchema,
  insertWorkflowExecutionEventSchema,
...
export type {
  ...
  InsertTriggerSchedule,
  InsertWorkflowCondition,
  InsertWorkflowStepAutomation,
  InsertWorkflowStepTransition,
...
// Re-export SEO Management schemas
export {
  seoSettings,
  seoAuditHistory,
  seoFixesApplied,
  ...
  seoSeverityEnum,
  seoAlertStatusEnum,
  seoNotificationTypeEnum,
  seoContentStatusEnum,
  seoMonitoringFrequencyEnum,
  insertSeoSettingsSchema,
  insertSeoAuditHistorySchema,
  insertSeoFixesAppliedSchema,
  insertSeoKeywordsSchema,
  insertSeoKeywordHistorySchema,
  insertSeoCompetitorAnalysisSchema,
  insertSeoPageScoresSchema,
  insertSeoMonitoringLogSchema,
  insertGscOauthCredentialsSchema,
  insertGscPropertiesSchema,
  insertGscKeywordPerformanceSchema,
  insertGscPagePerformanceSchema,
  insertSeoNotificationPreferencesSchema,
  insertSeoAlertRulesSchema,
  insertSeoAlertsSchema,
  insertSeoMonitoringSchedulesSchema,
  insertSeoCoreWebVitalsSchema,
  insertSeoCrawlResultsSchema,
  insertSeoImageAnalysisSchema,
  insertSeoRedirectAnalysisSchema,
  insertSeoDuplicateContentSchema,
  insertSeoSecurityAnalysisSchema,
  insertSeoLinkAnalysisSchema,
  insertSeoStructuredDataSchema,
  insertSeoMobileAnalysisSchema,
  insertSeoPerformanceBudgetSchema,
  insertSeoContentOptimizationSchema,
  insertSeoSemanticAnalysisSchema,
} from "./seo-schema";
...
export type {
  ...
  InsertSeoSettings,
  SeoAuditHistory,
  InsertSeoAuditHistory,
  SeoFixesApplied,
  InsertSeoFixesApplied,
  SeoKeywords,
  InsertSeoKeywords,
  SeoKeywordHistory,
  InsertSeoKeywordHistory,
  SeoCompetitorAnalysis,
  InsertSeoCompetitorAnalysis,
  SeoPageScores,
  InsertSeoPageScores,
  SeoMonitoringLog,
  InsertSeoMonitoringLog,
  GscOauthCredentials,
  InsertGscOauthCredentials,
  GscProperties,
  InsertGscProperties,
  GscKeywordPerformance,
  InsertGscKeywordPerformance,
  GscPagePerformance,
  InsertGscPagePerformance,
  SeoNotificationPreferences,
  InsertSeoNotificationPreferences,
  SeoAlertRules,
  InsertSeoAlertRules,
  SeoAlerts,
  InsertSeoAlerts,
  SeoMonitoringSchedules,
  InsertSeoMonitoringSchedules,
  SeoCoreWebVitals,
  InsertSeoCoreWebVitals,
  SeoCrawlResults,
  InsertSeoCrawlResults,
  SeoImageAnalysis,
  InsertSeoImageAnalysis,
  SeoRedirectAnalysis,
  InsertSeoRedirectAnalysis,
  SeoDuplicateContent,
  InsertSeoDuplicateContent,
  SeoSecurityAnalysis,
  InsertSeoSecurityAnalysis,
  SeoLinkAnalysis,
  InsertSeoLinkAnalysis,
  SeoStructuredData,
  InsertSeoStructuredData,
  SeoMobileAnalysis,
  InsertSeoMobileAnalysis,
  SeoPerformanceBudget,
  InsertSeoPerformanceBudget,
  SeoContentOptimization,
  InsertSeoContentOptimization,
  SeoSemanticAnalysis,
