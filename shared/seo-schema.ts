...
import { pgTable, uuid, varchar, text, timestamp, jsonb, boolean, integer, decimal, pgEnum, index } from "drizzle-orm/pg-core";
import { createInsertSchema } from "drizzle-zod";
import { relations } from "drizzle-orm";

// ============= ENUMS =============

export const seoAuditStatusEnum = pgEnum('seo_audit_status', ['pending', 'running', 'completed', 'failed']);
export const seoFixStatusEnum = pgEnum('seo_fix_status', ['pending', 'applied', 'failed', 'reverted']);
export const seoSeverityEnum = pgEnum('seo_severity', ['low', 'medium', 'high', 'critical']);
export const seoAlertStatusEnum = pgEnum('seo_alert_status', ['active', 'acknowledged', 'resolved', 'ignored']);
export const seoNotificationTypeEnum = pgEnum('seo_notification_type', ['email', 'slack', 'webhook', 'dashboard']);
export const seoContentStatusEnum = pgEnum('seo_content_status', ['draft', 'optimized', 'published', 'archived']);
export const seoMonitoringFrequencyEnum = pgEnum('seo_monitoring_frequency', ['hourly', 'daily', 'weekly', 'monthly']);
...
export const seoFixesApplied = pgTable("seo_fixes_applied", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoCompetitorAnalysis = pgTable("seo_competitor_analysis", {
  ...
  topRankingKeywords: jsonb("top_ranking_keywords").$type<Array<{
    keyword: string;
    position: number;
    searchVolume: number;
  }>>(),
  ...
  topPages: jsonb("top_pages").$type<Array<{
    url: string;
    traffic: number;
    keywords: number;
  }>>(),
...
export const seoPageScores = pgTable("seo_page_scores", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoMonitoringLog = pgTable("seo_monitoring_log", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const gscOauthCredentials = pgTable("gsc_oauth_credentials", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const gscKeywordPerformance = pgTable("gsc_keyword_performance", {
  id: uuid("id").primaryKey().defaultRandom(),
...
export const gscPagePerformance = pgTable("gsc_page_performance", {
  id: uuid("id").primaryKey().defaultRandom(),
  propertyId: uuid("property_id").notNull(),
...
export const seoNotificationPreferences = pgTable("seo_notification_preferences", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoAlertRules = pgTable("seo_alert_rules", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoMonitoringSchedules = pgTable("seo_monitoring_schedules", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoCoreWebVitals = pgTable("seo_core_web_vitals", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoImageAnalysis = pgTable("seo_image_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoRedirectAnalysis = pgTable("seo_redirect_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
  ...
  // Chain Details
  redirectChain: jsonb("redirect_chain").$type<Array<{
    url: string;
    statusCode: number;
  }>>(),
...
export const seoDuplicateContent = pgTable("seo_duplicate_content", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoSecurityAnalysis = pgTable("seo_security_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoLinkAnalysis = pgTable("seo_link_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoStructuredData = pgTable("seo_structured_data", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoMobileAnalysis = pgTable("seo_mobile_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoPerformanceBudget = pgTable("seo_performance_budget", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
...
export const seoContentOptimization = pgTable("seo_content_optimization", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
  ...
  // AI Suggestions
  aiSuggestions: jsonb("ai_suggestions").$type<Array<{
    type: string;
    suggestion: string;
    priority: string;
  }>>(),
...
export const seoSemanticAnalysis = pgTable("seo_semantic_analysis", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
  ...
  // Related Keywords
  relatedKeywords: jsonb("related_keywords").$type<Array<{
    keyword: string;
    relevance: number;
    searchVolume: number;
  }>>(),
  ...
  // Semantic Clusters
  semanticClusters: jsonb("semantic_clusters").$type<Array<{
    cluster: string;
    keywords: string[];
  }>>(),
  ...
  // Competitor Analysis
  topRankingContent: jsonb("top_ranking_content").$type<Array<{
    url: string;
    title: string;
...
export const insertSeoNotificationPreferencesSchema = createInsertSchema(seoNotificationPreferences).omit({
  id: true,
  createdAt: true,
  updatedAt: true,
});
