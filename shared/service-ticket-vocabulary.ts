 ...
 *
 * The client/Node copy. supabase/functions/_shared/service-ticket-vocabulary.ts
 * is the Deno twin the handlers run, and
 * server/tests/unit/service-ticket-vocabulary.test.ts locks the two together.
 *
