...
export const changeRequests = pgTable("change_requests", {
  ...
  approvedBy: jsonb("approved_by").$type<Array<{
    userId: string;
    userName: string;
    role: string;
    approvedAt: string;
...
export const incidents = pgTable("incidents", {
  ...
  assignedTeam: jsonb("assigned_team").$type<Array<{
    userId: string;
    userName: string;
    role: string;
    assignedAt: string;
  ...
  resolutionActions: jsonb("resolution_actions").$type<Array<{
    action: string;
    completedBy: string;
    completedAt: string;
    notes?: string;
 ...
 */
export const paymentMethodChanges = pgTable("payment_method_changes", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
 ...
 */
export const dataPurgeJobs = pgTable("data_purge_jobs", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
  policyId: uuid("policy_id").notNull().references(() => dataRetentionPolicies.id, { onDelete: 'cascade' }),
 ...
 */
export const auditArchiveJobs = pgTable("audit_archive_jobs", {
  id: uuid("id").primaryKey().defaultRandom(),
  tenantId: uuid("tenant_id").notNull(),
