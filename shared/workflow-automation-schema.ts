...
export const workflowVersions = pgTable(
  ...
  (table) => ({
    workflowVersionIdx: unique("workflow_version_unique").on(
      table.workflowId,
      table.version
    ),
...
export const workflowStepsAutomation = pgTable(
  ...
  (table) => ({
    workflowIdx: index("workflow_steps_automation_workflow_idx").on(
      table.workflowId
    ),
    orderIdx: index("workflow_steps_automation_order_idx").on(
      table.workflowId,
      table.orderIndex
    ),
  })
...
export const workflowExecutions = pgTable(
  ...
  (table) => ({
    ...
    createdAtIdx: index("workflow_executions_created_at_idx").on(
      table.createdAt
    ),
  })
);
...
export const workflowExecutionSteps = pgTable(
  ...
  (table) => ({
    executionIdx: index("workflow_execution_steps_execution_idx").on(
      table.executionId
    ),
...
export const workflowExecutionEvents = pgTable(
  "workflow_execution_events",
  {
    ...
    executionId: varchar("execution_id")
      .notNull()
      .references(() => workflowExecutions.id, { onDelete: "cascade" }),
    stepExecutionId: varchar("step_execution_id").references(
      () => workflowExecutionSteps.id,
      { onDelete: "cascade" }
    ),
  ...
  (table) => ({
    executionIdx: index("workflow_execution_events_execution_idx").on(
      table.executionId
    ),
    createdAtIdx: index("workflow_execution_events_created_at_idx").on(
      table.createdAt
    ),
  })
);
...
export const workflowEventRegistry = pgTable(
  ...
  (table) => ({
    eventNameIdx: index("workflow_event_registry_event_name_idx").on(
      table.eventName
    ),
    categoryIdx: index("workflow_event_registry_category_idx").on(
      table.category
    ),
  })
);
...
export const insertWorkflowStepAutomationSchema = createInsertSchema(
...
export const insertWorkflowStepTransitionSchema = createInsertSchema(
...
export const insertWorkflowExecutionStepSchema = createInsertSchema(
...
export const insertWorkflowEventRegistrySchema = createInsertSchema(
...
export type InsertWorkflowStepAutomation = z.infer<
  typeof insertWorkflowStepAutomationSchema
>;
export type InsertWorkflowStepTransition = z.infer<
  typeof insertWorkflowStepTransitionSchema
>;
export type InsertWorkflowExecution = z.infer<typeof insertWorkflowExecutionSchema>;
export type InsertWorkflowExecutionStep = z.infer<
  typeof insertWorkflowExecutionStepSchema
>;
export type InsertWorkflowExecutionEvent = z.infer<
  typeof insertWorkflowExecutionEventSchema
>;
