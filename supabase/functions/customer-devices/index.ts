...
export default async function handler(req: Request) {
  ...
  try {
    ...
    // /customer-devices, making this correct whether or not the prefix survived.
    const { parts } = normalizePath(url.pathname, 'customer-devices');
    const customerId = parts[0]; // customers/:customerId/devices
