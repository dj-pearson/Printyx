// Local RBAC helper for lead-scoring, ported from
// server/routes/lead-scoring-routes.ts::isAdminOrManager.
//
...
export async function isAdminOrManager(auth: AuthContext): Promise<boolean> {
