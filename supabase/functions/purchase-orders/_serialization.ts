 ...
 *
 * server/lib/equipment-serialization.ts is the Node twin, imported by the Express
 * POST /api/equipment handler; server/tests/unit/receipt-serialization.test.ts
