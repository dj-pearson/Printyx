-- Corrected Mock Data Injection for Current Schema
-- Using tenant UUID: 1d4522ad-b3d8-4018-8890-f9294b2efbe6

-- Business Records (using correct schema fields)  
INSERT INTO business_records (
    id, tenant_id, business_name, primary_contact_name, primary_contact_email, 
...
-- Companies (using correct schema fields)
INSERT INTO companies (
    id, tenant_id, business_name, industry, website, employee_count, 
    annual_revenue, address, city, state, zip_code, phone, email
) VALUES
(
    'comp_demo_001',
    '1d4522ad-b3d8-4018-8890-f9294b2efbe6',
...
-- Activity records for business records
INSERT INTO business_record_activities (
    id, business_record_id, activity_type, subject, description, 
    duration_minutes, outcome, next_action, created_by, tenant_id, created_at
) VALUES
(
    'activity_demo_001',
    'br_demo_001', 
