...
const DEFAULT_VISUAL_CONFIG: VisualConfig = {
  ...
  hideSelectors: ['[data-testid="timestamp"]', '.loading-spinner', '.skeleton', '[data-dynamic]'],
...
export class VisualTester {
   ...
   */
  async captureAllPages(page: Page, pages: { url: string; name: string }[]): Promise<TestResult[]> {
